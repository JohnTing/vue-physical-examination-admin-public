const Ju=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function n(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerpolicy&&(r.referrerPolicy=s.referrerpolicy),s.crossorigin==="use-credentials"?r.credentials="include":s.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(s){if(s.ep)return;s.ep=!0;const r=n(s);fetch(s.href,r)}};Ju();function Tr(t,e){const n=Object.create(null),i=t.split(",");for(let s=0;s<i.length;s++)n[i[s]]=!0;return e?s=>!!n[s.toLowerCase()]:s=>!!n[s]}const Xu="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Zu=Tr(Xu);function ha(t){return!!t||t===""}function Sr(t){if(z(t)){const e={};for(let n=0;n<t.length;n++){const i=t[n],s=Te(i)?nh(i):Sr(i);if(s)for(const r in s)e[r]=s[r]}return e}else{if(Te(t))return t;if(ye(t))return t}}const eh=/;(?![^(]*\))/g,th=/:(.+)/;function nh(t){const e={};return t.split(eh).forEach(n=>{if(n){const i=n.split(th);i.length>1&&(e[i[0].trim()]=i[1].trim())}}),e}function Nr(t){let e="";if(Te(t))e=t;else if(z(t))for(let n=0;n<t.length;n++){const i=Nr(t[n]);i&&(e+=i+" ")}else if(ye(t))for(const n in t)t[n]&&(e+=n+" ");return e.trim()}const pt=t=>Te(t)?t:t==null?"":z(t)||ye(t)&&(t.toString===_a||!K(t.toString))?JSON.stringify(t,fa,2):String(t),fa=(t,e)=>e&&e.__v_isRef?fa(t,e.value):mn(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((n,[i,s])=>(n[`${i} =>`]=s,n),{})}:da(e)?{[`Set(${e.size})`]:[...e.values()]}:ye(e)&&!z(e)&&!ga(e)?String(e):e,fe={},gn=[],nt=()=>{},ih=()=>!1,sh=/^on[^a-z]/,ss=t=>sh.test(t),Ar=t=>t.startsWith("onUpdate:"),De=Object.assign,Rr=(t,e)=>{const n=t.indexOf(e);n>-1&&t.splice(n,1)},rh=Object.prototype.hasOwnProperty,J=(t,e)=>rh.call(t,e),z=Array.isArray,mn=t=>rs(t)==="[object Map]",da=t=>rs(t)==="[object Set]",K=t=>typeof t=="function",Te=t=>typeof t=="string",xr=t=>typeof t=="symbol",ye=t=>t!==null&&typeof t=="object",pa=t=>ye(t)&&K(t.then)&&K(t.catch),_a=Object.prototype.toString,rs=t=>_a.call(t),oh=t=>rs(t).slice(8,-1),ga=t=>rs(t)==="[object Object]",Or=t=>Te(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,Oi=Tr(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),os=t=>{const e=Object.create(null);return n=>e[n]||(e[n]=t(n))},lh=/-(\w)/g,Tn=os(t=>t.replace(lh,(e,n)=>n?n.toUpperCase():"")),ah=/\B([A-Z])/g,Dn=os(t=>t.replace(ah,"-$1").toLowerCase()),ma=os(t=>t.charAt(0).toUpperCase()+t.slice(1)),bs=os(t=>t?`on${ma(t)}`:""),Xn=(t,e)=>!Object.is(t,e),Is=(t,e)=>{for(let n=0;n<t.length;n++)t[n](e)},Fi=(t,e,n)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,value:n})},ch=t=>{const e=parseFloat(t);return isNaN(e)?t:e};let Po;const uh=()=>Po||(Po=typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{});let lt;class hh{constructor(e=!1){this.active=!0,this.effects=[],this.cleanups=[],!e&&lt&&(this.parent=lt,this.index=(lt.scopes||(lt.scopes=[])).push(this)-1)}run(e){if(this.active){const n=lt;try{return lt=this,e()}finally{lt=n}}}on(){lt=this}off(){lt=this.parent}stop(e){if(this.active){let n,i;for(n=0,i=this.effects.length;n<i;n++)this.effects[n].stop();for(n=0,i=this.cleanups.length;n<i;n++)this.cleanups[n]();if(this.scopes)for(n=0,i=this.scopes.length;n<i;n++)this.scopes[n].stop(!0);if(this.parent&&!e){const s=this.parent.scopes.pop();s&&s!==this&&(this.parent.scopes[this.index]=s,s.index=this.index)}this.active=!1}}}function fh(t,e=lt){e&&e.active&&e.effects.push(t)}const kr=t=>{const e=new Set(t);return e.w=0,e.n=0,e},ya=t=>(t.w&Dt)>0,va=t=>(t.n&Dt)>0,dh=({deps:t})=>{if(t.length)for(let e=0;e<t.length;e++)t[e].w|=Dt},ph=t=>{const{deps:e}=t;if(e.length){let n=0;for(let i=0;i<e.length;i++){const s=e[i];ya(s)&&!va(s)?s.delete(t):e[n++]=s,s.w&=~Dt,s.n&=~Dt}e.length=n}},js=new WeakMap;let jn=0,Dt=1;const zs=30;let Je;const Gt=Symbol(""),Ks=Symbol("");class Dr{constructor(e,n=null,i){this.fn=e,this.scheduler=n,this.active=!0,this.deps=[],this.parent=void 0,fh(this,i)}run(){if(!this.active)return this.fn();let e=Je,n=At;for(;e;){if(e===this)return;e=e.parent}try{return this.parent=Je,Je=this,At=!0,Dt=1<<++jn,jn<=zs?dh(this):Fo(this),this.fn()}finally{jn<=zs&&ph(this),Dt=1<<--jn,Je=this.parent,At=n,this.parent=void 0,this.deferStop&&this.stop()}}stop(){Je===this?this.deferStop=!0:this.active&&(Fo(this),this.onStop&&this.onStop(),this.active=!1)}}function Fo(t){const{deps:e}=t;if(e.length){for(let n=0;n<e.length;n++)e[n].delete(t);e.length=0}}let At=!0;const Ca=[];function Mn(){Ca.push(At),At=!1}function Pn(){const t=Ca.pop();At=t===void 0?!0:t}function je(t,e,n){if(At&&Je){let i=js.get(t);i||js.set(t,i=new Map);let s=i.get(n);s||i.set(n,s=kr()),Ea(s)}}function Ea(t,e){let n=!1;jn<=zs?va(t)||(t.n|=Dt,n=!ya(t)):n=!t.has(Je),n&&(t.add(Je),Je.deps.push(t))}function vt(t,e,n,i,s,r){const o=js.get(t);if(!o)return;let l=[];if(e==="clear")l=[...o.values()];else if(n==="length"&&z(t))o.forEach((a,c)=>{(c==="length"||c>=i)&&l.push(a)});else switch(n!==void 0&&l.push(o.get(n)),e){case"add":z(t)?Or(n)&&l.push(o.get("length")):(l.push(o.get(Gt)),mn(t)&&l.push(o.get(Ks)));break;case"delete":z(t)||(l.push(o.get(Gt)),mn(t)&&l.push(o.get(Ks)));break;case"set":mn(t)&&l.push(o.get(Gt));break}if(l.length===1)l[0]&&qs(l[0]);else{const a=[];for(const c of l)c&&a.push(...c);qs(kr(a))}}function qs(t,e){const n=z(t)?t:[...t];for(const i of n)i.computed&&Lo(i);for(const i of n)i.computed||Lo(i)}function Lo(t,e){(t!==Je||t.allowRecurse)&&(t.scheduler?t.scheduler():t.run())}const _h=Tr("__proto__,__v_isRef,__isVue"),ba=new Set(Object.getOwnPropertyNames(Symbol).filter(t=>t!=="arguments"&&t!=="caller").map(t=>Symbol[t]).filter(xr)),gh=Mr(),mh=Mr(!1,!0),yh=Mr(!0),Uo=vh();function vh(){const t={};return["includes","indexOf","lastIndexOf"].forEach(e=>{t[e]=function(...n){const i=ne(this);for(let r=0,o=this.length;r<o;r++)je(i,"get",r+"");const s=i[e](...n);return s===-1||s===!1?i[e](...n.map(ne)):s}}),["push","pop","shift","unshift","splice"].forEach(e=>{t[e]=function(...n){Mn();const i=ne(this)[e].apply(this,n);return Pn(),i}}),t}function Mr(t=!1,e=!1){return function(i,s,r){if(s==="__v_isReactive")return!t;if(s==="__v_isReadonly")return t;if(s==="__v_isShallow")return e;if(s==="__v_raw"&&r===(t?e?Ph:Na:e?Sa:Ta).get(i))return i;const o=z(i);if(!t&&o&&J(Uo,s))return Reflect.get(Uo,s,r);const l=Reflect.get(i,s,r);return(xr(s)?ba.has(s):_h(s))||(t||je(i,"get",s),e)?l:ke(l)?o&&Or(s)?l:l.value:ye(l)?t?Aa(l):Lr(l):l}}const Ch=Ia(),Eh=Ia(!0);function Ia(t=!1){return function(n,i,s,r){let o=n[i];if(Sn(o)&&ke(o)&&!ke(s))return!1;if(!t&&(!Li(s)&&!Sn(s)&&(o=ne(o),s=ne(s)),!z(n)&&ke(o)&&!ke(s)))return o.value=s,!0;const l=z(n)&&Or(i)?Number(i)<n.length:J(n,i),a=Reflect.set(n,i,s,r);return n===ne(r)&&(l?Xn(s,o)&&vt(n,"set",i,s):vt(n,"add",i,s)),a}}function bh(t,e){const n=J(t,e);t[e];const i=Reflect.deleteProperty(t,e);return i&&n&&vt(t,"delete",e,void 0),i}function Ih(t,e){const n=Reflect.has(t,e);return(!xr(e)||!ba.has(e))&&je(t,"has",e),n}function wh(t){return je(t,"iterate",z(t)?"length":Gt),Reflect.ownKeys(t)}const wa={get:gh,set:Ch,deleteProperty:bh,has:Ih,ownKeys:wh},Th={get:yh,set(t,e){return!0},deleteProperty(t,e){return!0}},Sh=De({},wa,{get:mh,set:Eh}),Pr=t=>t,ls=t=>Reflect.getPrototypeOf(t);function bi(t,e,n=!1,i=!1){t=t.__v_raw;const s=ne(t),r=ne(e);n||(e!==r&&je(s,"get",e),je(s,"get",r));const{has:o}=ls(s),l=i?Pr:n?$r:Zn;if(o.call(s,e))return l(t.get(e));if(o.call(s,r))return l(t.get(r));t!==s&&t.get(e)}function Ii(t,e=!1){const n=this.__v_raw,i=ne(n),s=ne(t);return e||(t!==s&&je(i,"has",t),je(i,"has",s)),t===s?n.has(t):n.has(t)||n.has(s)}function wi(t,e=!1){return t=t.__v_raw,!e&&je(ne(t),"iterate",Gt),Reflect.get(t,"size",t)}function $o(t){t=ne(t);const e=ne(this);return ls(e).has.call(e,t)||(e.add(t),vt(e,"add",t,t)),this}function Bo(t,e){e=ne(e);const n=ne(this),{has:i,get:s}=ls(n);let r=i.call(n,t);r||(t=ne(t),r=i.call(n,t));const o=s.call(n,t);return n.set(t,e),r?Xn(e,o)&&vt(n,"set",t,e):vt(n,"add",t,e),this}function Ho(t){const e=ne(this),{has:n,get:i}=ls(e);let s=n.call(e,t);s||(t=ne(t),s=n.call(e,t)),i&&i.call(e,t);const r=e.delete(t);return s&&vt(e,"delete",t,void 0),r}function Wo(){const t=ne(this),e=t.size!==0,n=t.clear();return e&&vt(t,"clear",void 0,void 0),n}function Ti(t,e){return function(i,s){const r=this,o=r.__v_raw,l=ne(o),a=e?Pr:t?$r:Zn;return!t&&je(l,"iterate",Gt),o.forEach((c,u)=>i.call(s,a(c),a(u),r))}}function Si(t,e,n){return function(...i){const s=this.__v_raw,r=ne(s),o=mn(r),l=t==="entries"||t===Symbol.iterator&&o,a=t==="keys"&&o,c=s[t](...i),u=n?Pr:e?$r:Zn;return!e&&je(r,"iterate",a?Ks:Gt),{next(){const{value:h,done:d}=c.next();return d?{value:h,done:d}:{value:l?[u(h[0]),u(h[1])]:u(h),done:d}},[Symbol.iterator](){return this}}}}function wt(t){return function(...e){return t==="delete"?!1:this}}function Nh(){const t={get(r){return bi(this,r)},get size(){return wi(this)},has:Ii,add:$o,set:Bo,delete:Ho,clear:Wo,forEach:Ti(!1,!1)},e={get(r){return bi(this,r,!1,!0)},get size(){return wi(this)},has:Ii,add:$o,set:Bo,delete:Ho,clear:Wo,forEach:Ti(!1,!0)},n={get(r){return bi(this,r,!0)},get size(){return wi(this,!0)},has(r){return Ii.call(this,r,!0)},add:wt("add"),set:wt("set"),delete:wt("delete"),clear:wt("clear"),forEach:Ti(!0,!1)},i={get(r){return bi(this,r,!0,!0)},get size(){return wi(this,!0)},has(r){return Ii.call(this,r,!0)},add:wt("add"),set:wt("set"),delete:wt("delete"),clear:wt("clear"),forEach:Ti(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(r=>{t[r]=Si(r,!1,!1),n[r]=Si(r,!0,!1),e[r]=Si(r,!1,!0),i[r]=Si(r,!0,!0)}),[t,n,e,i]}const[Ah,Rh,xh,Oh]=Nh();function Fr(t,e){const n=e?t?Oh:xh:t?Rh:Ah;return(i,s,r)=>s==="__v_isReactive"?!t:s==="__v_isReadonly"?t:s==="__v_raw"?i:Reflect.get(J(n,s)&&s in i?n:i,s,r)}const kh={get:Fr(!1,!1)},Dh={get:Fr(!1,!0)},Mh={get:Fr(!0,!1)},Ta=new WeakMap,Sa=new WeakMap,Na=new WeakMap,Ph=new WeakMap;function Fh(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Lh(t){return t.__v_skip||!Object.isExtensible(t)?0:Fh(oh(t))}function Lr(t){return Sn(t)?t:Ur(t,!1,wa,kh,Ta)}function Uh(t){return Ur(t,!1,Sh,Dh,Sa)}function Aa(t){return Ur(t,!0,Th,Mh,Na)}function Ur(t,e,n,i,s){if(!ye(t)||t.__v_raw&&!(e&&t.__v_isReactive))return t;const r=s.get(t);if(r)return r;const o=Lh(t);if(o===0)return t;const l=new Proxy(t,o===2?i:n);return s.set(t,l),l}function yn(t){return Sn(t)?yn(t.__v_raw):!!(t&&t.__v_isReactive)}function Sn(t){return!!(t&&t.__v_isReadonly)}function Li(t){return!!(t&&t.__v_isShallow)}function Ra(t){return yn(t)||Sn(t)}function ne(t){const e=t&&t.__v_raw;return e?ne(e):t}function xa(t){return Fi(t,"__v_skip",!0),t}const Zn=t=>ye(t)?Lr(t):t,$r=t=>ye(t)?Aa(t):t;function Oa(t){At&&Je&&(t=ne(t),Ea(t.dep||(t.dep=kr())))}function ka(t,e){t=ne(t),t.dep&&qs(t.dep)}function ke(t){return!!(t&&t.__v_isRef===!0)}function Vo(t){return $h(t,!1)}function $h(t,e){return ke(t)?t:new Bh(t,e)}class Bh{constructor(e,n){this.__v_isShallow=n,this.dep=void 0,this.__v_isRef=!0,this._rawValue=n?e:ne(e),this._value=n?e:Zn(e)}get value(){return Oa(this),this._value}set value(e){const n=this.__v_isShallow||Li(e)||Sn(e);e=n?e:ne(e),Xn(e,this._rawValue)&&(this._rawValue=e,this._value=n?e:Zn(e),ka(this))}}function ki(t){return ke(t)?t.value:t}const Hh={get:(t,e,n)=>ki(Reflect.get(t,e,n)),set:(t,e,n,i)=>{const s=t[e];return ke(s)&&!ke(n)?(s.value=n,!0):Reflect.set(t,e,n,i)}};function Da(t){return yn(t)?t:new Proxy(t,Hh)}var Ma;class Wh{constructor(e,n,i,s){this._setter=n,this.dep=void 0,this.__v_isRef=!0,this[Ma]=!1,this._dirty=!0,this.effect=new Dr(e,()=>{this._dirty||(this._dirty=!0,ka(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!s,this.__v_isReadonly=i}get value(){const e=ne(this);return Oa(e),(e._dirty||!e._cacheable)&&(e._dirty=!1,e._value=e.effect.run()),e._value}set value(e){this._setter(e)}}Ma="__v_isReadonly";function Vh(t,e,n=!1){let i,s;const r=K(t);return r?(i=t,s=nt):(i=t.get,s=t.set),new Wh(i,s,r||!s,n)}function Rt(t,e,n,i){let s;try{s=i?t(...i):t()}catch(r){as(r,e,n)}return s}function Ke(t,e,n,i){if(K(t)){const r=Rt(t,e,n,i);return r&&pa(r)&&r.catch(o=>{as(o,e,n)}),r}const s=[];for(let r=0;r<t.length;r++)s.push(Ke(t[r],e,n,i));return s}function as(t,e,n,i=!0){const s=e?e.vnode:null;if(e){let r=e.parent;const o=e.proxy,l=n;for(;r;){const c=r.ec;if(c){for(let u=0;u<c.length;u++)if(c[u](t,o,l)===!1)return}r=r.parent}const a=e.appContext.config.errorHandler;if(a){Rt(a,null,10,[t,o,l]);return}}jh(t,n,s,i)}function jh(t,e,n,i=!0){console.error(t)}let ei=!1,Ys=!1;const Oe=[];let ut=0;const vn=[];let _t=null,jt=0;const Pa=Promise.resolve();let Br=null;function zh(t){const e=Br||Pa;return t?e.then(this?t.bind(this):t):e}function Kh(t){let e=ut+1,n=Oe.length;for(;e<n;){const i=e+n>>>1;ti(Oe[i])<t?e=i+1:n=i}return e}function Hr(t){(!Oe.length||!Oe.includes(t,ei&&t.allowRecurse?ut+1:ut))&&(t.id==null?Oe.push(t):Oe.splice(Kh(t.id),0,t),Fa())}function Fa(){!ei&&!Ys&&(Ys=!0,Br=Pa.then(Ua))}function qh(t){const e=Oe.indexOf(t);e>ut&&Oe.splice(e,1)}function Yh(t){z(t)?vn.push(...t):(!_t||!_t.includes(t,t.allowRecurse?jt+1:jt))&&vn.push(t),Fa()}function jo(t,e=ei?ut+1:0){for(;e<Oe.length;e++){const n=Oe[e];n&&n.pre&&(Oe.splice(e,1),e--,n())}}function La(t){if(vn.length){const e=[...new Set(vn)];if(vn.length=0,_t){_t.push(...e);return}for(_t=e,_t.sort((n,i)=>ti(n)-ti(i)),jt=0;jt<_t.length;jt++)_t[jt]();_t=null,jt=0}}const ti=t=>t.id==null?1/0:t.id,Gh=(t,e)=>{const n=ti(t)-ti(e);if(n===0){if(t.pre&&!e.pre)return-1;if(e.pre&&!t.pre)return 1}return n};function Ua(t){Ys=!1,ei=!0,Oe.sort(Gh);const e=nt;try{for(ut=0;ut<Oe.length;ut++){const n=Oe[ut];n&&n.active!==!1&&Rt(n,null,14)}}finally{ut=0,Oe.length=0,La(),ei=!1,Br=null,(Oe.length||vn.length)&&Ua()}}function Qh(t,e,...n){if(t.isUnmounted)return;const i=t.vnode.props||fe;let s=n;const r=e.startsWith("update:"),o=r&&e.slice(7);if(o&&o in i){const u=`${o==="modelValue"?"model":o}Modifiers`,{number:h,trim:d}=i[u]||fe;d&&(s=n.map(_=>_.trim())),h&&(s=n.map(ch))}let l,a=i[l=bs(e)]||i[l=bs(Tn(e))];!a&&r&&(a=i[l=bs(Dn(e))]),a&&Ke(a,t,6,s);const c=i[l+"Once"];if(c){if(!t.emitted)t.emitted={};else if(t.emitted[l])return;t.emitted[l]=!0,Ke(c,t,6,s)}}function $a(t,e,n=!1){const i=e.emitsCache,s=i.get(t);if(s!==void 0)return s;const r=t.emits;let o={},l=!1;if(!K(t)){const a=c=>{const u=$a(c,e,!0);u&&(l=!0,De(o,u))};!n&&e.mixins.length&&e.mixins.forEach(a),t.extends&&a(t.extends),t.mixins&&t.mixins.forEach(a)}return!r&&!l?(ye(t)&&i.set(t,null),null):(z(r)?r.forEach(a=>o[a]=null):De(o,r),ye(t)&&i.set(t,o),o)}function cs(t,e){return!t||!ss(e)?!1:(e=e.slice(2).replace(/Once$/,""),J(t,e[0].toLowerCase()+e.slice(1))||J(t,Dn(e))||J(t,e))}let ht=null,us=null;function Ui(t){const e=ht;return ht=t,us=t&&t.type.__scopeId||null,e}function Jh(t){us=t}function Xh(){us=null}function Zh(t,e=ht,n){if(!e||t._n)return t;const i=(...s)=>{i._d&&tl(-1);const r=Ui(e),o=t(...s);return Ui(r),i._d&&tl(1),o};return i._n=!0,i._c=!0,i._d=!0,i}function ws(t){const{type:e,vnode:n,proxy:i,withProxy:s,props:r,propsOptions:[o],slots:l,attrs:a,emit:c,render:u,renderCache:h,data:d,setupState:_,ctx:E,inheritAttrs:O}=t;let M,H;const ue=Ui(t);try{if(n.shapeFlag&4){const Q=s||i;M=ct(u.call(Q,Q,h,r,_,d,E)),H=a}else{const Q=e;M=ct(Q.length>1?Q(r,{attrs:a,slots:l,emit:c}):Q(r,null)),H=e.props?a:ef(a)}}catch(Q){zn.length=0,as(Q,t,1),M=ft(it)}let X=M;if(H&&O!==!1){const Q=Object.keys(H),{shapeFlag:pe}=X;Q.length&&pe&7&&(o&&Q.some(Ar)&&(H=tf(H,o)),X=Mt(X,H))}return n.dirs&&(X=Mt(X),X.dirs=X.dirs?X.dirs.concat(n.dirs):n.dirs),n.transition&&(X.transition=n.transition),M=X,Ui(ue),M}const ef=t=>{let e;for(const n in t)(n==="class"||n==="style"||ss(n))&&((e||(e={}))[n]=t[n]);return e},tf=(t,e)=>{const n={};for(const i in t)(!Ar(i)||!(i.slice(9)in e))&&(n[i]=t[i]);return n};function nf(t,e,n){const{props:i,children:s,component:r}=t,{props:o,children:l,patchFlag:a}=e,c=r.emitsOptions;if(e.dirs||e.transition)return!0;if(n&&a>=0){if(a&1024)return!0;if(a&16)return i?zo(i,o,c):!!o;if(a&8){const u=e.dynamicProps;for(let h=0;h<u.length;h++){const d=u[h];if(o[d]!==i[d]&&!cs(c,d))return!0}}}else return(s||l)&&(!l||!l.$stable)?!0:i===o?!1:i?o?zo(i,o,c):!0:!!o;return!1}function zo(t,e,n){const i=Object.keys(e);if(i.length!==Object.keys(t).length)return!0;for(let s=0;s<i.length;s++){const r=i[s];if(e[r]!==t[r]&&!cs(n,r))return!0}return!1}function sf({vnode:t,parent:e},n){for(;e&&e.subTree===t;)(t=e.vnode).el=n,e=e.parent}const rf=t=>t.__isSuspense;function of(t,e){e&&e.pendingBranch?z(t)?e.effects.push(...t):e.effects.push(t):Yh(t)}function lf(t,e){if(Ae){let n=Ae.provides;const i=Ae.parent&&Ae.parent.provides;i===n&&(n=Ae.provides=Object.create(i)),n[t]=e}}function Ts(t,e,n=!1){const i=Ae||ht;if(i){const s=i.parent==null?i.vnode.appContext&&i.vnode.appContext.provides:i.parent.provides;if(s&&t in s)return s[t];if(arguments.length>1)return n&&K(e)?e.call(i.proxy):e}}const Ko={};function Ss(t,e,n){return Ba(t,e,n)}function Ba(t,e,{immediate:n,deep:i,flush:s,onTrack:r,onTrigger:o}=fe){const l=Ae;let a,c=!1,u=!1;if(ke(t)?(a=()=>t.value,c=Li(t)):yn(t)?(a=()=>t,i=!0):z(t)?(u=!0,c=t.some(H=>yn(H)||Li(H)),a=()=>t.map(H=>{if(ke(H))return H.value;if(yn(H))return dn(H);if(K(H))return Rt(H,l,2)})):K(t)?e?a=()=>Rt(t,l,2):a=()=>{if(!(l&&l.isUnmounted))return h&&h(),Ke(t,l,3,[d])}:a=nt,e&&i){const H=a;a=()=>dn(H())}let h,d=H=>{h=M.onStop=()=>{Rt(H,l,4)}};if(ii)return d=nt,e?n&&Ke(e,l,3,[a(),u?[]:void 0,d]):a(),nt;let _=u?[]:Ko;const E=()=>{if(!!M.active)if(e){const H=M.run();(i||c||(u?H.some((ue,X)=>Xn(ue,_[X])):Xn(H,_)))&&(h&&h(),Ke(e,l,3,[H,_===Ko?void 0:_,d]),_=H)}else M.run()};E.allowRecurse=!!e;let O;s==="sync"?O=E:s==="post"?O=()=>Le(E,l&&l.suspense):(E.pre=!0,l&&(E.id=l.uid),O=()=>Hr(E));const M=new Dr(a,O);return e?n?E():_=M.run():s==="post"?Le(M.run.bind(M),l&&l.suspense):M.run(),()=>{M.stop(),l&&l.scope&&Rr(l.scope.effects,M)}}function af(t,e,n){const i=this.proxy,s=Te(t)?t.includes(".")?Ha(i,t):()=>i[t]:t.bind(i,i);let r;K(e)?r=e:(r=e.handler,n=e);const o=Ae;Nn(this);const l=Ba(s,r.bind(i),n);return o?Nn(o):Qt(),l}function Ha(t,e){const n=e.split(".");return()=>{let i=t;for(let s=0;s<n.length&&i;s++)i=i[n[s]];return i}}function dn(t,e){if(!ye(t)||t.__v_skip||(e=e||new Set,e.has(t)))return t;if(e.add(t),ke(t))dn(t.value,e);else if(z(t))for(let n=0;n<t.length;n++)dn(t[n],e);else if(da(t)||mn(t))t.forEach(n=>{dn(n,e)});else if(ga(t))for(const n in t)dn(t[n],e);return t}function cf(){const t={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return Ka(()=>{t.isMounted=!0}),qa(()=>{t.isUnmounting=!0}),t}const ze=[Function,Array],uf={name:"BaseTransition",props:{mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:ze,onEnter:ze,onAfterEnter:ze,onEnterCancelled:ze,onBeforeLeave:ze,onLeave:ze,onAfterLeave:ze,onLeaveCancelled:ze,onBeforeAppear:ze,onAppear:ze,onAfterAppear:ze,onAppearCancelled:ze},setup(t,{slots:e}){const n=Qf(),i=cf();let s;return()=>{const r=e.default&&Va(e.default(),!0);if(!r||!r.length)return;let o=r[0];if(r.length>1){for(const O of r)if(O.type!==it){o=O;break}}const l=ne(t),{mode:a}=l;if(i.isLeaving)return Ns(o);const c=qo(o);if(!c)return Ns(o);const u=Gs(c,l,i,n);Qs(c,u);const h=n.subTree,d=h&&qo(h);let _=!1;const{getTransitionKey:E}=c.type;if(E){const O=E();s===void 0?s=O:O!==s&&(s=O,_=!0)}if(d&&d.type!==it&&(!zt(c,d)||_)){const O=Gs(d,l,i,n);if(Qs(d,O),a==="out-in")return i.isLeaving=!0,O.afterLeave=()=>{i.isLeaving=!1,n.update()},Ns(o);a==="in-out"&&c.type!==it&&(O.delayLeave=(M,H,ue)=>{const X=Wa(i,d);X[String(d.key)]=d,M._leaveCb=()=>{H(),M._leaveCb=void 0,delete u.delayedLeave},u.delayedLeave=ue})}return o}}},hf=uf;function Wa(t,e){const{leavingVNodes:n}=t;let i=n.get(e.type);return i||(i=Object.create(null),n.set(e.type,i)),i}function Gs(t,e,n,i){const{appear:s,mode:r,persisted:o=!1,onBeforeEnter:l,onEnter:a,onAfterEnter:c,onEnterCancelled:u,onBeforeLeave:h,onLeave:d,onAfterLeave:_,onLeaveCancelled:E,onBeforeAppear:O,onAppear:M,onAfterAppear:H,onAppearCancelled:ue}=e,X=String(t.key),Q=Wa(n,t),pe=(P,m)=>{P&&Ke(P,i,9,m)},Ce=(P,m)=>{const S=m[1];pe(P,m),z(P)?P.every(U=>U.length<=1)&&S():P.length<=1&&S()},Se={mode:r,persisted:o,beforeEnter(P){let m=l;if(!n.isMounted)if(s)m=O||l;else return;P._leaveCb&&P._leaveCb(!0);const S=Q[X];S&&zt(t,S)&&S.el._leaveCb&&S.el._leaveCb(),pe(m,[P])},enter(P){let m=a,S=c,U=u;if(!n.isMounted)if(s)m=M||a,S=H||c,U=ue||u;else return;let re=!1;const N=P._enterCb=R=>{re||(re=!0,R?pe(U,[P]):pe(S,[P]),Se.delayedLeave&&Se.delayedLeave(),P._enterCb=void 0)};m?Ce(m,[P,N]):N()},leave(P,m){const S=String(t.key);if(P._enterCb&&P._enterCb(!0),n.isUnmounting)return m();pe(h,[P]);let U=!1;const re=P._leaveCb=N=>{U||(U=!0,m(),N?pe(E,[P]):pe(_,[P]),P._leaveCb=void 0,Q[S]===t&&delete Q[S])};Q[S]=t,d?Ce(d,[P,re]):re()},clone(P){return Gs(P,e,n,i)}};return Se}function Ns(t){if(hs(t))return t=Mt(t),t.children=null,t}function qo(t){return hs(t)?t.children?t.children[0]:void 0:t}function Qs(t,e){t.shapeFlag&6&&t.component?Qs(t.component.subTree,e):t.shapeFlag&128?(t.ssContent.transition=e.clone(t.ssContent),t.ssFallback.transition=e.clone(t.ssFallback)):t.transition=e}function Va(t,e=!1,n){let i=[],s=0;for(let r=0;r<t.length;r++){let o=t[r];const l=n==null?o.key:String(n)+String(o.key!=null?o.key:r);o.type===We?(o.patchFlag&128&&s++,i=i.concat(Va(o.children,e,l))):(e||o.type!==it)&&i.push(l!=null?Mt(o,{key:l}):o)}if(s>1)for(let r=0;r<i.length;r++)i[r].patchFlag=-2;return i}function ja(t){return K(t)?{setup:t,name:t.name}:t}const Di=t=>!!t.type.__asyncLoader,hs=t=>t.type.__isKeepAlive;function ff(t,e){za(t,"a",e)}function df(t,e){za(t,"da",e)}function za(t,e,n=Ae){const i=t.__wdc||(t.__wdc=()=>{let s=n;for(;s;){if(s.isDeactivated)return;s=s.parent}return t()});if(fs(e,i,n),n){let s=n.parent;for(;s&&s.parent;)hs(s.parent.vnode)&&pf(i,e,n,s),s=s.parent}}function pf(t,e,n,i){const s=fs(e,t,i,!0);Ya(()=>{Rr(i[e],s)},n)}function fs(t,e,n=Ae,i=!1){if(n){const s=n[t]||(n[t]=[]),r=e.__weh||(e.__weh=(...o)=>{if(n.isUnmounted)return;Mn(),Nn(n);const l=Ke(e,n,t,o);return Qt(),Pn(),l});return i?s.unshift(r):s.push(r),r}}const Ct=t=>(e,n=Ae)=>(!ii||t==="sp")&&fs(t,e,n),_f=Ct("bm"),Ka=Ct("m"),gf=Ct("bu"),mf=Ct("u"),qa=Ct("bum"),Ya=Ct("um"),yf=Ct("sp"),vf=Ct("rtg"),Cf=Ct("rtc");function Ef(t,e=Ae){fs("ec",t,e)}function $t(t,e,n,i){const s=t.dirs,r=e&&e.dirs;for(let o=0;o<s.length;o++){const l=s[o];r&&(l.oldValue=r[o].value);let a=l.dir[i];a&&(Mn(),Ke(a,n,8,[t.el,l,t,e]),Pn())}}const bf=Symbol();function Yo(t,e,n,i){let s;const r=n&&n[i];if(z(t)||Te(t)){s=new Array(t.length);for(let o=0,l=t.length;o<l;o++)s[o]=e(t[o],o,void 0,r&&r[o])}else if(typeof t=="number"){s=new Array(t);for(let o=0;o<t;o++)s[o]=e(o+1,o,void 0,r&&r[o])}else if(ye(t))if(t[Symbol.iterator])s=Array.from(t,(o,l)=>e(o,l,void 0,r&&r[l]));else{const o=Object.keys(t);s=new Array(o.length);for(let l=0,a=o.length;l<a;l++){const c=o[l];s[l]=e(t[c],c,l,r&&r[l])}}else s=[];return n&&(n[i]=s),s}const Js=t=>t?rc(t)?Kr(t)||t.proxy:Js(t.parent):null,$i=De(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>Js(t.parent),$root:t=>Js(t.root),$emit:t=>t.emit,$options:t=>Wr(t),$forceUpdate:t=>t.f||(t.f=()=>Hr(t.update)),$nextTick:t=>t.n||(t.n=zh.bind(t.proxy)),$watch:t=>af.bind(t)}),If={get({_:t},e){const{ctx:n,setupState:i,data:s,props:r,accessCache:o,type:l,appContext:a}=t;let c;if(e[0]!=="$"){const _=o[e];if(_!==void 0)switch(_){case 1:return i[e];case 2:return s[e];case 4:return n[e];case 3:return r[e]}else{if(i!==fe&&J(i,e))return o[e]=1,i[e];if(s!==fe&&J(s,e))return o[e]=2,s[e];if((c=t.propsOptions[0])&&J(c,e))return o[e]=3,r[e];if(n!==fe&&J(n,e))return o[e]=4,n[e];Xs&&(o[e]=0)}}const u=$i[e];let h,d;if(u)return e==="$attrs"&&je(t,"get",e),u(t);if((h=l.__cssModules)&&(h=h[e]))return h;if(n!==fe&&J(n,e))return o[e]=4,n[e];if(d=a.config.globalProperties,J(d,e))return d[e]},set({_:t},e,n){const{data:i,setupState:s,ctx:r}=t;return s!==fe&&J(s,e)?(s[e]=n,!0):i!==fe&&J(i,e)?(i[e]=n,!0):J(t.props,e)||e[0]==="$"&&e.slice(1)in t?!1:(r[e]=n,!0)},has({_:{data:t,setupState:e,accessCache:n,ctx:i,appContext:s,propsOptions:r}},o){let l;return!!n[o]||t!==fe&&J(t,o)||e!==fe&&J(e,o)||(l=r[0])&&J(l,o)||J(i,o)||J($i,o)||J(s.config.globalProperties,o)},defineProperty(t,e,n){return n.get!=null?t._.accessCache[e]=0:J(n,"value")&&this.set(t,e,n.value,null),Reflect.defineProperty(t,e,n)}};let Xs=!0;function wf(t){const e=Wr(t),n=t.proxy,i=t.ctx;Xs=!1,e.beforeCreate&&Go(e.beforeCreate,t,"bc");const{data:s,computed:r,methods:o,watch:l,provide:a,inject:c,created:u,beforeMount:h,mounted:d,beforeUpdate:_,updated:E,activated:O,deactivated:M,beforeDestroy:H,beforeUnmount:ue,destroyed:X,unmounted:Q,render:pe,renderTracked:Ce,renderTriggered:Se,errorCaptured:P,serverPrefetch:m,expose:S,inheritAttrs:U,components:re,directives:N,filters:R}=e;if(c&&Tf(c,i,null,t.appContext.config.unwrapInjectedRef),o)for(const b in o){const D=o[b];K(D)&&(i[b]=D.bind(n))}if(s){const b=s.call(n,n);ye(b)&&(t.data=Lr(b))}if(Xs=!0,r)for(const b in r){const D=r[b],W=K(D)?D.bind(n,n):K(D.get)?D.get.bind(n,n):nt,ee=!K(D)&&K(D.set)?D.set.bind(n):nt,he=nd({get:W,set:ee});Object.defineProperty(i,b,{enumerable:!0,configurable:!0,get:()=>he.value,set:se=>he.value=se})}if(l)for(const b in l)Ga(l[b],i,n,b);if(a){const b=K(a)?a.call(n):a;Reflect.ownKeys(b).forEach(D=>{lf(D,b[D])})}u&&Go(u,t,"c");function L(b,D){z(D)?D.forEach(W=>b(W.bind(n))):D&&b(D.bind(n))}if(L(_f,h),L(Ka,d),L(gf,_),L(mf,E),L(ff,O),L(df,M),L(Ef,P),L(Cf,Ce),L(vf,Se),L(qa,ue),L(Ya,Q),L(yf,m),z(S))if(S.length){const b=t.exposed||(t.exposed={});S.forEach(D=>{Object.defineProperty(b,D,{get:()=>n[D],set:W=>n[D]=W})})}else t.exposed||(t.exposed={});pe&&t.render===nt&&(t.render=pe),U!=null&&(t.inheritAttrs=U),re&&(t.components=re),N&&(t.directives=N)}function Tf(t,e,n=nt,i=!1){z(t)&&(t=Zs(t));for(const s in t){const r=t[s];let o;ye(r)?"default"in r?o=Ts(r.from||s,r.default,!0):o=Ts(r.from||s):o=Ts(r),ke(o)&&i?Object.defineProperty(e,s,{enumerable:!0,configurable:!0,get:()=>o.value,set:l=>o.value=l}):e[s]=o}}function Go(t,e,n){Ke(z(t)?t.map(i=>i.bind(e.proxy)):t.bind(e.proxy),e,n)}function Ga(t,e,n,i){const s=i.includes(".")?Ha(n,i):()=>n[i];if(Te(t)){const r=e[t];K(r)&&Ss(s,r)}else if(K(t))Ss(s,t.bind(n));else if(ye(t))if(z(t))t.forEach(r=>Ga(r,e,n,i));else{const r=K(t.handler)?t.handler.bind(n):e[t.handler];K(r)&&Ss(s,r,t)}}function Wr(t){const e=t.type,{mixins:n,extends:i}=e,{mixins:s,optionsCache:r,config:{optionMergeStrategies:o}}=t.appContext,l=r.get(e);let a;return l?a=l:!s.length&&!n&&!i?a=e:(a={},s.length&&s.forEach(c=>Bi(a,c,o,!0)),Bi(a,e,o)),ye(e)&&r.set(e,a),a}function Bi(t,e,n,i=!1){const{mixins:s,extends:r}=e;r&&Bi(t,r,n,!0),s&&s.forEach(o=>Bi(t,o,n,!0));for(const o in e)if(!(i&&o==="expose")){const l=Sf[o]||n&&n[o];t[o]=l?l(t[o],e[o]):e[o]}return t}const Sf={data:Qo,props:Ht,emits:Ht,methods:Ht,computed:Ht,beforeCreate:Fe,created:Fe,beforeMount:Fe,mounted:Fe,beforeUpdate:Fe,updated:Fe,beforeDestroy:Fe,beforeUnmount:Fe,destroyed:Fe,unmounted:Fe,activated:Fe,deactivated:Fe,errorCaptured:Fe,serverPrefetch:Fe,components:Ht,directives:Ht,watch:Af,provide:Qo,inject:Nf};function Qo(t,e){return e?t?function(){return De(K(t)?t.call(this,this):t,K(e)?e.call(this,this):e)}:e:t}function Nf(t,e){return Ht(Zs(t),Zs(e))}function Zs(t){if(z(t)){const e={};for(let n=0;n<t.length;n++)e[t[n]]=t[n];return e}return t}function Fe(t,e){return t?[...new Set([].concat(t,e))]:e}function Ht(t,e){return t?De(De(Object.create(null),t),e):e}function Af(t,e){if(!t)return e;if(!e)return t;const n=De(Object.create(null),t);for(const i in e)n[i]=Fe(t[i],e[i]);return n}function Rf(t,e,n,i=!1){const s={},r={};Fi(r,ds,1),t.propsDefaults=Object.create(null),Qa(t,e,s,r);for(const o in t.propsOptions[0])o in s||(s[o]=void 0);n?t.props=i?s:Uh(s):t.type.props?t.props=s:t.props=r,t.attrs=r}function xf(t,e,n,i){const{props:s,attrs:r,vnode:{patchFlag:o}}=t,l=ne(s),[a]=t.propsOptions;let c=!1;if((i||o>0)&&!(o&16)){if(o&8){const u=t.vnode.dynamicProps;for(let h=0;h<u.length;h++){let d=u[h];if(cs(t.emitsOptions,d))continue;const _=e[d];if(a)if(J(r,d))_!==r[d]&&(r[d]=_,c=!0);else{const E=Tn(d);s[E]=er(a,l,E,_,t,!1)}else _!==r[d]&&(r[d]=_,c=!0)}}}else{Qa(t,e,s,r)&&(c=!0);let u;for(const h in l)(!e||!J(e,h)&&((u=Dn(h))===h||!J(e,u)))&&(a?n&&(n[h]!==void 0||n[u]!==void 0)&&(s[h]=er(a,l,h,void 0,t,!0)):delete s[h]);if(r!==l)for(const h in r)(!e||!J(e,h)&&!0)&&(delete r[h],c=!0)}c&&vt(t,"set","$attrs")}function Qa(t,e,n,i){const[s,r]=t.propsOptions;let o=!1,l;if(e)for(let a in e){if(Oi(a))continue;const c=e[a];let u;s&&J(s,u=Tn(a))?!r||!r.includes(u)?n[u]=c:(l||(l={}))[u]=c:cs(t.emitsOptions,a)||(!(a in i)||c!==i[a])&&(i[a]=c,o=!0)}if(r){const a=ne(n),c=l||fe;for(let u=0;u<r.length;u++){const h=r[u];n[h]=er(s,a,h,c[h],t,!J(c,h))}}return o}function er(t,e,n,i,s,r){const o=t[n];if(o!=null){const l=J(o,"default");if(l&&i===void 0){const a=o.default;if(o.type!==Function&&K(a)){const{propsDefaults:c}=s;n in c?i=c[n]:(Nn(s),i=c[n]=a.call(null,e),Qt())}else i=a}o[0]&&(r&&!l?i=!1:o[1]&&(i===""||i===Dn(n))&&(i=!0))}return i}function Ja(t,e,n=!1){const i=e.propsCache,s=i.get(t);if(s)return s;const r=t.props,o={},l=[];let a=!1;if(!K(t)){const u=h=>{a=!0;const[d,_]=Ja(h,e,!0);De(o,d),_&&l.push(..._)};!n&&e.mixins.length&&e.mixins.forEach(u),t.extends&&u(t.extends),t.mixins&&t.mixins.forEach(u)}if(!r&&!a)return ye(t)&&i.set(t,gn),gn;if(z(r))for(let u=0;u<r.length;u++){const h=Tn(r[u]);Jo(h)&&(o[h]=fe)}else if(r)for(const u in r){const h=Tn(u);if(Jo(h)){const d=r[u],_=o[h]=z(d)||K(d)?{type:d}:d;if(_){const E=el(Boolean,_.type),O=el(String,_.type);_[0]=E>-1,_[1]=O<0||E<O,(E>-1||J(_,"default"))&&l.push(h)}}}const c=[o,l];return ye(t)&&i.set(t,c),c}function Jo(t){return t[0]!=="$"}function Xo(t){const e=t&&t.toString().match(/^\s*function (\w+)/);return e?e[1]:t===null?"null":""}function Zo(t,e){return Xo(t)===Xo(e)}function el(t,e){return z(e)?e.findIndex(n=>Zo(n,t)):K(e)&&Zo(e,t)?0:-1}const Xa=t=>t[0]==="_"||t==="$stable",Vr=t=>z(t)?t.map(ct):[ct(t)],Of=(t,e,n)=>{if(e._n)return e;const i=Zh((...s)=>Vr(e(...s)),n);return i._c=!1,i},Za=(t,e,n)=>{const i=t._ctx;for(const s in t){if(Xa(s))continue;const r=t[s];if(K(r))e[s]=Of(s,r,i);else if(r!=null){const o=Vr(r);e[s]=()=>o}}},ec=(t,e)=>{const n=Vr(e);t.slots.default=()=>n},kf=(t,e)=>{if(t.vnode.shapeFlag&32){const n=e._;n?(t.slots=ne(e),Fi(e,"_",n)):Za(e,t.slots={})}else t.slots={},e&&ec(t,e);Fi(t.slots,ds,1)},Df=(t,e,n)=>{const{vnode:i,slots:s}=t;let r=!0,o=fe;if(i.shapeFlag&32){const l=e._;l?n&&l===1?r=!1:(De(s,e),!n&&l===1&&delete s._):(r=!e.$stable,Za(e,s)),o=e}else e&&(ec(t,e),o={default:1});if(r)for(const l in s)!Xa(l)&&!(l in o)&&delete s[l]};function tc(){return{app:null,config:{isNativeTag:ih,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Mf=0;function Pf(t,e){return function(i,s=null){K(i)||(i=Object.assign({},i)),s!=null&&!ye(s)&&(s=null);const r=tc(),o=new Set;let l=!1;const a=r.app={_uid:Mf++,_component:i,_props:s,_container:null,_context:r,_instance:null,version:id,get config(){return r.config},set config(c){},use(c,...u){return o.has(c)||(c&&K(c.install)?(o.add(c),c.install(a,...u)):K(c)&&(o.add(c),c(a,...u))),a},mixin(c){return r.mixins.includes(c)||r.mixins.push(c),a},component(c,u){return u?(r.components[c]=u,a):r.components[c]},directive(c,u){return u?(r.directives[c]=u,a):r.directives[c]},mount(c,u,h){if(!l){const d=ft(i,s);return d.appContext=r,u&&e?e(d,c):t(d,c,h),l=!0,a._container=c,c.__vue_app__=a,Kr(d.component)||d.component.proxy}},unmount(){l&&(t(null,a._container),delete a._container.__vue_app__)},provide(c,u){return r.provides[c]=u,a}};return a}}function tr(t,e,n,i,s=!1){if(z(t)){t.forEach((d,_)=>tr(d,e&&(z(e)?e[_]:e),n,i,s));return}if(Di(i)&&!s)return;const r=i.shapeFlag&4?Kr(i.component)||i.component.proxy:i.el,o=s?null:r,{i:l,r:a}=t,c=e&&e.r,u=l.refs===fe?l.refs={}:l.refs,h=l.setupState;if(c!=null&&c!==a&&(Te(c)?(u[c]=null,J(h,c)&&(h[c]=null)):ke(c)&&(c.value=null)),K(a))Rt(a,l,12,[o,u]);else{const d=Te(a),_=ke(a);if(d||_){const E=()=>{if(t.f){const O=d?u[a]:a.value;s?z(O)&&Rr(O,r):z(O)?O.includes(r)||O.push(r):d?(u[a]=[r],J(h,a)&&(h[a]=u[a])):(a.value=[r],t.k&&(u[t.k]=a.value))}else d?(u[a]=o,J(h,a)&&(h[a]=o)):_&&(a.value=o,t.k&&(u[t.k]=o))};o?(E.id=-1,Le(E,n)):E()}}}const Le=of;function Ff(t){return Lf(t)}function Lf(t,e){const n=uh();n.__VUE__=!0;const{insert:i,remove:s,patchProp:r,createElement:o,createText:l,createComment:a,setText:c,setElementText:u,parentNode:h,nextSibling:d,setScopeId:_=nt,cloneNode:E,insertStaticContent:O}=t,M=(f,p,g,v=null,y=null,T=null,k=!1,w=null,A=!!p.dynamicChildren)=>{if(f===p)return;f&&!zt(f,p)&&(v=Ge(f),_e(f,y,T,!0),f=null),p.patchFlag===-2&&(A=!1,p.dynamicChildren=null);const{type:C,ref:$,shapeFlag:F}=p;switch(C){case jr:H(f,p,g,v);break;case it:ue(f,p,g,v);break;case As:f==null&&X(p,g,v,k);break;case We:N(f,p,g,v,y,T,k,w,A);break;default:F&1?Ce(f,p,g,v,y,T,k,w,A):F&6?R(f,p,g,v,y,T,k,w,A):(F&64||F&128)&&C.process(f,p,g,v,y,T,k,w,A,Pe)}$!=null&&y&&tr($,f&&f.ref,T,p||f,!p)},H=(f,p,g,v)=>{if(f==null)i(p.el=l(p.children),g,v);else{const y=p.el=f.el;p.children!==f.children&&c(y,p.children)}},ue=(f,p,g,v)=>{f==null?i(p.el=a(p.children||""),g,v):p.el=f.el},X=(f,p,g,v)=>{[f.el,f.anchor]=O(f.children,p,g,v,f.el,f.anchor)},Q=({el:f,anchor:p},g,v)=>{let y;for(;f&&f!==p;)y=d(f),i(f,g,v),f=y;i(p,g,v)},pe=({el:f,anchor:p})=>{let g;for(;f&&f!==p;)g=d(f),s(f),f=g;s(p)},Ce=(f,p,g,v,y,T,k,w,A)=>{k=k||p.type==="svg",f==null?Se(p,g,v,y,T,k,w,A):S(f,p,y,T,k,w,A)},Se=(f,p,g,v,y,T,k,w)=>{let A,C;const{type:$,props:F,shapeFlag:B,transition:j,patchFlag:Z,dirs:oe}=f;if(f.el&&E!==void 0&&Z===-1)A=f.el=E(f.el);else{if(A=f.el=o(f.type,T,F&&F.is,F),B&8?u(A,f.children):B&16&&m(f.children,A,null,v,y,T&&$!=="foreignObject",k,w),oe&&$t(f,null,v,"created"),F){for(const ge in F)ge!=="value"&&!Oi(ge)&&r(A,ge,null,F[ge],T,f.children,v,y,Me);"value"in F&&r(A,"value",null,F.value),(C=F.onVnodeBeforeMount)&&ot(C,v,f)}P(A,f,f.scopeId,k,v)}oe&&$t(f,null,v,"beforeMount");const le=(!y||y&&!y.pendingBranch)&&j&&!j.persisted;le&&j.beforeEnter(A),i(A,p,g),((C=F&&F.onVnodeMounted)||le||oe)&&Le(()=>{C&&ot(C,v,f),le&&j.enter(A),oe&&$t(f,null,v,"mounted")},y)},P=(f,p,g,v,y)=>{if(g&&_(f,g),v)for(let T=0;T<v.length;T++)_(f,v[T]);if(y){let T=y.subTree;if(p===T){const k=y.vnode;P(f,k,k.scopeId,k.slotScopeIds,y.parent)}}},m=(f,p,g,v,y,T,k,w,A=0)=>{for(let C=A;C<f.length;C++){const $=f[C]=w?Nt(f[C]):ct(f[C]);M(null,$,p,g,v,y,T,k,w)}},S=(f,p,g,v,y,T,k)=>{const w=p.el=f.el;let{patchFlag:A,dynamicChildren:C,dirs:$}=p;A|=f.patchFlag&16;const F=f.props||fe,B=p.props||fe;let j;g&&Bt(g,!1),(j=B.onVnodeBeforeUpdate)&&ot(j,g,p,f),$&&$t(p,f,g,"beforeUpdate"),g&&Bt(g,!0);const Z=y&&p.type!=="foreignObject";if(C?U(f.dynamicChildren,C,w,g,v,Z,T):k||W(f,p,w,null,g,v,Z,T,!1),A>0){if(A&16)re(w,p,F,B,g,v,y);else if(A&2&&F.class!==B.class&&r(w,"class",null,B.class,y),A&4&&r(w,"style",F.style,B.style,y),A&8){const oe=p.dynamicProps;for(let le=0;le<oe.length;le++){const ge=oe[le],Qe=F[ge],hn=B[ge];(hn!==Qe||ge==="value")&&r(w,ge,Qe,hn,y,f.children,g,v,Me)}}A&1&&f.children!==p.children&&u(w,p.children)}else!k&&C==null&&re(w,p,F,B,g,v,y);((j=B.onVnodeUpdated)||$)&&Le(()=>{j&&ot(j,g,p,f),$&&$t(p,f,g,"updated")},v)},U=(f,p,g,v,y,T,k)=>{for(let w=0;w<p.length;w++){const A=f[w],C=p[w],$=A.el&&(A.type===We||!zt(A,C)||A.shapeFlag&70)?h(A.el):g;M(A,C,$,null,v,y,T,k,!0)}},re=(f,p,g,v,y,T,k)=>{if(g!==v){for(const w in v){if(Oi(w))continue;const A=v[w],C=g[w];A!==C&&w!=="value"&&r(f,w,C,A,k,p.children,y,T,Me)}if(g!==fe)for(const w in g)!Oi(w)&&!(w in v)&&r(f,w,g[w],null,k,p.children,y,T,Me);"value"in v&&r(f,"value",g.value,v.value)}},N=(f,p,g,v,y,T,k,w,A)=>{const C=p.el=f?f.el:l(""),$=p.anchor=f?f.anchor:l("");let{patchFlag:F,dynamicChildren:B,slotScopeIds:j}=p;j&&(w=w?w.concat(j):j),f==null?(i(C,g,v),i($,g,v),m(p.children,g,$,y,T,k,w,A)):F>0&&F&64&&B&&f.dynamicChildren?(U(f.dynamicChildren,B,g,y,T,k,w),(p.key!=null||y&&p===y.subTree)&&nc(f,p,!0)):W(f,p,g,$,y,T,k,w,A)},R=(f,p,g,v,y,T,k,w,A)=>{p.slotScopeIds=w,f==null?p.shapeFlag&512?y.ctx.activate(p,g,v,k,A):x(p,g,v,y,T,k,A):L(f,p,A)},x=(f,p,g,v,y,T,k)=>{const w=f.component=Gf(f,v,y);if(hs(f)&&(w.ctx.renderer=Pe),Jf(w),w.asyncDep){if(y&&y.registerDep(w,b),!f.el){const A=w.subTree=ft(it);ue(null,A,p,g)}return}b(w,f,p,g,y,T,k)},L=(f,p,g)=>{const v=p.component=f.component;if(nf(f,p,g))if(v.asyncDep&&!v.asyncResolved){D(v,p,g);return}else v.next=p,qh(v.update),v.update();else p.el=f.el,v.vnode=p},b=(f,p,g,v,y,T,k)=>{const w=()=>{if(f.isMounted){let{next:$,bu:F,u:B,parent:j,vnode:Z}=f,oe=$,le;Bt(f,!1),$?($.el=Z.el,D(f,$,k)):$=Z,F&&Is(F),(le=$.props&&$.props.onVnodeBeforeUpdate)&&ot(le,j,$,Z),Bt(f,!0);const ge=ws(f),Qe=f.subTree;f.subTree=ge,M(Qe,ge,h(Qe.el),Ge(Qe),f,y,T),$.el=ge.el,oe===null&&sf(f,ge.el),B&&Le(B,y),(le=$.props&&$.props.onVnodeUpdated)&&Le(()=>ot(le,j,$,Z),y)}else{let $;const{el:F,props:B}=p,{bm:j,m:Z,parent:oe}=f,le=Di(p);if(Bt(f,!1),j&&Is(j),!le&&($=B&&B.onVnodeBeforeMount)&&ot($,oe,p),Bt(f,!0),F&&It){const ge=()=>{f.subTree=ws(f),It(F,f.subTree,f,y,null)};le?p.type.__asyncLoader().then(()=>!f.isUnmounted&&ge()):ge()}else{const ge=f.subTree=ws(f);M(null,ge,g,v,f,y,T),p.el=ge.el}if(Z&&Le(Z,y),!le&&($=B&&B.onVnodeMounted)){const ge=p;Le(()=>ot($,oe,ge),y)}(p.shapeFlag&256||oe&&Di(oe.vnode)&&oe.vnode.shapeFlag&256)&&f.a&&Le(f.a,y),f.isMounted=!0,p=g=v=null}},A=f.effect=new Dr(w,()=>Hr(C),f.scope),C=f.update=()=>A.run();C.id=f.uid,Bt(f,!0),C()},D=(f,p,g)=>{p.component=f;const v=f.vnode.props;f.vnode=p,f.next=null,xf(f,p.props,v,g),Df(f,p.children,g),Mn(),jo(),Pn()},W=(f,p,g,v,y,T,k,w,A=!1)=>{const C=f&&f.children,$=f?f.shapeFlag:0,F=p.children,{patchFlag:B,shapeFlag:j}=p;if(B>0){if(B&128){he(C,F,g,v,y,T,k,w,A);return}else if(B&256){ee(C,F,g,v,y,T,k,w,A);return}}j&8?($&16&&Me(C,y,T),F!==C&&u(g,F)):$&16?j&16?he(C,F,g,v,y,T,k,w,A):Me(C,y,T,!0):($&8&&u(g,""),j&16&&m(F,g,v,y,T,k,w,A))},ee=(f,p,g,v,y,T,k,w,A)=>{f=f||gn,p=p||gn;const C=f.length,$=p.length,F=Math.min(C,$);let B;for(B=0;B<F;B++){const j=p[B]=A?Nt(p[B]):ct(p[B]);M(f[B],j,g,null,y,T,k,w,A)}C>$?Me(f,y,T,!0,!1,F):m(p,g,v,y,T,k,w,A,F)},he=(f,p,g,v,y,T,k,w,A)=>{let C=0;const $=p.length;let F=f.length-1,B=$-1;for(;C<=F&&C<=B;){const j=f[C],Z=p[C]=A?Nt(p[C]):ct(p[C]);if(zt(j,Z))M(j,Z,g,null,y,T,k,w,A);else break;C++}for(;C<=F&&C<=B;){const j=f[F],Z=p[B]=A?Nt(p[B]):ct(p[B]);if(zt(j,Z))M(j,Z,g,null,y,T,k,w,A);else break;F--,B--}if(C>F){if(C<=B){const j=B+1,Z=j<$?p[j].el:v;for(;C<=B;)M(null,p[C]=A?Nt(p[C]):ct(p[C]),g,Z,y,T,k,w,A),C++}}else if(C>B)for(;C<=F;)_e(f[C],y,T,!0),C++;else{const j=C,Z=C,oe=new Map;for(C=Z;C<=B;C++){const He=p[C]=A?Nt(p[C]):ct(p[C]);He.key!=null&&oe.set(He.key,C)}let le,ge=0;const Qe=B-Z+1;let hn=!1,ko=0;const $n=new Array(Qe);for(C=0;C<Qe;C++)$n[C]=0;for(C=j;C<=F;C++){const He=f[C];if(ge>=Qe){_e(He,y,T,!0);continue}let rt;if(He.key!=null)rt=oe.get(He.key);else for(le=Z;le<=B;le++)if($n[le-Z]===0&&zt(He,p[le])){rt=le;break}rt===void 0?_e(He,y,T,!0):($n[rt-Z]=C+1,rt>=ko?ko=rt:hn=!0,M(He,p[rt],g,null,y,T,k,w,A),ge++)}const Do=hn?Uf($n):gn;for(le=Do.length-1,C=Qe-1;C>=0;C--){const He=Z+C,rt=p[He],Mo=He+1<$?p[He+1].el:v;$n[C]===0?M(null,rt,g,Mo,y,T,k,w,A):hn&&(le<0||C!==Do[le]?se(rt,g,Mo,2):le--)}}},se=(f,p,g,v,y=null)=>{const{el:T,type:k,transition:w,children:A,shapeFlag:C}=f;if(C&6){se(f.component.subTree,p,g,v);return}if(C&128){f.suspense.move(p,g,v);return}if(C&64){k.move(f,p,g,Pe);return}if(k===We){i(T,p,g);for(let F=0;F<A.length;F++)se(A[F],p,g,v);i(f.anchor,p,g);return}if(k===As){Q(f,p,g);return}if(v!==2&&C&1&&w)if(v===0)w.beforeEnter(T),i(T,p,g),Le(()=>w.enter(T),y);else{const{leave:F,delayLeave:B,afterLeave:j}=w,Z=()=>i(T,p,g),oe=()=>{F(T,()=>{Z(),j&&j()})};B?B(T,Z,oe):oe()}else i(T,p,g)},_e=(f,p,g,v=!1,y=!1)=>{const{type:T,props:k,ref:w,children:A,dynamicChildren:C,shapeFlag:$,patchFlag:F,dirs:B}=f;if(w!=null&&tr(w,null,g,f,!0),$&256){p.ctx.deactivate(f);return}const j=$&1&&B,Z=!Di(f);let oe;if(Z&&(oe=k&&k.onVnodeBeforeUnmount)&&ot(oe,p,f),$&6)Lt(f.component,g,v);else{if($&128){f.suspense.unmount(g,v);return}j&&$t(f,null,p,"beforeUnmount"),$&64?f.type.remove(f,p,g,y,Pe,v):C&&(T!==We||F>0&&F&64)?Me(C,p,g,!1,!0):(T===We&&F&384||!y&&$&16)&&Me(A,p,g),v&&qe(f)}(Z&&(oe=k&&k.onVnodeUnmounted)||j)&&Le(()=>{oe&&ot(oe,p,f),j&&$t(f,null,p,"unmounted")},g)},qe=f=>{const{type:p,el:g,anchor:v,transition:y}=f;if(p===We){Ye(g,v);return}if(p===As){pe(f);return}const T=()=>{s(g),y&&!y.persisted&&y.afterLeave&&y.afterLeave()};if(f.shapeFlag&1&&y&&!y.persisted){const{leave:k,delayLeave:w}=y,A=()=>k(g,T);w?w(f.el,T,A):A()}else T()},Ye=(f,p)=>{let g;for(;f!==p;)g=d(f),s(f),f=g;s(p)},Lt=(f,p,g)=>{const{bum:v,scope:y,update:T,subTree:k,um:w}=f;v&&Is(v),y.stop(),T&&(T.active=!1,_e(k,f,p,g)),w&&Le(w,p),Le(()=>{f.isUnmounted=!0},p),p&&p.pendingBranch&&!p.isUnmounted&&f.asyncDep&&!f.asyncResolved&&f.suspenseId===p.pendingId&&(p.deps--,p.deps===0&&p.resolve())},Me=(f,p,g,v=!1,y=!1,T=0)=>{for(let k=T;k<f.length;k++)_e(f[k],p,g,v,y)},Ge=f=>f.shapeFlag&6?Ge(f.component.subTree):f.shapeFlag&128?f.suspense.next():d(f.anchor||f.el),Ne=(f,p,g)=>{f==null?p._vnode&&_e(p._vnode,null,null,!0):M(p._vnode||null,f,p,null,null,null,g),jo(),La(),p._vnode=f},Pe={p:M,um:_e,m:se,r:qe,mt:x,mc:m,pc:W,pbc:U,n:Ge,o:t};let Ut,It;return e&&([Ut,It]=e(Pe)),{render:Ne,hydrate:Ut,createApp:Pf(Ne,Ut)}}function Bt({effect:t,update:e},n){t.allowRecurse=e.allowRecurse=n}function nc(t,e,n=!1){const i=t.children,s=e.children;if(z(i)&&z(s))for(let r=0;r<i.length;r++){const o=i[r];let l=s[r];l.shapeFlag&1&&!l.dynamicChildren&&((l.patchFlag<=0||l.patchFlag===32)&&(l=s[r]=Nt(s[r]),l.el=o.el),n||nc(o,l))}}function Uf(t){const e=t.slice(),n=[0];let i,s,r,o,l;const a=t.length;for(i=0;i<a;i++){const c=t[i];if(c!==0){if(s=n[n.length-1],t[s]<c){e[i]=s,n.push(i);continue}for(r=0,o=n.length-1;r<o;)l=r+o>>1,t[n[l]]<c?r=l+1:o=l;c<t[n[r]]&&(r>0&&(e[i]=n[r-1]),n[r]=i)}}for(r=n.length,o=n[r-1];r-- >0;)n[r]=o,o=e[o];return n}const $f=t=>t.__isTeleport,We=Symbol(void 0),jr=Symbol(void 0),it=Symbol(void 0),As=Symbol(void 0),zn=[];let Ze=null;function gt(t=!1){zn.push(Ze=t?null:[])}function Bf(){zn.pop(),Ze=zn[zn.length-1]||null}let ni=1;function tl(t){ni+=t}function ic(t){return t.dynamicChildren=ni>0?Ze||gn:null,Bf(),ni>0&&Ze&&Ze.push(t),t}function St(t,e,n,i,s,r){return ic(at(t,e,n,i,s,r,!0))}function Hf(t,e,n,i,s){return ic(ft(t,e,n,i,s,!0))}function Wf(t){return t?t.__v_isVNode===!0:!1}function zt(t,e){return t.type===e.type&&t.key===e.key}const ds="__vInternal",sc=({key:t})=>t!=null?t:null,Mi=({ref:t,ref_key:e,ref_for:n})=>t!=null?Te(t)||ke(t)||K(t)?{i:ht,r:t,k:e,f:!!n}:t:null;function at(t,e=null,n=null,i=0,s=null,r=t===We?0:1,o=!1,l=!1){const a={__v_isVNode:!0,__v_skip:!0,type:t,props:e,key:e&&sc(e),ref:e&&Mi(e),scopeId:us,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:r,patchFlag:i,dynamicProps:s,dynamicChildren:null,appContext:null};return l?(zr(a,n),r&128&&t.normalize(a)):n&&(a.shapeFlag|=Te(n)?8:16),ni>0&&!o&&Ze&&(a.patchFlag>0||r&6)&&a.patchFlag!==32&&Ze.push(a),a}const ft=Vf;function Vf(t,e=null,n=null,i=0,s=null,r=!1){if((!t||t===bf)&&(t=it),Wf(t)){const l=Mt(t,e,!0);return n&&zr(l,n),ni>0&&!r&&Ze&&(l.shapeFlag&6?Ze[Ze.indexOf(t)]=l:Ze.push(l)),l.patchFlag|=-2,l}if(td(t)&&(t=t.__vccOpts),e){e=jf(e);let{class:l,style:a}=e;l&&!Te(l)&&(e.class=Nr(l)),ye(a)&&(Ra(a)&&!z(a)&&(a=De({},a)),e.style=Sr(a))}const o=Te(t)?1:rf(t)?128:$f(t)?64:ye(t)?4:K(t)?2:0;return at(t,e,n,i,s,o,r,!0)}function jf(t){return t?Ra(t)||ds in t?De({},t):t:null}function Mt(t,e,n=!1){const{props:i,ref:s,patchFlag:r,children:o}=t,l=e?Kf(i||{},e):i;return{__v_isVNode:!0,__v_skip:!0,type:t.type,props:l,key:l&&sc(l),ref:e&&e.ref?n&&s?z(s)?s.concat(Mi(e)):[s,Mi(e)]:Mi(e):s,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:o,target:t.target,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:e&&t.type!==We?r===-1?16:r|16:r,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:t.transition,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&Mt(t.ssContent),ssFallback:t.ssFallback&&Mt(t.ssFallback),el:t.el,anchor:t.anchor}}function zf(t=" ",e=0){return ft(jr,null,t,e)}function nl(t="",e=!1){return e?(gt(),Hf(it,null,t)):ft(it,null,t)}function ct(t){return t==null||typeof t=="boolean"?ft(it):z(t)?ft(We,null,t.slice()):typeof t=="object"?Nt(t):ft(jr,null,String(t))}function Nt(t){return t.el===null||t.memo?t:Mt(t)}function zr(t,e){let n=0;const{shapeFlag:i}=t;if(e==null)e=null;else if(z(e))n=16;else if(typeof e=="object")if(i&65){const s=e.default;s&&(s._c&&(s._d=!1),zr(t,s()),s._c&&(s._d=!0));return}else{n=32;const s=e._;!s&&!(ds in e)?e._ctx=ht:s===3&&ht&&(ht.slots._===1?e._=1:(e._=2,t.patchFlag|=1024))}else K(e)?(e={default:e,_ctx:ht},n=32):(e=String(e),i&64?(n=16,e=[zf(e)]):n=8);t.children=e,t.shapeFlag|=n}function Kf(...t){const e={};for(let n=0;n<t.length;n++){const i=t[n];for(const s in i)if(s==="class")e.class!==i.class&&(e.class=Nr([e.class,i.class]));else if(s==="style")e.style=Sr([e.style,i.style]);else if(ss(s)){const r=e[s],o=i[s];o&&r!==o&&!(z(r)&&r.includes(o))&&(e[s]=r?[].concat(r,o):o)}else s!==""&&(e[s]=i[s])}return e}function ot(t,e,n,i=null){Ke(t,e,7,[n,i])}const qf=tc();let Yf=0;function Gf(t,e,n){const i=t.type,s=(e?e.appContext:t.appContext)||qf,r={uid:Yf++,vnode:t,type:i,parent:e,appContext:s,root:null,next:null,subTree:null,effect:null,update:null,scope:new hh(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(s.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:Ja(i,s),emitsOptions:$a(i,s),emit:null,emitted:null,propsDefaults:fe,inheritAttrs:i.inheritAttrs,ctx:fe,data:fe,props:fe,attrs:fe,slots:fe,refs:fe,setupState:fe,setupContext:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return r.ctx={_:r},r.root=e?e.root:r,r.emit=Qh.bind(null,r),t.ce&&t.ce(r),r}let Ae=null;const Qf=()=>Ae||ht,Nn=t=>{Ae=t,t.scope.on()},Qt=()=>{Ae&&Ae.scope.off(),Ae=null};function rc(t){return t.vnode.shapeFlag&4}let ii=!1;function Jf(t,e=!1){ii=e;const{props:n,children:i}=t.vnode,s=rc(t);Rf(t,n,s,e),kf(t,i);const r=s?Xf(t,e):void 0;return ii=!1,r}function Xf(t,e){const n=t.type;t.accessCache=Object.create(null),t.proxy=xa(new Proxy(t.ctx,If));const{setup:i}=n;if(i){const s=t.setupContext=i.length>1?ed(t):null;Nn(t),Mn();const r=Rt(i,t,0,[t.props,s]);if(Pn(),Qt(),pa(r)){if(r.then(Qt,Qt),e)return r.then(o=>{il(t,o,e)}).catch(o=>{as(o,t,0)});t.asyncDep=r}else il(t,r,e)}else oc(t,e)}function il(t,e,n){K(e)?t.type.__ssrInlineRender?t.ssrRender=e:t.render=e:ye(e)&&(t.setupState=Da(e)),oc(t,n)}let sl;function oc(t,e,n){const i=t.type;if(!t.render){if(!e&&sl&&!i.render){const s=i.template||Wr(t).template;if(s){const{isCustomElement:r,compilerOptions:o}=t.appContext.config,{delimiters:l,compilerOptions:a}=i,c=De(De({isCustomElement:r,delimiters:l},o),a);i.render=sl(s,c)}}t.render=i.render||nt}Nn(t),Mn(),wf(t),Pn(),Qt()}function Zf(t){return new Proxy(t.attrs,{get(e,n){return je(t,"get","$attrs"),e[n]}})}function ed(t){const e=i=>{t.exposed=i||{}};let n;return{get attrs(){return n||(n=Zf(t))},slots:t.slots,emit:t.emit,expose:e}}function Kr(t){if(t.exposed)return t.exposeProxy||(t.exposeProxy=new Proxy(Da(xa(t.exposed)),{get(e,n){if(n in e)return e[n];if(n in $i)return $i[n](t)}}))}function td(t){return K(t)&&"__vccOpts"in t}const nd=(t,e)=>Vh(t,e,ii),id="3.2.39",sd="http://www.w3.org/2000/svg",Kt=typeof document!="undefined"?document:null,rl=Kt&&Kt.createElement("template"),rd={insert:(t,e,n)=>{e.insertBefore(t,n||null)},remove:t=>{const e=t.parentNode;e&&e.removeChild(t)},createElement:(t,e,n,i)=>{const s=e?Kt.createElementNS(sd,t):Kt.createElement(t,n?{is:n}:void 0);return t==="select"&&i&&i.multiple!=null&&s.setAttribute("multiple",i.multiple),s},createText:t=>Kt.createTextNode(t),createComment:t=>Kt.createComment(t),setText:(t,e)=>{t.nodeValue=e},setElementText:(t,e)=>{t.textContent=e},parentNode:t=>t.parentNode,nextSibling:t=>t.nextSibling,querySelector:t=>Kt.querySelector(t),setScopeId(t,e){t.setAttribute(e,"")},cloneNode(t){const e=t.cloneNode(!0);return"_value"in t&&(e._value=t._value),e},insertStaticContent(t,e,n,i,s,r){const o=n?n.previousSibling:e.lastChild;if(s&&(s===r||s.nextSibling))for(;e.insertBefore(s.cloneNode(!0),n),!(s===r||!(s=s.nextSibling)););else{rl.innerHTML=i?`<svg>${t}</svg>`:t;const l=rl.content;if(i){const a=l.firstChild;for(;a.firstChild;)l.appendChild(a.firstChild);l.removeChild(a)}e.insertBefore(l,n)}return[o?o.nextSibling:e.firstChild,n?n.previousSibling:e.lastChild]}};function od(t,e,n){const i=t._vtc;i&&(e=(e?[e,...i]:[...i]).join(" ")),e==null?t.removeAttribute("class"):n?t.setAttribute("class",e):t.className=e}function ld(t,e,n){const i=t.style,s=Te(n);if(n&&!s){for(const r in n)nr(i,r,n[r]);if(e&&!Te(e))for(const r in e)n[r]==null&&nr(i,r,"")}else{const r=i.display;s?e!==n&&(i.cssText=n):e&&t.removeAttribute("style"),"_vod"in t&&(i.display=r)}}const ol=/\s*!important$/;function nr(t,e,n){if(z(n))n.forEach(i=>nr(t,e,i));else if(n==null&&(n=""),e.startsWith("--"))t.setProperty(e,n);else{const i=ad(t,e);ol.test(n)?t.setProperty(Dn(i),n.replace(ol,""),"important"):t[i]=n}}const ll=["Webkit","Moz","ms"],Rs={};function ad(t,e){const n=Rs[e];if(n)return n;let i=Tn(e);if(i!=="filter"&&i in t)return Rs[e]=i;i=ma(i);for(let s=0;s<ll.length;s++){const r=ll[s]+i;if(r in t)return Rs[e]=r}return e}const al="http://www.w3.org/1999/xlink";function cd(t,e,n,i,s){if(i&&e.startsWith("xlink:"))n==null?t.removeAttributeNS(al,e.slice(6,e.length)):t.setAttributeNS(al,e,n);else{const r=Zu(e);n==null||r&&!ha(n)?t.removeAttribute(e):t.setAttribute(e,r?"":n)}}function ud(t,e,n,i,s,r,o){if(e==="innerHTML"||e==="textContent"){i&&o(i,s,r),t[e]=n==null?"":n;return}if(e==="value"&&t.tagName!=="PROGRESS"&&!t.tagName.includes("-")){t._value=n;const a=n==null?"":n;(t.value!==a||t.tagName==="OPTION")&&(t.value=a),n==null&&t.removeAttribute(e);return}let l=!1;if(n===""||n==null){const a=typeof t[e];a==="boolean"?n=ha(n):n==null&&a==="string"?(n="",l=!0):a==="number"&&(n=0,l=!0)}try{t[e]=n}catch{}l&&t.removeAttribute(e)}const[lc,hd]=(()=>{let t=Date.now,e=!1;if(typeof window!="undefined"){Date.now()>document.createEvent("Event").timeStamp&&(t=performance.now.bind(performance));const n=navigator.userAgent.match(/firefox\/(\d+)/i);e=!!(n&&Number(n[1])<=53)}return[t,e]})();let ir=0;const fd=Promise.resolve(),dd=()=>{ir=0},pd=()=>ir||(fd.then(dd),ir=lc());function _d(t,e,n,i){t.addEventListener(e,n,i)}function gd(t,e,n,i){t.removeEventListener(e,n,i)}function md(t,e,n,i,s=null){const r=t._vei||(t._vei={}),o=r[e];if(i&&o)o.value=i;else{const[l,a]=yd(e);if(i){const c=r[e]=vd(i,s);_d(t,l,c,a)}else o&&(gd(t,l,o,a),r[e]=void 0)}}const cl=/(?:Once|Passive|Capture)$/;function yd(t){let e;if(cl.test(t)){e={};let i;for(;i=t.match(cl);)t=t.slice(0,t.length-i[0].length),e[i[0].toLowerCase()]=!0}return[t[2]===":"?t.slice(3):Dn(t.slice(2)),e]}function vd(t,e){const n=i=>{const s=i.timeStamp||lc();(hd||s>=n.attached-1)&&Ke(Cd(i,n.value),e,5,[i])};return n.value=t,n.attached=pd(),n}function Cd(t,e){if(z(e)){const n=t.stopImmediatePropagation;return t.stopImmediatePropagation=()=>{n.call(t),t._stopped=!0},e.map(i=>s=>!s._stopped&&i&&i(s))}else return e}const ul=/^on[a-z]/,Ed=(t,e,n,i,s=!1,r,o,l,a)=>{e==="class"?od(t,i,s):e==="style"?ld(t,n,i):ss(e)?Ar(e)||md(t,e,n,i,o):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):bd(t,e,i,s))?ud(t,e,i,r,o,l,a):(e==="true-value"?t._trueValue=i:e==="false-value"&&(t._falseValue=i),cd(t,e,i,s))};function bd(t,e,n,i){return i?!!(e==="innerHTML"||e==="textContent"||e in t&&ul.test(e)&&K(n)):e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&t.tagName==="INPUT"||e==="type"&&t.tagName==="TEXTAREA"||ul.test(e)&&Te(n)?!1:e in t}const Id={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String};hf.props;const wd=De({patchProp:Ed},rd);let hl;function Td(){return hl||(hl=Ff(wd))}const Sd=(...t)=>{const e=Td().createApp(...t),{mount:n}=e;return e.mount=i=>{const s=Nd(i);if(!s)return;const r=e._component;!K(r)&&!r.render&&!r.template&&(r.template=s.innerHTML),s.innerHTML="";const o=n(s,!1,s instanceof SVGElement);return s instanceof Element&&(s.removeAttribute("v-cloak"),s.setAttribute("data-v-app","")),o},e};function Nd(t){return Te(t)?document.querySelector(t):t}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const I=function(t,e){if(!t)throw Fn(e)},Fn=function(t){return new Error("Firebase Database ("+ac.SDK_VERSION+") INTERNAL ASSERT FAILED: "+t)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Md="FirebaseError";class ln extends Error{constructor(e,n,i){super(n),this.code=e,this.customData=i,this.name=Md,Object.setPrototypeOf(this,ln.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,pi.prototype.create)}}class pi{constructor(e,n,i){this.service=e,this.serviceName=n,this.errors=i}create(e,...n){const i=n[0]||{},s=`${this.service}/${e}`,r=this.errors[e],o=r?Pd(r,i):"Error",l=`${this.serviceName}: ${o} (${s}).`;return new ln(s,l,i)}}function Pd(t,e){return t.replace(Fd,(n,i)=>{const s=e[i];return s!=null?String(s):`<${i}?>`})}const Fd=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _c=function(t){let e={},n={},i={},s="";try{const r=t.split(".");e=si(sr(r[0])||""),n=si(sr(r[1])||""),s=r[2],i=n.d||{},delete n.d}catch{}return{header:e,claims:n,data:i,signature:s}},Ld=function(t){const e=_c(t),n=e.claims;return!!n&&typeof n=="object"&&n.hasOwnProperty("iat")},Ud=function(t){const e=_c(t).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vd=function(t){const e=[];let n=0;for(let i=0;i<t.length;i++){let s=t.charCodeAt(i);if(s>=55296&&s<=56319){const r=s-55296;i++,I(i<t.length,"Surrogate pair missing trail surrogate.");const o=t.charCodeAt(i)-56320;s=65536+(r<<10)+o}s<128?e[n++]=s:s<2048?(e[n++]=s>>6|192,e[n++]=s&63|128):s<65536?(e[n++]=s>>12|224,e[n++]=s>>6&63|128,e[n++]=s&63|128):(e[n++]=s>>18|240,e[n++]=s>>12&63|128,e[n++]=s>>6&63|128,e[n++]=s&63|128)}return e},ps=function(t){let e=0;for(let n=0;n<t.length;n++){const i=t.charCodeAt(n);i<128?e++:i<2048?e+=2:i>=55296&&i<=56319?(e+=4,n++):e+=3}return e};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ae;(function(t){t[t.DEBUG=0]="DEBUG",t[t.VERBOSE=1]="VERBOSE",t[t.INFO=2]="INFO",t[t.WARN=3]="WARN",t[t.ERROR=4]="ERROR",t[t.SILENT=5]="SILENT"})(ae||(ae={}));const Yd={debug:ae.DEBUG,verbose:ae.VERBOSE,info:ae.INFO,warn:ae.WARN,error:ae.ERROR,silent:ae.SILENT},Gd=ae.INFO,Qd={[ae.DEBUG]:"log",[ae.VERBOSE]:"log",[ae.INFO]:"info",[ae.WARN]:"warn",[ae.ERROR]:"error"},Jd=(t,e,...n)=>{if(e<t.logLevel)return;const i=new Date().toISOString(),s=Qd[e];if(s)console[s](`[${i}]  ${t.name}:`,...n);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class Jr{constructor(e){this.name=e,this._logLevel=Gd,this._logHandler=Jd,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in ae))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?Yd[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,ae.DEBUG,...e),this._logHandler(this,ae.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,ae.VERBOSE,...e),this._logHandler(this,ae.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,ae.INFO,...e),this._logHandler(this,ae.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,ae.WARN,...e),this._logHandler(this,ae.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,ae.ERROR,...e),this._logHandler(this,ae.ERROR,...e)}}const Xd=(t,e)=>e.some(n=>t instanceof n);let pl,_l;function Zd(){return pl||(pl=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function ep(){return _l||(_l=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const mc=new WeakMap,or=new WeakMap,yc=new WeakMap,Os=new WeakMap,Xr=new WeakMap;function tp(t){const e=new Promise((n,i)=>{const s=()=>{t.removeEventListener("success",r),t.removeEventListener("error",o)},r=()=>{n(xt(t.result)),s()},o=()=>{i(t.error),s()};t.addEventListener("success",r),t.addEventListener("error",o)});return e.then(n=>{n instanceof IDBCursor&&mc.set(n,t)}).catch(()=>{}),Xr.set(e,t),e}function np(t){if(or.has(t))return;const e=new Promise((n,i)=>{const s=()=>{t.removeEventListener("complete",r),t.removeEventListener("error",o),t.removeEventListener("abort",o)},r=()=>{n(),s()},o=()=>{i(t.error||new DOMException("AbortError","AbortError")),s()};t.addEventListener("complete",r),t.addEventListener("error",o),t.addEventListener("abort",o)});or.set(t,e)}let lr={get(t,e,n){if(t instanceof IDBTransaction){if(e==="done")return or.get(t);if(e==="objectStoreNames")return t.objectStoreNames||yc.get(t);if(e==="store")return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return xt(t[e])},set(t,e,n){return t[e]=n,!0},has(t,e){return t instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in t}};function ip(t){lr=t(lr)}function sp(t){return t===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...n){const i=t.call(ks(this),e,...n);return yc.set(i,e.sort?e.sort():[e]),xt(i)}:ep().includes(t)?function(...e){return t.apply(ks(this),e),xt(mc.get(this))}:function(...e){return xt(t.apply(ks(this),e))}}function rp(t){return typeof t=="function"?sp(t):(t instanceof IDBTransaction&&np(t),Xd(t,Zd())?new Proxy(t,lr):t)}function xt(t){if(t instanceof IDBRequest)return tp(t);if(Os.has(t))return Os.get(t);const e=rp(t);return e!==t&&(Os.set(t,e),Xr.set(e,t)),e}const ks=t=>Xr.get(t);function op(t,e,{blocked:n,upgrade:i,blocking:s,terminated:r}={}){const o=indexedDB.open(t,e),l=xt(o);return i&&o.addEventListener("upgradeneeded",a=>{i(xt(o.result),a.oldVersion,a.newVersion,xt(o.transaction))}),n&&o.addEventListener("blocked",()=>n()),l.then(a=>{r&&a.addEventListener("close",()=>r()),s&&a.addEventListener("versionchange",()=>s())}).catch(()=>{}),l}const lp=["get","getKey","getAll","getAllKeys","count"],ap=["put","add","delete","clear"],Ds=new Map;function gl(t,e){if(!(t instanceof IDBDatabase&&!(e in t)&&typeof e=="string"))return;if(Ds.get(e))return Ds.get(e);const n=e.replace(/FromIndex$/,""),i=e!==n,s=ap.includes(n);if(!(n in(i?IDBIndex:IDBObjectStore).prototype)||!(s||lp.includes(n)))return;const r=async function(o,...l){const a=this.transaction(o,s?"readwrite":"readonly");let c=a.store;return i&&(c=c.index(l.shift())),(await Promise.all([c[n](...l),s&&a.done]))[0]};return Ds.set(e,r),r}ip(t=>({...t,get:(e,n,i)=>gl(e,n)||t.get(e,n,i),has:(e,n)=>!!gl(e,n)||t.has(e,n)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vc="[DEFAULT]",Fp={[ar]:"fire-core",[hp]:"fire-core-compat",[dp]:"fire-analytics",[fp]:"fire-analytics-compat",[_p]:"fire-app-check",[pp]:"fire-app-check-compat",[gp]:"fire-auth",[mp]:"fire-auth-compat",[yp]:"fire-rtdb",[vp]:"fire-rtdb-compat",[Cp]:"fire-fn",[Ep]:"fire-fn-compat",[bp]:"fire-iid",[Ip]:"fire-iid-compat",[wp]:"fire-fcm",[Tp]:"fire-fcm-compat",[Sp]:"fire-perf",[Np]:"fire-perf-compat",[Ap]:"fire-rc",[Rp]:"fire-rc-compat",[xp]:"fire-gcs",[Op]:"fire-gcs-compat",[kp]:"fire-fst",[Dp]:"fire-fst-compat","fire-js":"fire-js",[Mp]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zr=Pp;function Hp(t,e={}){typeof e!="object"&&(e={name:e});const n=Object.assign({name:vc,automaticDataCollectionEnabled:!1},e),i=n.name;if(typeof i!="string"||!i)throw en.create("bad-app-name",{appName:String(i)});const s=Wi.get(i);if(s){if(rr(t,s.options)&&rr(n,s.config))return s;throw en.create("duplicate-app",{appName:i})}const r=new qd(i);for(const l of cr.values())r.addComponent(l);const o=new Bp(t,n,r);return Wi.set(i,o),o}function Wp(t=vc){const e=Wi.get(t);if(!e)throw en.create("no-app",{appName:t});return e}function Ot(t,e,n){var i;let s=(i=Fp[t])!==null&&i!==void 0?i:t;n&&(s+=`-${n}`);const r=s.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const l=[`Unable to register library "${s}" with version "${e}":`];r&&l.push(`library name "${s}" contains illegal characters (whitespace or "/")`),r&&o&&l.push("and"),o&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Zt.warn(l.join(" "));return}Rn(new Xt(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vp="firebase-heartbeat-database",jp=1,ri="firebase-heartbeat-store";let Ms=null;function Cc(){return Ms||(Ms=op(Vp,jp,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(ri)}}}).catch(t=>{throw en.create("idb-open",{originalErrorMessage:t.message})})),Ms}async function zp(t){var e;try{return(await Cc()).transaction(ri).objectStore(ri).get(Ec(t))}catch(n){if(n instanceof ln)Zt.warn(n.message);else{const i=en.create("idb-get",{originalErrorMessage:(e=n)===null||e===void 0?void 0:e.message});Zt.warn(i.message)}}}async function yl(t,e){var n;try{const s=(await Cc()).transaction(ri,"readwrite");return await s.objectStore(ri).put(e,Ec(t)),s.done}catch(i){if(i instanceof ln)Zt.warn(i.message);else{const s=en.create("idb-set",{originalErrorMessage:(n=i)===null||n===void 0?void 0:n.message});Zt.warn(s.message)}}}function Ec(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Jp(t){Rn(new Xt("platform-logger",e=>new cp(e),"PRIVATE")),Rn(new Xt("heartbeat",e=>new Yp(e),"PRIVATE")),Ot(ar,ml,t),Ot(ar,ml,"esm2017"),Ot("fire-js","")}Jp("");const El="@firebase/database",bl="0.13.6";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ic=function(t){try{if(typeof window!="undefined"&&typeof window[t]!="undefined"){const e=window[t];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new Zp(e)}}catch{}return new e_},qt=Ic("localStorage"),ur=Ic("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const to="5",Ac="v",Rc="s",xc="r",Oc="f",kc=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,Dc="ls",Mc="p",dr="ac",Pc="websocket",Fc="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class m_{constructor(){this.counters_={}}incrementCounter(e,n=1){Et(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=n}get(){return Rd(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ps={},Fs={};function no(t){const e=t.toString();return Ps[e]||(Ps[e]=new m_),Ps[e]}function y_(t,e){const n=t.toString();return Fs[n]||(Fs[n]=e()),Fs[n]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ji extends jc{constructor(){super(["online"]),this.online_=!0,typeof window!="undefined"&&typeof window.addEventListener!="undefined"&&!Gr()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}static getInstance(){return new ji}getInitialEvent(e){return I(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kl=32,Dl=768;class ce{constructor(e,n){if(n===void 0){this.pieces_=e.split("/");let i=0;for(let s=0;s<this.pieces_.length;s++)this.pieces_[s].length>0&&(this.pieces_[i]=this.pieces_[s],i++);this.pieces_.length=i,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=n}toString(){let e="";for(let n=this.pieceNum_;n<this.pieces_.length;n++)this.pieces_[n]!==""&&(e+="/"+this.pieces_[n]);return e||"/"}}function te(){return new ce("")}function Y(t){return t.pieceNum_>=t.pieces_.length?null:t.pieces_[t.pieceNum_]}function Pt(t){return t.pieces_.length-t.pieceNum_}function de(t){let e=t.pieceNum_;return e<t.pieces_.length&&e++,new ce(t.pieces_,e)}function zc(t){return t.pieceNum_<t.pieces_.length?t.pieces_[t.pieces_.length-1]:null}function H_(t){let e="";for(let n=t.pieceNum_;n<t.pieces_.length;n++)t.pieces_[n]!==""&&(e+="/"+encodeURIComponent(String(t.pieces_[n])));return e||"/"}function Kc(t,e=0){return t.pieces_.slice(t.pieceNum_+e)}function qc(t){if(t.pieceNum_>=t.pieces_.length)return null;const e=[];for(let n=t.pieceNum_;n<t.pieces_.length-1;n++)e.push(t.pieces_[n]);return new ce(e,0)}function Ee(t,e){const n=[];for(let i=t.pieceNum_;i<t.pieces_.length;i++)n.push(t.pieces_[i]);if(e instanceof ce)for(let i=e.pieceNum_;i<e.pieces_.length;i++)n.push(e.pieces_[i]);else{const i=e.split("/");for(let s=0;s<i.length;s++)i[s].length>0&&n.push(i[s])}return new ce(n,0)}function G(t){return t.pieceNum_>=t.pieces_.length}function Ue(t,e){const n=Y(t),i=Y(e);if(n===null)return e;if(n===i)return Ue(de(t),de(e));throw new Error("INTERNAL ERROR: innerPath ("+e+") is not within outerPath ("+t+")")}function so(t,e){if(Pt(t)!==Pt(e))return!1;for(let n=t.pieceNum_,i=e.pieceNum_;n<=t.pieces_.length;n++,i++)if(t.pieces_[n]!==e.pieces_[i])return!1;return!0}function et(t,e){let n=t.pieceNum_,i=e.pieceNum_;if(Pt(t)>Pt(e))return!1;for(;n<t.pieces_.length;){if(t.pieces_[n]!==e.pieces_[i])return!1;++n,++i}return!0}class W_{constructor(e,n){this.errorPrefix_=n,this.parts_=Kc(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let i=0;i<this.parts_.length;i++)this.byteLength_+=ps(this.parts_[i]);Yc(this)}}function V_(t,e){t.parts_.length>0&&(t.byteLength_+=1),t.parts_.push(e),t.byteLength_+=ps(e),Yc(t)}function j_(t){const e=t.parts_.pop();t.byteLength_-=ps(e),t.parts_.length>0&&(t.byteLength_-=1)}function Yc(t){if(t.byteLength_>Dl)throw new Error(t.errorPrefix_+"has a key path longer than "+Dl+" bytes ("+t.byteLength_+").");if(t.parts_.length>kl)throw new Error(t.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+kl+") or object contains a cycle "+Vt(t))}function Vt(t){return t.parts_.length===0?"":"in property '"+t.parts_.join(".")+"'"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _s{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,n){const i=new q(xn,e),s=new q(xn,n);return this.compare(i,s)!==0}minPost(){return q.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let pr;function J_(t){pr=t}const Qc=function(t){return typeof t=="number"?"number:"+Nc(t):"string:"+t},Jc=function(t){if(t.isLeafNode()){const e=t.val();I(typeof e=="string"||typeof e=="number"||typeof e=="object"&&Et(e,".sv"),"Priority must be a string or number.")}else I(t===pr||t.isEmpty(),"priority of unexpected type.");I(t===pr||t.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Xc,Zc;function X_(t){Xc=t}function Z_(t){Zc=t}class eg extends _s{compare(e,n){const i=e.node.getPriority(),s=n.node.getPriority(),r=i.compareTo(s);return r===0?Ln(e.name,n.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,n){return!e.getPriority().equals(n.getPriority())}minPost(){return q.MIN}maxPost(){return new q(nn,new be("[PRIORITY-POST]",Zc))}makePost(e,n){const i=Xc(e);return new q(n,new be("[PRIORITY-POST]",i))}toString(){return".priority"}}const ve=new eg;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tg=Math.log(2);class ng{constructor(e){const n=r=>parseInt(Math.log(r)/tg,10),i=r=>parseInt(Array(r+1).join("1"),2);this.count=n(e+1),this.current_=this.count-1;const s=i(this.count);this.bits_=e+1&s}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const zi=function(t,e,n,i){t.sort(e);const s=function(a,c){const u=c-a;let h,d;if(u===0)return null;if(u===1)return h=t[a],d=n?n(h):h,new Ie(d,h.node,Ie.BLACK,null,null);{const _=parseInt(u/2,10)+a,E=s(a,_),O=s(_+1,c);return h=t[_],d=n?n(h):h,new Ie(d,h.node,Ie.BLACK,E,O)}},r=function(a){let c=null,u=null,h=t.length;const d=function(E,O){const M=h-E,H=h;h-=E;const ue=s(M+1,H),X=t[M],Q=n?n(X):X;_(new Ie(Q,X.node,O,null,ue))},_=function(E){c?(c.left=E,c=E):(u=E,c=E)};for(let E=0;E<a.count;++E){const O=a.nextBitIsOne(),M=Math.pow(2,a.count-(E+1));O?d(M,Ie.BLACK):(d(M,Ie.BLACK),d(M,Ie.RED))}return u},o=new ng(t.length),l=r(o);return new $e(i||e,l)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Us;const fn={};class mt{constructor(e,n){this.indexes_=e,this.indexSet_=n}static get Default(){return I(fn&&ve,"ChildrenNode.ts has not been loaded"),Us=Us||new mt({".priority":fn},{".priority":ve}),Us}get(e){const n=An(this.indexes_,e);if(!n)throw new Error("No index defined for "+e);return n instanceof $e?n:null}hasIndex(e){return Et(this.indexSet_,e.toString())}addIndex(e,n){I(e!==En,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const i=[];let s=!1;const r=n.getIterator(q.Wrap);let o=r.getNext();for(;o;)s=s||e.isDefinedOn(o.node),i.push(o),o=r.getNext();let l;s?l=zi(i,e.getCompare()):l=fn;const a=e.toString(),c=Object.assign({},this.indexSet_);c[a]=e;const u=Object.assign({},this.indexes_);return u[a]=l,new mt(u,c)}addToIndexes(e,n){const i=Hi(this.indexes_,(s,r)=>{const o=An(this.indexSet_,r);if(I(o,"Missing index implementation for "+r),s===fn)if(o.isDefinedOn(e.node)){const l=[],a=n.getIterator(q.Wrap);let c=a.getNext();for(;c;)c.name!==e.name&&l.push(c),c=a.getNext();return l.push(e),zi(l,o.getCompare())}else return fn;else{const l=n.get(e.name);let a=s;return l&&(a=a.remove(new q(e.name,l))),a.insert(e,e.node)}});return new mt(i,this.indexSet_)}removeFromIndexes(e,n){const i=Hi(this.indexes_,s=>{if(s===fn)return s;{const r=n.get(e.name);return r?s.remove(new q(e.name,r)):s}});return new mt(i,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rg extends _s{constructor(e){super(),this.indexPath_=e,I(!G(e)&&Y(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,n){const i=this.extractChild(e.node),s=this.extractChild(n.node),r=i.compareTo(s);return r===0?Ln(e.name,n.name):r}makePost(e,n){const i=xe(e),s=V.EMPTY_NODE.updateChild(this.indexPath_,i);return new q(n,s)}maxPost(){const e=V.EMPTY_NODE.updateChild(this.indexPath_,yi);return new q(nn,e)}toString(){return Kc(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class og extends _s{compare(e,n){const i=e.node.compareTo(n.node);return i===0?Ln(e.name,n.name):i}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return q.MIN}maxPost(){return q.MAX}makePost(e,n){const i=xe(e);return new q(n,i)}toString(){return".value"}}const lg=new og;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ci{constructor(e){this.indexedFilter_=new lo(e.getIndex()),this.index_=e.getIndex(),this.startPost_=ci.getStartPost_(e),this.endPost_=ci.getEndPost_(e)}getStartPost(){return this.startPost_}getEndPost(){return this.endPost_}matches(e){return this.index_.compare(this.getStartPost(),e)<=0&&this.index_.compare(e,this.getEndPost())<=0}updateChild(e,n,i,s,r,o){return this.matches(new q(n,i))||(i=V.EMPTY_NODE),this.indexedFilter_.updateChild(e,n,i,s,r,o)}updateFullNode(e,n,i){n.isLeafNode()&&(n=V.EMPTY_NODE);let s=n.withIndex(this.index_);s=s.updatePriority(V.EMPTY_NODE);const r=this;return n.forEachChild(ve,(o,l)=>{r.matches(new q(o,l))||(s=s.updateImmediateChild(o,V.EMPTY_NODE))}),this.indexedFilter_.updateFullNode(e,s,i)}updatePriority(e,n){return e}filtersNodes(){return!0}getIndexedFilter(){return this.indexedFilter_}getIndex(){return this.index_}static getStartPost_(e){if(e.hasStart()){const n=e.getIndexStartName();return e.getIndex().makePost(e.getIndexStartValue(),n)}else return e.getIndex().minPost()}static getEndPost_(e){if(e.hasEnd()){const n=e.getIndexEndName();return e.getIndex().makePost(e.getIndexEndValue(),n)}else return e.getIndex().maxPost()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qi(){return{value:null,children:new Map}}function tu(t,e,n){if(G(e))t.value=n,t.children.clear();else if(t.value!==null)t.value=t.value.updateChild(e,n);else{const i=Y(e);t.children.has(i)||t.children.set(i,qi());const s=t.children.get(i);e=de(e),tu(s,e,n)}}function _r(t,e,n){t.value!==null?n(e,t.value):fg(t,(i,s)=>{const r=new ce(e.toString()+"/"+i);_r(s,r,n)})}function fg(t,e){t.children.forEach((n,i)=>{e(i,n)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yi{constructor(e,n,i){this.path=e,this.affectedTree=n,this.revert=i,this.type=tt.ACK_USER_WRITE,this.source=nu()}operationForChild(e){if(G(this.path)){if(this.affectedTree.value!=null)return I(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new ce(e));return new Yi(te(),n,this.revert)}}else return I(Y(this.path)===e,"operationForChild called for unrelated child."),new Yi(de(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sn{constructor(e,n,i){this.source=e,this.path=n,this.snap=i,this.type=tt.OVERWRITE}operationForChild(e){return G(this.path)?new sn(this.source,te(),this.snap.getImmediateChild(e)):new sn(this.source,de(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hi{constructor(e,n,i){this.source=e,this.path=n,this.children=i,this.type=tt.MERGE}operationForChild(e){if(G(this.path)){const n=this.children.subtree(new ce(e));return n.isEmpty()?null:n.value?new sn(this.source,te(),n.value):new hi(this.source,te(),n)}else return I(Y(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new hi(this.source,de(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gs(t,e){return{eventCache:t,serverCache:e}}function qn(t,e,n,i){return gs(new rn(e,n,i),t.serverCache)}function iu(t,e,n,i){return gs(t.eventCache,new rn(e,n,i))}function gr(t){return t.eventCache.isFullyInitialized()?t.eventCache.getNode():null}function on(t){return t.serverCache.isFullyInitialized()?t.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pg{constructor(){this.changeMap=new Map}trackChildChange(e){const n=e.type,i=e.childName;I(n==="child_added"||n==="child_changed"||n==="child_removed","Only child changes supported for tracking"),I(i!==".priority","Only non-priority child changes can be tracked.");const s=this.changeMap.get(i);if(s){const r=s.type;if(n==="child_added"&&r==="child_removed")this.changeMap.set(i,ai(i,e.snapshotNode,s.snapshotNode));else if(n==="child_removed"&&r==="child_added")this.changeMap.delete(i);else if(n==="child_removed"&&r==="child_changed")this.changeMap.set(i,li(i,s.oldSnap));else if(n==="child_changed"&&r==="child_added")this.changeMap.set(i,On(i,e.snapshotNode));else if(n==="child_changed"&&r==="child_changed")this.changeMap.set(i,ai(i,e.snapshotNode,s.oldSnap));else throw Fn("Illegal combination of changes: "+e+" occurred after "+s)}else this.changeMap.set(i,e)}getChanges(){return Array.from(this.changeMap.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fg{getCompleteChild(e){return null}getChildAfterChild(e,n,i){return null}}const cu=new Fg;class _o{constructor(e,n,i=null){this.writes_=e,this.viewCache_=n,this.optCompleteServerCache_=i}getCompleteChild(e){const n=this.viewCache_.eventCache;if(n.isCompleteForChild(e))return n.getNode().getImmediateChild(e);{const i=this.optCompleteServerCache_!=null?new rn(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return po(this.writes_,e,i)}}getChildAfterChild(e,n,i){const s=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:on(this.viewCache_),r=Mg(this.writes_,s,n,1,i,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lg(t){return{filter:t}}function Ug(t,e){I(e.eventCache.getNode().isIndexed(t.filter.getIndex()),"Event snap not indexed"),I(e.serverCache.getNode().isIndexed(t.filter.getIndex()),"Server snap not indexed")}function $g(t,e,n,i,s){const r=new Pg;let o,l;if(n.type===tt.OVERWRITE){const c=n;c.source.fromUser?o=vr(t,e,c.path,c.snap,i,s,r):(I(c.source.fromServer,"Unknown source."),l=c.source.tagged||e.serverCache.isFiltered()&&!G(c.path),o=Ji(t,e,c.path,c.snap,i,s,l,r))}else if(n.type===tt.MERGE){const c=n;c.source.fromUser?o=Hg(t,e,c.path,c.children,i,s,r):(I(c.source.fromServer,"Unknown source."),l=c.source.tagged||e.serverCache.isFiltered(),o=Cr(t,e,c.path,c.children,i,s,l,r))}else if(n.type===tt.ACK_USER_WRITE){const c=n;c.revert?o=jg(t,e,c.path,i,s,r):o=Wg(t,e,c.path,c.affectedTree,i,s,r)}else if(n.type===tt.LISTEN_COMPLETE)o=Vg(t,e,n.path,i,r);else throw Fn("Unknown operation type: "+n.type);const a=r.getChanges();return Bg(e,o,a),{viewCache:o,changes:a}}function Bg(t,e,n){const i=e.eventCache;if(i.isFullyInitialized()){const s=i.getNode().isLeafNode()||i.getNode().isEmpty(),r=gr(t);(n.length>0||!t.eventCache.isFullyInitialized()||s&&!i.getNode().equals(r)||!i.getNode().getPriority().equals(r.getPriority()))&&n.push(eu(gr(e)))}}function uu(t,e,n,i,s,r){const o=e.eventCache;if(Qi(i,n)!=null)return e;{let l,a;if(G(n))if(I(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const c=on(e),u=c instanceof V?c:V.EMPTY_NODE,h=fo(i,u);l=t.filter.updateFullNode(e.eventCache.getNode(),h,r)}else{const c=Gi(i,on(e));l=t.filter.updateFullNode(e.eventCache.getNode(),c,r)}else{const c=Y(n);if(c===".priority"){I(Pt(n)===1,"Can't have a priority with additional path components");const u=o.getNode();a=e.serverCache.getNode();const h=Vl(i,n,u,a);h!=null?l=t.filter.updatePriority(u,h):l=o.getNode()}else{const u=de(n);let h;if(o.isCompleteForChild(c)){a=e.serverCache.getNode();const d=Vl(i,n,o.getNode(),a);d!=null?h=o.getNode().getImmediateChild(c).updateChild(u,d):h=o.getNode().getImmediateChild(c)}else h=po(i,c,e.serverCache);h!=null?l=t.filter.updateChild(o.getNode(),c,h,u,s,r):l=o.getNode()}}return qn(e,l,o.isFullyInitialized()||G(n),t.filter.filtersNodes())}}function Ji(t,e,n,i,s,r,o,l){const a=e.serverCache;let c;const u=o?t.filter:t.filter.getIndexedFilter();if(G(n))c=u.updateFullNode(a.getNode(),i,null);else if(u.filtersNodes()&&!a.isFiltered()){const _=a.getNode().updateChild(n,i);c=u.updateFullNode(a.getNode(),_,null)}else{const _=Y(n);if(!a.isCompleteForPath(n)&&Pt(n)>1)return e;const E=de(n),M=a.getNode().getImmediateChild(_).updateChild(E,i);_===".priority"?c=u.updatePriority(a.getNode(),M):c=u.updateChild(a.getNode(),_,M,E,cu,null)}const h=iu(e,c,a.isFullyInitialized()||G(n),u.filtersNodes()),d=new _o(s,h,r);return uu(t,h,n,s,d,l)}function vr(t,e,n,i,s,r,o){const l=e.eventCache;let a,c;const u=new _o(s,e,r);if(G(n))c=t.filter.updateFullNode(e.eventCache.getNode(),i,o),a=qn(e,c,!0,t.filter.filtersNodes());else{const h=Y(n);if(h===".priority")c=t.filter.updatePriority(e.eventCache.getNode(),i),a=qn(e,c,l.isFullyInitialized(),l.isFiltered());else{const d=de(n),_=l.getNode().getImmediateChild(h);let E;if(G(d))E=i;else{const O=u.getCompleteChild(h);O!=null?zc(d)===".priority"&&O.getChild(qc(d)).isEmpty()?E=O:E=O.updateChild(d,i):E=V.EMPTY_NODE}if(_.equals(E))a=e;else{const O=t.filter.updateChild(l.getNode(),h,E,d,u,o);a=qn(e,O,l.isFullyInitialized(),t.filter.filtersNodes())}}}return a}function jl(t,e){return t.eventCache.isCompleteForChild(e)}function Hg(t,e,n,i,s,r,o){let l=e;return i.foreach((a,c)=>{const u=Ee(n,a);jl(e,Y(u))&&(l=vr(t,l,u,c,s,r,o))}),i.foreach((a,c)=>{const u=Ee(n,a);jl(e,Y(u))||(l=vr(t,l,u,c,s,r,o))}),l}function zl(t,e,n){return n.foreach((i,s)=>{e=e.updateChild(i,s)}),e}function Cr(t,e,n,i,s,r,o,l){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let a=e,c;G(n)?c=i:c=new me(null).setTree(n,i);const u=e.serverCache.getNode();return c.children.inorderTraversal((h,d)=>{if(u.hasChild(h)){const _=e.serverCache.getNode().getImmediateChild(h),E=zl(t,_,d);a=Ji(t,a,new ce(h),E,s,r,o,l)}}),c.children.inorderTraversal((h,d)=>{const _=!e.serverCache.isCompleteForChild(h)&&d.value===null;if(!u.hasChild(h)&&!_){const E=e.serverCache.getNode().getImmediateChild(h),O=zl(t,E,d);a=Ji(t,a,new ce(h),O,s,r,o,l)}}),a}function Wg(t,e,n,i,s,r,o){if(Qi(s,n)!=null)return e;const l=e.serverCache.isFiltered(),a=e.serverCache;if(i.value!=null){if(G(n)&&a.isFullyInitialized()||a.isCompleteForPath(n))return Ji(t,e,n,a.getNode().getChild(n),s,r,l,o);if(G(n)){let c=new me(null);return a.getNode().forEachChild(En,(u,h)=>{c=c.set(new ce(u),h)}),Cr(t,e,n,c,s,r,l,o)}else return e}else{let c=new me(null);return i.foreach((u,h)=>{const d=Ee(n,u);a.isCompleteForPath(d)&&(c=c.set(u,a.getNode().getChild(d)))}),Cr(t,e,n,c,s,r,l,o)}}function Vg(t,e,n,i,s){const r=e.serverCache,o=iu(e,r.getNode(),r.isFullyInitialized()||G(n),r.isFiltered());return uu(t,o,n,i,cu,s)}function jg(t,e,n,i,s,r){let o;if(Qi(i,n)!=null)return e;{const l=new _o(i,e,s),a=e.eventCache.getNode();let c;if(G(n)||Y(n)===".priority"){let u;if(e.serverCache.isFullyInitialized())u=Gi(i,on(e));else{const h=e.serverCache.getNode();I(h instanceof V,"serverChildren would be complete if leaf node"),u=fo(i,h)}u=u,c=t.filter.updateFullNode(a,u,r)}else{const u=Y(n);let h=po(i,u,e.serverCache);h==null&&e.serverCache.isCompleteForChild(u)&&(h=a.getImmediateChild(u)),h!=null?c=t.filter.updateChild(a,u,h,de(n),l,r):e.eventCache.getNode().hasChild(u)?c=t.filter.updateChild(a,u,V.EMPTY_NODE,de(n),l,r):c=a,c.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=Gi(i,on(e)),o.isLeafNode()&&(c=t.filter.updateFullNode(c,o,r)))}return o=e.serverCache.isFullyInitialized()||Qi(i,te())!=null,qn(e,c,o,t.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Xi;class Qg{constructor(){this.views=new Map}}function Jg(t){I(!Xi,"__referenceConstructor has already been defined"),Xi=t}function Xg(){return I(Xi,"Reference.ts has not been loaded"),Xi}function Zg(t){return t.views.size===0}function go(t,e,n,i){const s=e.source.queryId;if(s!==null){const r=t.views.get(s);return I(r!=null,"SyncTree gave us an op for an invalid query."),Yl(r,e,n,i)}else{let r=[];for(const o of t.views.values())r=r.concat(Yl(o,e,n,i));return r}}function em(t,e,n,i,s){const r=e._queryIdentifier,o=t.views.get(r);if(!o){let l=Gi(n,s?i:null),a=!1;l?a=!0:i instanceof V?(l=fo(n,i),a=!1):(l=V.EMPTY_NODE,a=!1);const c=gs(new rn(l,a,!1),new rn(i,s,!1));return new zg(e,c)}return o}function tm(t,e,n,i,s,r){const o=em(t,e,i,s,r);return t.views.has(e._queryIdentifier)||t.views.set(e._queryIdentifier,o),Yg(o,n),Gg(o,n)}function nm(t,e,n,i){const s=e._queryIdentifier,r=[];let o=[];const l=Ft(t);if(s==="default")for(const[a,c]of t.views.entries())o=o.concat(ql(c,n,i)),Kl(c)&&(t.views.delete(a),c.query._queryParams.loadsAllData()||r.push(c.query));else{const a=t.views.get(s);a&&(o=o.concat(ql(a,n,i)),Kl(a)&&(t.views.delete(s),a.query._queryParams.loadsAllData()||r.push(a.query)))}return l&&!Ft(t)&&r.push(new(Xg())(e._repo,e._path)),{removed:r,events:o}}function fu(t){const e=[];for(const n of t.views.values())n.query._queryParams.loadsAllData()||e.push(n);return e}function bn(t,e){let n=null;for(const i of t.views.values())n=n||qg(i,e);return n}function du(t,e){if(e._queryParams.loadsAllData())return ms(t);{const i=e._queryIdentifier;return t.views.get(i)}}function pu(t,e){return du(t,e)!=null}function Ft(t){return ms(t)!=null}function ms(t){for(const e of t.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Zi;function im(t){I(!Zi,"__referenceConstructor has already been defined"),Zi=t}function sm(){return I(Zi,"Reference.ts has not been loaded"),Zi}let rm=1;class Gl{constructor(e){this.listenProvider_=e,this.syncPointTree_=new me(null),this.pendingWriteTree_=Dg(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function om(t,e,n,i,s){return bg(t.pendingWriteTree_,e,n,i,s),s?vi(t,new sn(nu(),e,n)):[]}function _n(t,e,n=!1){const i=Ig(t.pendingWriteTree_,e);if(wg(t.pendingWriteTree_,e)){let r=new me(null);return i.snap!=null?r=r.set(te(),!0):Be(i.children,o=>{r=r.set(new ce(o),!0)}),vi(t,new Yi(i.path,r,n))}else return[]}function ys(t,e,n){return vi(t,new sn(co(),e,n))}function lm(t,e,n){const i=me.fromObject(n);return vi(t,new hi(co(),e,i))}function am(t,e){return vi(t,new ui(co(),e))}function cm(t,e,n){const i=mo(t,n);if(i){const s=yo(i),r=s.path,o=s.queryId,l=Ue(r,e),a=new ui(uo(o),l);return vo(t,r,a)}else return[]}function Er(t,e,n,i,s=!1){const r=e._path,o=t.syncPointTree_.get(r);let l=[];if(o&&(e._queryIdentifier==="default"||pu(o,e))){const a=nm(o,e,n,i);Zg(o)&&(t.syncPointTree_=t.syncPointTree_.remove(r));const c=a.removed;if(l=a.events,!s){const u=c.findIndex(d=>d._queryParams.loadsAllData())!==-1,h=t.syncPointTree_.findOnPath(r,(d,_)=>Ft(_));if(u&&!h){const d=t.syncPointTree_.subtree(r);if(!d.isEmpty()){const _=fm(d);for(let E=0;E<_.length;++E){const O=_[E],M=O.query,H=yu(t,O);t.listenProvider_.startListening(Gn(M),es(t,M),H.hashFn,H.onComplete)}}}!h&&c.length>0&&!i&&(u?t.listenProvider_.stopListening(Gn(e),null):c.forEach(d=>{const _=t.queryToTagMap.get(vs(d));t.listenProvider_.stopListening(Gn(d),_)}))}dm(t,c)}return l}function um(t,e,n,i){const s=mo(t,i);if(s!=null){const r=yo(s),o=r.path,l=r.queryId,a=Ue(o,e),c=new sn(uo(l),a,n);return vo(t,o,c)}else return[]}function hm(t,e,n,i){const s=mo(t,i);if(s){const r=yo(s),o=r.path,l=r.queryId,a=Ue(o,e),c=me.fromObject(n),u=new hi(uo(l),a,c);return vo(t,o,u)}else return[]}function Ql(t,e,n,i=!1){const s=e._path;let r=null,o=!1;t.syncPointTree_.foreachOnPath(s,(d,_)=>{const E=Ue(d,s);r=r||bn(_,E),o=o||Ft(_)});let l=t.syncPointTree_.get(s);l?(o=o||Ft(l),r=r||bn(l,te())):(l=new Qg,t.syncPointTree_=t.syncPointTree_.set(s,l));let a;r!=null?a=!0:(a=!1,r=V.EMPTY_NODE,t.syncPointTree_.subtree(s).foreachChild((_,E)=>{const O=bn(E,te());O&&(r=r.updateImmediateChild(_,O))}));const c=pu(l,e);if(!c&&!e._queryParams.loadsAllData()){const d=vs(e);I(!t.queryToTagMap.has(d),"View does not exist, but we have a tag");const _=pm();t.queryToTagMap.set(d,_),t.tagToQueryMap.set(_,d)}const u=ho(t.pendingWriteTree_,s);let h=tm(l,e,n,u,r,a);if(!c&&!o&&!i){const d=du(l,e);h=h.concat(_m(t,e,d))}return h}function _u(t,e,n){const s=t.pendingWriteTree_,r=t.syncPointTree_.findOnPath(e,(o,l)=>{const a=Ue(o,e),c=bn(l,a);if(c)return c});return ou(s,e,r,n,!0)}function vi(t,e){return gu(e,t.syncPointTree_,null,ho(t.pendingWriteTree_,te()))}function gu(t,e,n,i){if(G(t.path))return mu(t,e,n,i);{const s=e.get(te());n==null&&s!=null&&(n=bn(s,te()));let r=[];const o=Y(t.path),l=t.operationForChild(o),a=e.children.get(o);if(a&&l){const c=n?n.getImmediateChild(o):null,u=lu(i,o);r=r.concat(gu(l,a,c,u))}return s&&(r=r.concat(go(s,t,i,n))),r}}function mu(t,e,n,i){const s=e.get(te());n==null&&s!=null&&(n=bn(s,te()));let r=[];return e.children.inorderTraversal((o,l)=>{const a=n?n.getImmediateChild(o):null,c=lu(i,o),u=t.operationForChild(o);u&&(r=r.concat(mu(u,l,a,c)))}),s&&(r=r.concat(go(s,t,i,n))),r}function yu(t,e){const n=e.query,i=es(t,n);return{hashFn:()=>(Kg(e)||V.EMPTY_NODE).hash(),onComplete:s=>{if(s==="ok")return i?cm(t,n._path,i):am(t,n._path);{const r=a_(s,n);return Er(t,n,null,r)}}}}function es(t,e){const n=vs(e);return t.queryToTagMap.get(n)}function vs(t){return t._path.toString()+"$"+t._queryIdentifier}function mo(t,e){return t.tagToQueryMap.get(e)}function yo(t){const e=t.indexOf("$");return I(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new ce(t.substr(0,e))}}function vo(t,e,n){const i=t.syncPointTree_.get(e);I(i,"Missing sync point for query tag that we're tracking");const s=ho(t.pendingWriteTree_,e);return go(i,n,s,null)}function fm(t){return t.fold((e,n,i)=>{if(n&&Ft(n))return[ms(n)];{let s=[];return n&&(s=fu(n)),Be(i,(r,o)=>{s=s.concat(o)}),s}})}function Gn(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(sm())(t._repo,t._path):t}function dm(t,e){for(let n=0;n<e.length;++n){const i=e[n];if(!i._queryParams.loadsAllData()){const s=vs(i),r=t.queryToTagMap.get(s);t.queryToTagMap.delete(s),t.tagToQueryMap.delete(r)}}}function pm(){return rm++}function _m(t,e,n){const i=e._path,s=es(t,e),r=yu(t,n),o=t.listenProvider_.startListening(Gn(e),s,r.hashFn,r.onComplete),l=t.syncPointTree_.subtree(i);if(s)I(!Ft(l.value),"If we're adding a query, it shouldn't be shadowed");else{const a=l.fold((c,u,h)=>{if(!G(c)&&u&&Ft(u))return[ms(u).query];{let d=[];return u&&(d=d.concat(fu(u).map(_=>_.query))),Be(h,(_,E)=>{d=d.concat(E)}),d}});for(let c=0;c<a.length;++c){const u=a[c];t.listenProvider_.stopListening(Gn(u),es(t,u))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Io{constructor(e="",n=null,i={children:{},childCount:0}){this.name=e,this.parent=n,this.node=i}}function wo(t,e){let n=e instanceof ce?e:new ce(e),i=t,s=Y(n);for(;s!==null;){const r=An(i.node.children,s)||{children:{},childCount:0};i=new Io(s,i,r),n=de(n),s=Y(n)}return i}function Un(t){return t.node.value}function vu(t,e){t.node.value=e,br(t)}function Cu(t){return t.node.childCount>0}function Em(t){return Un(t)===void 0&&!Cu(t)}function Cs(t,e){Be(t.node.children,(n,i)=>{e(new Io(n,t,i))})}function Eu(t,e,n,i){n&&!i&&e(t),Cs(t,s=>{Eu(s,e,!0,i)}),n&&i&&e(t)}function bm(t,e,n){let i=n?t:t.parent;for(;i!==null;){if(e(i))return!0;i=i.parent}return!1}function Ci(t){return new ce(t.parent===null?t.name:Ci(t.parent)+"/"+t.name)}function br(t){t.parent!==null&&Im(t.parent,t.name,t)}function Im(t,e,n){const i=Em(n),s=Et(t.node.children,e);i&&s?(delete t.node.children[e],t.node.childCount--,br(t)):!i&&!s&&(t.node.children[e]=n.node,t.node.childCount++,br(t))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wm=/[\[\].#$\/\u0000-\u001F\u007F]/,Tm=/[\[\].#$\u0000-\u001F\u007F]/,Bs=10*1024*1024,bu=function(t){return typeof t=="string"&&t.length!==0&&!wm.test(t)},Iu=function(t){return typeof t=="string"&&t.length!==0&&!Tm.test(t)},Sm=function(t){return t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),Iu(t)},wu=function(t,e,n){const i=n instanceof ce?new W_(n,t):n;if(e===void 0)throw new Error(t+"contains undefined "+Vt(i));if(typeof e=="function")throw new Error(t+"contains a function "+Vt(i)+" with contents = "+e.toString());if(Tc(e))throw new Error(t+"contains "+e.toString()+" "+Vt(i));if(typeof e=="string"&&e.length>Bs/3&&ps(e)>Bs)throw new Error(t+"contains a string greater than "+Bs+" utf8 bytes "+Vt(i)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let s=!1,r=!1;if(Be(e,(o,l)=>{if(o===".value")s=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!bu(o)))throw new Error(t+" contains an invalid key ("+o+") "+Vt(i)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);V_(i,o),wu(t,l,i),j_(i)}),s&&r)throw new Error(t+' contains ".value" child '+Vt(i)+" in addition to actual children.")}},Tu=function(t,e,n,i){if(!(i&&n===void 0)&&!Iu(n))throw new Error(gc(t,e)+'was an invalid path = "'+n+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},Nm=function(t,e,n,i){n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),Tu(t,e,n,i)},Am=function(t,e){const n=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!bu(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||n.length!==0&&!Sm(n))throw new Error(gc(t,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Om="repo_interrupt",km=25;class Dm{constructor(e,n,i,s){this.repoInfo_=e,this.forceRestClient_=n,this.authTokenProvider_=i,this.appCheckProvider_=s,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Rm,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=qi(),this.transactionQueueTree_=new Io,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function Mm(t,e,n){if(t.stats_=no(t.repoInfo_),t.forceRestClient_||f_())t.server_=new Ki(t.repoInfo_,(i,s,r,o)=>{Xl(t,i,s,r,o)},t.authTokenProvider_,t.appCheckProvider_),setTimeout(()=>Zl(t,!0),0);else{if(typeof n!="undefined"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{we(n)}catch(i){throw new Error("Invalid authOverride provided: "+i)}}t.persistentConnection_=new yt(t.repoInfo_,e,(i,s,r,o)=>{Xl(t,i,s,r,o)},i=>{Zl(t,i)},i=>{Fm(t,i)},t.authTokenProvider_,t.appCheckProvider_,n),t.server_=t.persistentConnection_}t.authTokenProvider_.addTokenChangeListener(i=>{t.server_.refreshAuthToken(i)}),t.appCheckProvider_.addTokenChangeListener(i=>{t.server_.refreshAppCheckToken(i.token)}),t.statsReporter_=y_(t.repoInfo_,()=>new gg(t.stats_,t.server_)),t.infoData_=new hg,t.infoSyncTree_=new Gl({startListening:(i,s,r,o)=>{let l=[];const a=t.infoData_.getNode(i._path);return a.isEmpty()||(l=ys(t.infoSyncTree_,i._path,a),setTimeout(()=>{o("ok")},0)),l},stopListening:()=>{}}),To(t,"connected",!1),t.serverSyncTree_=new Gl({startListening:(i,s,r,o)=>(t.server_.listen(i,r,s,(l,a)=>{const c=o(l,a);un(t.eventQueue_,i._path,c)}),[]),stopListening:(i,s)=>{t.server_.unlisten(i,s)}})}function Pm(t){const n=t.infoData_.getNode(new ce(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function Ru(t){return gm({timestamp:Pm(t)})}function Xl(t,e,n,i,s){t.dataUpdateCount++;const r=new ce(e);n=t.interceptServerDataCallback_?t.interceptServerDataCallback_(e,n):n;let o=[];if(s)if(i){const a=Hi(n,c=>xe(c));o=hm(t.serverSyncTree_,r,a,s)}else{const a=xe(n);o=um(t.serverSyncTree_,r,a,s)}else if(i){const a=Hi(n,c=>xe(c));o=lm(t.serverSyncTree_,r,a)}else{const a=xe(n);o=ys(t.serverSyncTree_,r,a)}let l=r;o.length>0&&(l=No(t,r)),un(t.eventQueue_,l,o)}function Zl(t,e){To(t,"connected",e),e===!1&&Um(t)}function Fm(t,e){Be(e,(n,i)=>{To(t,n,i)})}function To(t,e,n){const i=new ce("/.info/"+e),s=xe(n);t.infoData_.updateSnapshot(i,s);const r=ys(t.infoSyncTree_,i,s);un(t.eventQueue_,i,r)}function Lm(t){return t.nextWriteId_++}function Um(t){xu(t,"onDisconnectEvents");const e=Ru(t),n=qi();_r(t.onDisconnect_,te(),(s,r)=>{const o=vm(s,r,t.serverSyncTree_,e);tu(n,s,o)});let i=[];_r(n,te(),(s,r)=>{i=i.concat(ys(t.serverSyncTree_,s,r));const o=Vm(t,s);No(t,o)}),t.onDisconnect_=qi(),un(t.eventQueue_,te(),i)}function $m(t,e,n){let i;Y(e._path)===".info"?i=Ql(t.infoSyncTree_,e,n):i=Ql(t.serverSyncTree_,e,n),Nu(t.eventQueue_,e._path,i)}function ea(t,e,n){let i;Y(e._path)===".info"?i=Er(t.infoSyncTree_,e,n):i=Er(t.serverSyncTree_,e,n),Nu(t.eventQueue_,e._path,i)}function Bm(t){t.persistentConnection_&&t.persistentConnection_.interrupt(Om)}function xu(t,...e){let n="";t.persistentConnection_&&(n=t.persistentConnection_.id+":"),Re(n,...e)}function Ou(t,e,n){return _u(t.serverSyncTree_,e,n)||V.EMPTY_NODE}function So(t,e=t.transactionQueueTree_){if(e||Es(t,e),Un(e)){const n=Du(t,e);I(n.length>0,"Sending zero length transaction queue"),n.every(s=>s.status===0)&&Hm(t,Ci(e),n)}else Cu(e)&&Cs(e,n=>{So(t,n)})}function Hm(t,e,n){const i=n.map(c=>c.currentWriteId),s=Ou(t,e,i);let r=s;const o=s.hash();for(let c=0;c<n.length;c++){const u=n[c];I(u.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;const h=Ue(e,u.path);r=r.updateChild(h,u.currentOutputSnapshotRaw)}const l=r.val(!0),a=e;t.server_.put(a.toString(),l,c=>{xu(t,"transaction put response",{path:a.toString(),status:c});let u=[];if(c==="ok"){const h=[];for(let d=0;d<n.length;d++)n[d].status=2,u=u.concat(_n(t.serverSyncTree_,n[d].currentWriteId)),n[d].onComplete&&h.push(()=>n[d].onComplete(null,!0,n[d].currentOutputSnapshotResolved)),n[d].unwatcher();Es(t,wo(t.transactionQueueTree_,e)),So(t,t.transactionQueueTree_),un(t.eventQueue_,e,u);for(let d=0;d<h.length;d++)mi(h[d])}else{if(c==="datastale")for(let h=0;h<n.length;h++)n[h].status===3?n[h].status=4:n[h].status=0;else{Ve("transaction at "+a.toString()+" failed: "+c);for(let h=0;h<n.length;h++)n[h].status=4,n[h].abortReason=c}No(t,e)}},o)}function No(t,e){const n=ku(t,e),i=Ci(n),s=Du(t,n);return Wm(t,s,i),i}function Wm(t,e,n){if(e.length===0)return;const i=[];let s=[];const o=e.filter(l=>l.status===0).map(l=>l.currentWriteId);for(let l=0;l<e.length;l++){const a=e[l],c=Ue(n,a.path);let u=!1,h;if(I(c!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),a.status===4)u=!0,h=a.abortReason,s=s.concat(_n(t.serverSyncTree_,a.currentWriteId,!0));else if(a.status===0)if(a.retryCount>=km)u=!0,h="maxretry",s=s.concat(_n(t.serverSyncTree_,a.currentWriteId,!0));else{const d=Ou(t,a.path,o);a.currentInputSnapshot=d;const _=e[l].update(d.val());if(_!==void 0){wu("transaction failed: Data returned ",_,a.path);let E=xe(_);typeof _=="object"&&_!=null&&Et(_,".priority")||(E=E.updatePriority(d.getPriority()));const M=a.currentWriteId,H=Ru(t),ue=Cm(E,d,H);a.currentOutputSnapshotRaw=E,a.currentOutputSnapshotResolved=ue,a.currentWriteId=Lm(t),o.splice(o.indexOf(M),1),s=s.concat(om(t.serverSyncTree_,a.path,ue,a.currentWriteId,a.applyLocally)),s=s.concat(_n(t.serverSyncTree_,M,!0))}else u=!0,h="nodata",s=s.concat(_n(t.serverSyncTree_,a.currentWriteId,!0))}un(t.eventQueue_,n,s),s=[],u&&(e[l].status=2,function(d){setTimeout(d,Math.floor(0))}(e[l].unwatcher),e[l].onComplete&&(h==="nodata"?i.push(()=>e[l].onComplete(null,!1,e[l].currentInputSnapshot)):i.push(()=>e[l].onComplete(new Error(h),!1,null))))}Es(t,t.transactionQueueTree_);for(let l=0;l<i.length;l++)mi(i[l]);So(t,t.transactionQueueTree_)}function ku(t,e){let n,i=t.transactionQueueTree_;for(n=Y(e);n!==null&&Un(i)===void 0;)i=wo(i,n),e=de(e),n=Y(e);return i}function Du(t,e){const n=[];return Mu(t,e,n),n.sort((i,s)=>i.order-s.order),n}function Mu(t,e,n){const i=Un(e);if(i)for(let s=0;s<i.length;s++)n.push(i[s]);Cs(e,s=>{Mu(t,s,n)})}function Es(t,e){const n=Un(e);if(n){let i=0;for(let s=0;s<n.length;s++)n[s].status!==2&&(n[i]=n[s],i++);n.length=i,vu(e,n.length>0?n:void 0)}Cs(e,i=>{Es(t,i)})}function Vm(t,e){const n=Ci(ku(t,e)),i=wo(t.transactionQueueTree_,e);return bm(i,s=>{Hs(t,s)}),Hs(t,i),Eu(i,s=>{Hs(t,s)}),n}function Hs(t,e){const n=Un(e);if(n){const i=[];let s=[],r=-1;for(let o=0;o<n.length;o++)n[o].status===3||(n[o].status===1?(I(r===o-1,"All SENT items should be at beginning of queue."),r=o,n[o].status=3,n[o].abortReason="set"):(I(n[o].status===0,"Unexpected transaction status in abort"),n[o].unwatcher(),s=s.concat(_n(t.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&i.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?vu(e,void 0):n.length=r+1,un(t.eventQueue_,Ci(e),s);for(let o=0;o<i.length;o++)mi(i[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ao{constructor(e,n,i,s){this._repo=e,this._path=n,this._queryParams=i,this._orderByCalled=s}get key(){return G(this._path)?null:zc(this._path)}get ref(){return new bt(this._repo,this._path)}get _queryIdentifier(){const e=Ul(this._queryParams),n=eo(e);return n==="{}"?"default":n}get _queryObject(){return Ul(this._queryParams)}isEqual(e){if(e=an(e),!(e instanceof Ao))return!1;const n=this._repo===e._repo,i=so(this._path,e._path),s=this._queryIdentifier===e._queryIdentifier;return n&&i&&s}toJSON(){return this.toString()}toString(){return this._repo.toString()+H_(this._path)}}class bt extends Ao{constructor(e,n){super(e,n,new ao,!1)}get parent(){const e=qc(this._path);return e===null?null:new bt(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class fi{constructor(e,n,i){this._node=e,this.ref=n,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new ce(e),i=ts(this.ref,e);return new fi(this._node.getChild(n),i,ve)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,s)=>e(new fi(s,ts(this.ref,i),ve)))}hasChild(e){const n=new ce(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Ym(t,e){return t=an(t),t._checkNotDeleted("ref"),e!==void 0?ts(t._root,e):t._root}function ts(t,e){return t=an(t),Y(t._path)===null?Nm("child","path",e,!1):Tu("child","path",e,!1),new bt(t._repo,Ee(t._path,e))}class Ro{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,n){const i=n._queryParams.getIndex();return new Pu("value",this,new fi(e.snapshotNode,new bt(n._repo,n._path),i))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new Fu(this,e,n):null}matches(e){return e instanceof Ro?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}class xo{constructor(e,n){this.eventType=e,this.callbackContext=n}respondsTo(e){let n=e==="children_added"?"child_added":e;return n=n==="children_removed"?"child_removed":n,this.eventType===n}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new Fu(this,e,n):null}createEvent(e,n){I(e.childName!=null,"Child events should have a childName.");const i=ts(new bt(n._repo,n._path),e.childName),s=n._queryParams.getIndex();return new Pu(e.type,this,new fi(e.snapshotNode,i,s),e.prevName)}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof xo?this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)):!1}hasAnyCallback(){return!!this.callbackContext}}function Gm(t,e,n,i,s){let r;if(typeof i=="object"&&(r=void 0,s=i),typeof i=="function"&&(r=i),s&&s.onlyOnce){const a=n,c=(u,h)=>{ea(t._repo,t,l),a(u,h)};c.userCallback=n.userCallback,c.context=n.context,n=c}const o=new qm(n,r||void 0),l=e==="value"?new Ro(o):new xo(e,o);return $m(t._repo,t,l),()=>ea(t._repo,t,l)}function Qm(t,e,n,i){return Gm(t,"child_added",e,n,i)}Jg(bt);im(bt);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jm="FIREBASE_DATABASE_EMULATOR_HOST",Ir={};let Xm=!1;function Zm(t,e,n,i,s){let r=i||t.options.databaseURL;r===void 0&&(t.options.projectId||tn("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Re("Using default host for project ",t.options.projectId),r=`${t.options.projectId}-default-rtdb.firebaseio.com`);let o=ta(r,s),l=o.repoInfo,a,c;typeof process!="undefined"&&process.env&&(c=process.env[Jm]),c?(a=!0,r=`http://${c}?ns=${l.namespace}`,o=ta(r,s),l=o.repoInfo):a=!o.repoInfo.secure;const u=s&&a?new fr(fr.OWNER):new p_(t.name,t.options,e);Am("Invalid Firebase Database URL",o),G(o.path)||tn("Database URL must point to the root of a Firebase Database (not including a child path).");const h=ty(l,t,u,new d_(t.name,n));return new ny(h,t)}function ey(t,e){const n=Ir[e];(!n||n[t.key]!==t)&&tn(`Database ${e}(${t.repoInfo_}) has already been deleted.`),Bm(t),delete n[t.key]}function ty(t,e,n,i){let s=Ir[e.name];s||(s={},Ir[e.name]=s);let r=s[t.toURLString()];return r&&tn("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),r=new Dm(t,Xm,n,i),s[t.toURLString()]=r,r}class ny{constructor(e,n){this._repoInternal=e,this.app=n,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(Mm(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new bt(this._repo,te())),this._rootInternal}_delete(){return this._rootInternal!==null&&(ey(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&tn("Cannot call "+e+" on a deleted database.")}}function iy(t=Wp(),e){return Up(t,"database").getImmediate({identifier:e})}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sy(t){Xp(Zr),Rn(new Xt("database",(e,{instanceIdentifier:n})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return Zm(i,s,r,n)},"PUBLIC").setMultipleInstances(!0)),Ot(El,bl,t),Ot(El,bl,"esm2017")}yt.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};yt.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};sy();var Lu=(t,e)=>{const n=t.__vccOpts||t;for(const[i,s]of e)n[i]=s;return n},ry=typeof globalThis!="undefined"?globalThis:typeof window!="undefined"?window:typeof global!="undefined"?global:typeof self!="undefined"?self:{},Uu={exports:{}};(function(t,e){(function(n,i){t.exports=i()})(ry,function(){var n=1e3,i=6e4,s=36e5,r="millisecond",o="second",l="minute",a="hour",c="day",u="week",h="month",d="quarter",_="year",E="date",O="Invalid Date",M=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,H=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,ue={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_")},X=function(N,R,x){var L=String(N);return!L||L.length>=R?N:""+Array(R+1-L.length).join(x)+N},Q={s:X,z:function(N){var R=-N.utcOffset(),x=Math.abs(R),L=Math.floor(x/60),b=x%60;return(R<=0?"+":"-")+X(L,2,"0")+":"+X(b,2,"0")},m:function N(R,x){if(R.date()<x.date())return-N(x,R);var L=12*(x.year()-R.year())+(x.month()-R.month()),b=R.clone().add(L,h),D=x-b<0,W=R.clone().add(L+(D?-1:1),h);return+(-(L+(x-b)/(D?b-W:W-b))||0)},a:function(N){return N<0?Math.ceil(N)||0:Math.floor(N)},p:function(N){return{M:h,y:_,w:u,d:c,D:E,h:a,m:l,s:o,ms:r,Q:d}[N]||String(N||"").toLowerCase().replace(/s$/,"")},u:function(N){return N===void 0}},pe="en",Ce={};Ce[pe]=ue;var Se=function(N){return N instanceof U},P=function N(R,x,L){var b;if(!R)return pe;if(typeof R=="string"){var D=R.toLowerCase();Ce[D]&&(b=D),x&&(Ce[D]=x,b=D);var W=R.split("-");if(!b&&W.length>1)return N(W[0])}else{var ee=R.name;Ce[ee]=R,b=ee}return!L&&b&&(pe=b),b||!L&&pe},m=function(N,R){if(Se(N))return N.clone();var x=typeof R=="object"?R:{};return x.date=N,x.args=arguments,new U(x)},S=Q;S.l=P,S.i=Se,S.w=function(N,R){return m(N,{locale:R.$L,utc:R.$u,x:R.$x,$offset:R.$offset})};var U=function(){function N(x){this.$L=P(x.locale,null,!0),this.parse(x)}var R=N.prototype;return R.parse=function(x){this.$d=function(L){var b=L.date,D=L.utc;if(b===null)return new Date(NaN);if(S.u(b))return new Date;if(b instanceof Date)return new Date(b);if(typeof b=="string"&&!/Z$/i.test(b)){var W=b.match(M);if(W){var ee=W[2]-1||0,he=(W[7]||"0").substring(0,3);return D?new Date(Date.UTC(W[1],ee,W[3]||1,W[4]||0,W[5]||0,W[6]||0,he)):new Date(W[1],ee,W[3]||1,W[4]||0,W[5]||0,W[6]||0,he)}}return new Date(b)}(x),this.$x=x.x||{},this.init()},R.init=function(){var x=this.$d;this.$y=x.getFullYear(),this.$M=x.getMonth(),this.$D=x.getDate(),this.$W=x.getDay(),this.$H=x.getHours(),this.$m=x.getMinutes(),this.$s=x.getSeconds(),this.$ms=x.getMilliseconds()},R.$utils=function(){return S},R.isValid=function(){return this.$d.toString()!==O},R.isSame=function(x,L){var b=m(x);return this.startOf(L)<=b&&b<=this.endOf(L)},R.isAfter=function(x,L){return m(x)<this.startOf(L)},R.isBefore=function(x,L){return this.endOf(L)<m(x)},R.$g=function(x,L,b){return S.u(x)?this[L]:this.set(b,x)},R.unix=function(){return Math.floor(this.valueOf()/1e3)},R.valueOf=function(){return this.$d.getTime()},R.startOf=function(x,L){var b=this,D=!!S.u(L)||L,W=S.p(x),ee=function(Ge,Ne){var Pe=S.w(b.$u?Date.UTC(b.$y,Ne,Ge):new Date(b.$y,Ne,Ge),b);return D?Pe:Pe.endOf(c)},he=function(Ge,Ne){return S.w(b.toDate()[Ge].apply(b.toDate("s"),(D?[0,0,0,0]:[23,59,59,999]).slice(Ne)),b)},se=this.$W,_e=this.$M,qe=this.$D,Ye="set"+(this.$u?"UTC":"");switch(W){case _:return D?ee(1,0):ee(31,11);case h:return D?ee(1,_e):ee(0,_e+1);case u:var Lt=this.$locale().weekStart||0,Me=(se<Lt?se+7:se)-Lt;return ee(D?qe-Me:qe+(6-Me),_e);case c:case E:return he(Ye+"Hours",0);case a:return he(Ye+"Minutes",1);case l:return he(Ye+"Seconds",2);case o:return he(Ye+"Milliseconds",3);default:return this.clone()}},R.endOf=function(x){return this.startOf(x,!1)},R.$set=function(x,L){var b,D=S.p(x),W="set"+(this.$u?"UTC":""),ee=(b={},b[c]=W+"Date",b[E]=W+"Date",b[h]=W+"Month",b[_]=W+"FullYear",b[a]=W+"Hours",b[l]=W+"Minutes",b[o]=W+"Seconds",b[r]=W+"Milliseconds",b)[D],he=D===c?this.$D+(L-this.$W):L;if(D===h||D===_){var se=this.clone().set(E,1);se.$d[ee](he),se.init(),this.$d=se.set(E,Math.min(this.$D,se.daysInMonth())).$d}else ee&&this.$d[ee](he);return this.init(),this},R.set=function(x,L){return this.clone().$set(x,L)},R.get=function(x){return this[S.p(x)]()},R.add=function(x,L){var b,D=this;x=Number(x);var W=S.p(L),ee=function(_e){var qe=m(D);return S.w(qe.date(qe.date()+Math.round(_e*x)),D)};if(W===h)return this.set(h,this.$M+x);if(W===_)return this.set(_,this.$y+x);if(W===c)return ee(1);if(W===u)return ee(7);var he=(b={},b[l]=i,b[a]=s,b[o]=n,b)[W]||1,se=this.$d.getTime()+x*he;return S.w(se,this)},R.subtract=function(x,L){return this.add(-1*x,L)},R.format=function(x){var L=this,b=this.$locale();if(!this.isValid())return b.invalidDate||O;var D=x||"YYYY-MM-DDTHH:mm:ssZ",W=S.z(this),ee=this.$H,he=this.$m,se=this.$M,_e=b.weekdays,qe=b.months,Ye=function(Ne,Pe,Ut,It){return Ne&&(Ne[Pe]||Ne(L,D))||Ut[Pe].slice(0,It)},Lt=function(Ne){return S.s(ee%12||12,Ne,"0")},Me=b.meridiem||function(Ne,Pe,Ut){var It=Ne<12?"AM":"PM";return Ut?It.toLowerCase():It},Ge={YY:String(this.$y).slice(-2),YYYY:this.$y,M:se+1,MM:S.s(se+1,2,"0"),MMM:Ye(b.monthsShort,se,qe,3),MMMM:Ye(qe,se),D:this.$D,DD:S.s(this.$D,2,"0"),d:String(this.$W),dd:Ye(b.weekdaysMin,this.$W,_e,2),ddd:Ye(b.weekdaysShort,this.$W,_e,3),dddd:_e[this.$W],H:String(ee),HH:S.s(ee,2,"0"),h:Lt(1),hh:Lt(2),a:Me(ee,he,!0),A:Me(ee,he,!1),m:String(he),mm:S.s(he,2,"0"),s:String(this.$s),ss:S.s(this.$s,2,"0"),SSS:S.s(this.$ms,3,"0"),Z:W};return D.replace(H,function(Ne,Pe){return Pe||Ge[Ne]||W.replace(":","")})},R.utcOffset=function(){return 15*-Math.round(this.$d.getTimezoneOffset()/15)},R.diff=function(x,L,b){var D,W=S.p(L),ee=m(x),he=(ee.utcOffset()-this.utcOffset())*i,se=this-ee,_e=S.m(this,ee);return _e=(D={},D[_]=_e/12,D[h]=_e,D[d]=_e/3,D[u]=(se-he)/6048e5,D[c]=(se-he)/864e5,D[a]=se/s,D[l]=se/i,D[o]=se/n,D)[W]||se,b?_e:S.a(_e)},R.daysInMonth=function(){return this.endOf(h).$D},R.$locale=function(){return Ce[this.$L]},R.locale=function(x,L){if(!x)return this.$L;var b=this.clone(),D=P(x,L,!0);return D&&(b.$L=D),b},R.clone=function(){return S.w(this.$d,this)},R.toDate=function(){return new Date(this.valueOf())},R.toJSON=function(){return this.isValid()?this.toISOString():null},R.toISOString=function(){return this.$d.toISOString()},R.toString=function(){return this.$d.toUTCString()},N}(),re=U.prototype;return m.prototype=re,[["$ms",r],["$s",o],["$m",l],["$H",a],["$W",c],["$M",h],["$y",_],["$D",E]].forEach(function(N){re[N[1]]=function(R){return this.$g(R,N[0],N[1])}}),m.extend=function(N,R){return N.$i||(N(R,U,m),N.$i=!0),m},m.locale=P,m.isDayjs=Se,m.unix=function(N){return m(1e3*N)},m.en=Ce[pe],m.Ls=Ce,m.p={},m})})(Uu);var Ri=Uu.exports;const oy={class:"row"},ly={class:"row place justify-content-md-center",style:{padding:"5px"}},ay={class:"col-4",style:{"margin-bottom":"5px"}},cy={key:0,class:"box"},uy={key:1,class:"box"},hy=ja({__name:"MainPage",setup(t){const e={\u5831\u5230:["\u5065\u6AA2\u6AC3\u53F0"],\u9AD4\u6AA2\u5927\u6A13:["\u57FA\u790E\u6AA2\u67E5","\u5FC3\u96FB\u5716","\u8840\u58D3\u91CF\u6E2C","\u5BB6\u91AB\u8A3A\u65B7","\u62BD\u8840\u7AD9","\u7CBE\u795E\u79D1\u6AA2\u67E5"]},n="NFC",i=iy(),s=Ym(i,n),r=Vo({});Object.keys(e).forEach(P=>{e[P].forEach(m=>{r.value[m]={num:0,avgWorkTime:0,avgWaitTime:0}})});let o={},l={},a={},c={},u={},h={},d=[],_=Vo(0);Object.keys(e).forEach(P=>{e[P].forEach(m=>{c[m]=[],u[m]=[]})});let E=new URLSearchParams(window.location.search);console.log("If you want to set the time range, you can set params like '?start=2022-09-22T08:00:00'");let O=Ri(E.get("start")||"NaN"),M=O.valueOf(),H=Ri(E.get("end")||"NaN"),ue=H.valueOf();const X=Ri();isNaN(M)&&(O=X.set("hour",0).set("minute",0).set("second",0),M=O.valueOf()),isNaN(ue)&&(H=O.add(1,"day"),ue=H.valueOf()),console.log(O.toJSON()),console.log(O.format("\u958B\u59CB\u6642\u9593:\u672C\u5730\u6642\u9593 YYYY-MM-DD HH:mm:ss")),console.log(H.toJSON()),console.log(H.format("\u7D50\u675F\u6642\u9593:\u672C\u5730\u6642\u9593 YYYY-MM-DD HH:mm:ss")),Qm(s,P=>{const m=P.val();m.timestamp<M||m.timestamp>ue||pe(m)});function Q(P){return Ri(P).format("HH:mm:ss")}function pe(P){const m=P.serialNumber,S=P.placeName,U=P.timestamp;if(m in o||(o[m]={}),!(S in r.value))return;const re="\u7B49\u5019\u5340";if(re in o[m]||(o[m][re]={intime:U,outtime:U}),S in o[m]||(o[m][S]={intime:U,outtime:U}),l[m]||(l[m]=re),!a[m])a[m]=U;else if(U-a[m]<1e3){console.log(`${Q(U)} ${m}  ${(U-a[m])/1e3}  \u592A\u5FEB\uFF0Cskip`);return}if(a[m]=U,S=="\u5065\u6AA2\u6AC3\u53F0")if(!h[m])console.log(`${Q(U)}\uFF1A${m} \u5F9E\u5916\u9762\u9032\u5165\u4E86 ${S}`),h[m]=U;else{const R=Math.floor((U-h[m])/1e3);console.log(`${Q(U)}\uFF1A${m} \u56DE\u5230\u4E86 ${S}\uFF0C\u6574\u8D9F\u82B1\u4E86 ${R} \u79D2`),d.push(R),h[m]=0,_.value=Math.floor(d.reduce((x,L)=>x+L)/d.length)}const N=l[m];if(N!=re&&N!=S){const R=U-o[m][N].intime;console.log(`${Q(U)}\uFF1A${m} \u5F9E ${N} \u77AC\u9593\u79FB\u52D5\u5230 ${S}\uFF0C\u8655\u7406+\u7B49\u5019\u82B1 ${Math.floor(R/1e3)} \u79D2\u3002`),o[m][N].intime=0,o[m][N].outtime=0,o[m][S].intime=U,o[m][S].outtime=0,l[m]=S}else if(N!=re&&N==S){const R=U-o[m][N].intime;c[S].push(R),console.log(`${Q(U)}\uFF1A${m} \u5728 ${N}\uFF0C\u5237\u7B2C2\u6B21\uFF0C\u5230${re}\uFF0C\u8655\u7406\u6642\u9593\u82B1 ${Math.floor(R/1e3)} \u79D2\u3002`),o[m][N].intime=0,o[m][N].outtime=U,o[m][re].intime=U,o[m][re].outtime=U,l[m]=re}else if(N==re){const R=U-o[m][N].outtime;u[S].push(R),console.log(`${Q(U)}\uFF1A${m} \u5F9E ${N} \u9032\u5165 ${S}\uFF0C\u7B49\u5019\u6642\u9593\u82B1 ${Math.floor(R/1e3)} \u79D2\u3002`),o[m][N].intime=0,o[m][N].outtime=0,o[m][S].intime=U,o[m][S].outtime=0,l[m]=S}else console.log(`${Q(U)}\uFF1A\u932F\u8AA4\uFF0C\u9019\u72C0\u6CC1\u4E0D\u8A72\u767C\u751F ${m} , ${N} , ${S}`);Ce()}function Ce(){Object.keys(e).forEach(P=>{e[P].forEach(m=>{r.value[m]={num:0,avgWorkTime:Se(c[m],m),avgWaitTime:Se(u[m])}})})}O.format("YYYY-MM-DD")=="2022-12-06"&&console.log("2022-11-06\uFF0C\u51FA\u53E3\u8B8A\u6210\u5FC3\u96FB\u5716\uFF0C\u756B\u9762\u6703\u7BE9\u6389\u7570\u5E38\u8CC7\u6599\uFF0C\u4E0D\u904Elog\u7167\u820A");function Se(P,m){if(P.length<1)return 0;if(O.format("YYYY-MM-DD")=="2022-12-06"&&m=="\u5FC3\u96FB\u5716"){let S=P.filter(U=>U<3e5);return S=S.filter(U=>U>1e5),Math.floor(S.reduce((U,re)=>U+re)/S.length/1e3)}return Math.floor(P.reduce((S,U)=>S+U)/P.length/1e3)}return(P,m)=>(gt(),St("div",oy,[(gt(!0),St(We,null,Yo(ki(e),(S,U,re)=>(gt(),St("div",ly,[at("h1",null,pt(U),1),(gt(!0),St(We,null,Yo(S.filter(N=>N!="\u51FA\u53E3"),(N,R,x)=>(gt(),St("div",ay,[N.includes("\u5065\u6AA2\u6AC3\u53F0")?nl("",!0):(gt(),St("div",cy,[at("h2",null,pt(N),1),at("h3",null,"\u5E73\u5747\u8655\u7406\u6642\u9593\uFF1A"+pt(Math.floor(r.value[N].avgWorkTime/60))+"\u5206 "+pt(r.value[N].avgWorkTime%60)+"\u79D2",1),at("h3",null,"\u5E73\u5747\u7B49\u5019\u6642\u9593\uFF1A"+pt(Math.floor(r.value[N].avgWaitTime/60))+"\u5206 "+pt(r.value[N].avgWaitTime%60)+"\u79D2",1)])),N=="\u5065\u6AA2\u6AC3\u53F0"?(gt(),St("div",uy,[at("h2",null,pt(N),1),at("h3",null,"\u5E73\u5747\u5B8C\u6210\u9AD4\u6AA2\u6642\u9593\uFF1A"+pt(Math.floor(ki(_)/60))+"\u5206 "+pt(ki(_)%60)+"\u79D2",1)])):nl("",!0)]))),256))]))),256))]))}});var fy=Lu(hy,[["__scopeId","data-v-954f53a6"]]),dy="firebase",py="9.9.4";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const na=new Jr("@firebase/auth");function Pi(t,...e){na.logLevel<=ae.ERROR&&na.error(`Auth (${Zr}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sa=new Map;function Yt(t){ns(t instanceof Function,"Expected a class definition");let e=sa.get(t);return e?(ns(e instanceof t,"Instance stored in cache mismatched with class"),e):(e=new t,sa.set(t,e),e)}function my(t,e){const n=(e==null?void 0:e.persistence)||[],i=(Array.isArray(n)?n:[n]).map(Yt);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(i,e==null?void 0:e.popupRedirectResolver)}function yy(){return ra()==="http:"||ra()==="https:"}function ra(){var t;return typeof self!="undefined"&&((t=self.location)===null||t===void 0?void 0:t.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ei{constructor(e,n){this.shortDelay=e,this.longDelay=n,ns(n>e,"Short delay should be less than long delay!"),this.isMobile=Gr()||dc()}get(){return vy()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ey(t,e){ns(t.emulator,"Emulator should always be set here");const{url:n}=t.emulator;return e?`${n}${e.startsWith("/")?e.slice(1):e}`:n}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Jn(t){if(!!t)try{const e=new Date(Number(t));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function Ny(t,e=!1){const n=an(t),i=await n.getIdToken(e),s=qu(i);ie(s&&s.exp&&s.auth_time&&s.iat,n.auth,"internal-error");const r=typeof s.firebase=="object"?s.firebase:void 0,o=r==null?void 0:r.sign_in_provider;return{claims:s,token:i,authTime:Jn(Ws(s.auth_time)),issuedAtTime:Jn(Ws(s.iat)),expirationTime:Jn(Ws(s.exp)),signInProvider:o||null,signInSecondFactor:(r==null?void 0:r.sign_in_second_factor)||null}}function Ws(t){return Number(t)*1e3}function qu(t){var e;const[n,i,s]=t.split(".");if(n===void 0||i===void 0||s===void 0)return Pi("JWT malformed, contained fewer than 3 sections"),null;try{const r=sr(i);return r?JSON.parse(r):(Pi("Failed to decode base64 JWT payload"),null)}catch(r){return Pi("Caught error parsing JWT payload as JSON",(e=r)===null||e===void 0?void 0:e.toString()),null}}function Ay(t){const e=qu(t);return ie(e,"internal-error"),ie(typeof e.exp!="undefined","internal-error"),ie(typeof e.iat!="undefined","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function wr(t,e,n=!1){if(n)return e;try{return await e}catch(i){throw i instanceof ln&&Ry(i)&&t.auth.currentUser===t&&await t.auth.signOut(),i}}function Ry({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function My(t,e){const n=await zu(t,{},async()=>{const i=Qr({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:r}=t.config,o=Ku(t,s,"/v1/token",`key=${r}`),l=await t._getAdditionalHeaders();return l["Content-Type"]="application/x-www-form-urlencoded",Vu.fetch()(o,{method:"POST",headers:l,body:i})});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class di{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){ie(e.idToken,"internal-error"),ie(typeof e.idToken!="undefined","internal-error"),ie(typeof e.refreshToken!="undefined","internal-error");const n="expiresIn"in e&&typeof e.expiresIn!="undefined"?Number(e.expiresIn):Ay(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,n)}async getToken(e,n=!1){return ie(!this.accessToken||this.refreshToken,e,"user-token-expired"),!n&&this.accessToken&&!this.isExpired?this.accessToken:this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null}clearRefreshToken(){this.refreshToken=null}async refresh(e,n){const{accessToken:i,refreshToken:s,expiresIn:r}=await My(e,n);this.updateTokensAndExpiration(i,s,Number(r))}updateTokensAndExpiration(e,n,i){this.refreshToken=n||null,this.accessToken=e||null,this.expirationTime=Date.now()+i*1e3}static fromJSON(e,n){const{refreshToken:i,accessToken:s,expirationTime:r}=n,o=new di;return i&&(ie(typeof i=="string","internal-error",{appName:e}),o.refreshToken=i),s&&(ie(typeof s=="string","internal-error",{appName:e}),o.accessToken=s),r&&(ie(typeof r=="number","internal-error",{appName:e}),o.expirationTime=r),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new di,this.toJSON())}_performRefresh(){return Qn("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function la(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Uy(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Py(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(By(e))return"Blackberry";if(Hy(e))return"Webos";if(Fy(e))return"Safari";if((e.includes("chrome/")||Ly(e))&&!e.includes("edge/"))return"Chrome";if($y(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=t.match(n);if((i==null?void 0:i.length)===2)return i[1]}return"Other"}function Py(t=dt()){return/firefox\//i.test(t)}function Fy(t=dt()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Ly(t=dt()){return/crios\//i.test(t)}function Uy(t=dt()){return/iemobile/i.test(t)}function $y(t=dt()){return/android/i.test(t)}function By(t=dt()){return/blackberry/i.test(t)}function Hy(t=dt()){return/webos/i.test(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
