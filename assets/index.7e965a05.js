 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ey(t){Gp(Yr),mn(new Ut("database",(e,{instanceIdentifier:n})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return Ym(i,s,r,n)},"PUBLIC").setMultipleInstances(!0)),yt(ml,yl,t),yt(ml,yl,"esm2017")}ot.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};ot.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};ey();var No=(t,e)=>{const n=t.__vccOpts||t;for(const[i,s]of e)n[i]=s;return n};const ty={class:"box"},ny=Fr({__name:"checkCom",props:{placeName:null,checkIn:null,checkOut:null},setup(t){return(e,n)=>(tt(),nt("div",ty,[(tt(!0),nt(we,null,js(t.placeName.split(" "),(i,s,r)=>(tt(),nt("h2",null,Ei(i),1))),256)),Ft("h3",null,"\u7C3D\u5230\u4EBA\u6578\uFF1A"+Ei(t.checkIn),1),Ft("h3",null,"\u7C3D\u9000\u4EBA\u6578\uFF1A"+Ei(t.checkOut),1)]))}});var iy=No(ny,[["__scopeId","data-v-e9cfd7c8"]]);const sy={class:"row"},ry={class:"col-sm-3 place",style:{padding:"5px"}},oy={class:"row",style:{margin:"1px"}},ly=Fr({__name:"MainPage",setup(t){const e={\u5831\u5230:["\u5065\u6AA2\u6AC3\u53F0"],\u9AD4\u6AA2\u5927\u6A13:["\u8EAB\u9AD8\u9AD4\u91CD \u8840\u58D3\u8108\u640F","\u5FC3\u96FB\u6AA2\u67E5","\u5BB6\u91AB\u8A3A\u65B7","\u62BD\u8840\u6AA2\u67E5"],\u91AB\u7642\u5927\u6A13:["X\u5149\u6AA2\u67E5","\u773C\u79D1\u6AA2\u67E5"],\u7259\u79D1:["\u7259\u91AB\u6AA2\u67E5"]},n="NFC",i=Zm(),s=zm(i,n),r=Dh({}),o=["\u5065\u6AA2\u6AC3\u53F0"];Object.keys(e).forEach(h=>{e[h].forEach(u=>{r.value[u]={checkIn:0,checkOut:0}})});let l={},a={};Km(s,h=>{c(h.val())});function c(h){const u=h.serialNumber,f=h.placeName;console.log(h),u in l||(l[u]={}),f in l[u]||(l[u][f]=0),f in r.value&&(l[u][f]+=1,a[u]&&a[u]!=f&&l[u][a[u]]<=2&&(r.value[a[u]].checkOut+=1,l[u][a[u]]=3,a[u]=""),l[u][f]==1?(r.value[f].checkIn+=1,a[u]=f):l[u][f]==2?(a[u]=f,o.includes(f)&&(r.value[f].checkOut+=1,l[u][f]=3)):l[u][f]==3&&(r.value[f].checkOut+=1,a[u]=""))}return(h,u)=>(tt(),nt("div",sy,[(tt(!0),nt(we,null,js(Ra(e),(f,g,b)=>(tt(),nt("div",ry,[Ft("h1",null,Ei(g),1),(tt(!0),nt(we,null,js(f,(S,A,P)=>(tt(),nt("div",oy,[rt(iy,{placeName:S,"check-in":r.value[S].checkIn,"check-out":r.value[S].checkOut},null,8,["placeName","check-in","check-out"])]))),256))]))),256))]))}});var ay=No(ly,[["__scopeId","data-v-747d4a07"]]),cy="firebase",uy="9.9.4";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
