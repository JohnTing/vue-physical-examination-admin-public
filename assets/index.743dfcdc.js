const Ju=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function n(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerpolicy&&(r.referrerPolicy=s.referrerpolicy),s.crossorigin==="use-credentials"?r.credentials="include":s.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(s){if(s.ep)return;s.ep=!0;const r=n(s);fetch(s.href,r)}};Ju();function Tr(t,e){const n=Object.create(null),i=t.split(",");for(let s=0;s<i.length;s++)n[i[s]]=!0;return e?s=>!!n[s.toLowerCase()]:s=>!!n[s]}const Xu="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Zu=Tr(Xu);function ha(t){return!!t||t===""}function Sr(t){if(K(t)){const e={};for(let n=0;n<t.length;n++){const i=t[n],s=Se(i)?nh(i):Sr(i);if(s)for(const r in s)e[r]=s[r]}return e}else{if(Se(t))return t;if(ve(t))return t}}const eh=/;(?![^(]*\))/g,th=/:(.+)/;function nh(t){const e={};return t.split(eh).forEach(n=>{if(n){const i=n.split(th);i.length>1&&(e[i[0].trim()]=i[1].trim())}}),e}function Nr(t){let e="";if(Se(t))e=t;else if(K(t))for(let n=0;n<t.length;n++){const i=Nr(t[n]);i&&(e+=i+" ")}else if(ve(t))for(const n in t)t[n]&&(e+=n+" ");return e.trim()}const $n=t=>Se(t)?t:t==null?"":K(t)||ve(t)&&(t.toString===_a||!Y(t.toString))?JSON.stringify(t,fa,2):String(t),fa=(t,e)=>e&&e.__v_isRef?fa(t,e.value):gn(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((n,[i,s])=>(n[`${i} =>`]=s,n),{})}:da(e)?{[`Set(${e.size})`]:[...e.values()]}:ve(e)&&!K(e)&&!ga(e)?String(e):e,de={},_n=[],nt=()=>{},ih=()=>!1,sh=/^on[^a-z]/,is=t=>sh.test(t),Ar=t=>t.startsWith("onUpdate:"),De=Object.assign,Rr=(t,e)=>{const n=t.indexOf(e);n>-1&&t.splice(n,1)},rh=Object.prototype.hasOwnProperty,Z=(t,e)=>rh.call(t,e),K=Array.isArray,gn=t=>ss(t)==="[object Map]",da=t=>ss(t)==="[object Set]",Y=t=>typeof t=="function",Se=t=>typeof t=="string",xr=t=>typeof t=="symbol",ve=t=>t!==null&&typeof t=="object",pa=t=>ve(t)&&Y(t.then)&&Y(t.catch),_a=Object.prototype.toString,ss=t=>_a.call(t),oh=t=>ss(t).slice(8,-1),ga=t=>ss(t)==="[object Object]",Or=t=>Se(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,Oi=Tr(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),rs=t=>{const e=Object.create(null);return n=>e[n]||(e[n]=t(n))},lh=/-(\w)/g,wn=rs(t=>t.replace(lh,(e,n)=>n?n.toUpperCase():"")),ah=/\B([A-Z])/g,kn=rs(t=>t.replace(ah,"-$1").toLowerCase()),ma=rs(t=>t.charAt(0).toUpperCase()+t.slice(1)),Es=rs(t=>t?`on${ma(t)}`:""),Xn=(t,e)=>!Object.is(t,e),bs=(t,e)=>{for(let n=0;n<t.length;n++)t[n](e)},Mi=(t,e,n)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,value:n})},ch=t=>{const e=parseFloat(t);return isNaN(e)?t:e};let Mo;const uh=()=>Mo||(Mo=typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{});let lt;class hh{constructor(e=!1){this.active=!0,this.effects=[],this.cleanups=[],!e&&lt&&(this.parent=lt,this.index=(lt.scopes||(lt.scopes=[])).push(this)-1)}run(e){if(this.active){const n=lt;try{return lt=this,e()}finally{lt=n}}}on(){lt=this}off(){lt=this.parent}stop(e){if(this.active){let n,i;for(n=0,i=this.effects.length;n<i;n++)this.effects[n].stop();for(n=0,i=this.cleanups.length;n<i;n++)this.cleanups[n]();if(this.scopes)for(n=0,i=this.scopes.length;n<i;n++)this.scopes[n].stop(!0);if(this.parent&&!e){const s=this.parent.scopes.pop();s&&s!==this&&(this.parent.scopes[this.index]=s,s.index=this.index)}this.active=!1}}}function fh(t,e=lt){e&&e.active&&e.effects.push(t)}const kr=t=>{const e=new Set(t);return e.w=0,e.n=0,e},ya=t=>(t.w&kt)>0,va=t=>(t.n&kt)>0,dh=({deps:t})=>{if(t.length)for(let e=0;e<t.length;e++)t[e].w|=kt},ph=t=>{const{deps:e}=t;if(e.length){let n=0;for(let i=0;i<e.length;i++){const s=e[i];ya(s)&&!va(s)?s.delete(t):e[n++]=s,s.w&=~kt,s.n&=~kt}e.length=n}},Vs=new WeakMap;let jn=0,kt=1;const js=30;let Je;const Yt=Symbol(""),zs=Symbol("");class Dr{constructor(e,n=null,i){this.fn=e,this.scheduler=n,this.active=!0,this.deps=[],this.parent=void 0,fh(this,i)}run(){if(!this.active)return this.fn();let e=Je,n=Nt;for(;e;){if(e===this)return;e=e.parent}try{return this.parent=Je,Je=this,Nt=!0,kt=1<<++jn,jn<=js?dh(this):Lo(this),this.fn()}finally{jn<=js&&ph(this),kt=1<<--jn,Je=this.parent,Nt=n,this.parent=void 0,this.deferStop&&this.stop()}}stop(){Je===this?this.deferStop=!0:this.active&&(Lo(this),this.onStop&&this.onStop(),this.active=!1)}}function Lo(t){const{deps:e}=t;if(e.length){for(let n=0;n<e.length;n++)e[n].delete(t);e.length=0}}let Nt=!0;const Ca=[];function Dn(){Ca.push(Nt),Nt=!1}function Pn(){const t=Ca.pop();Nt=t===void 0?!0:t}function je(t,e,n){if(Nt&&Je){let i=Vs.get(t);i||Vs.set(t,i=new Map);let s=i.get(n);s||i.set(n,s=kr()),Ea(s)}}function Ea(t,e){let n=!1;jn<=js?va(t)||(t.n|=kt,n=!ya(t)):n=!t.has(Je),n&&(t.add(Je),Je.deps.push(t))}function yt(t,e,n,i,s,r){const o=Vs.get(t);if(!o)return;let l=[];if(e==="clear")l=[...o.values()];else if(n==="length"&&K(t))o.forEach((a,c)=>{(c==="length"||c>=i)&&l.push(a)});else switch(n!==void 0&&l.push(o.get(n)),e){case"add":K(t)?Or(n)&&l.push(o.get("length")):(l.push(o.get(Yt)),gn(t)&&l.push(o.get(zs)));break;case"delete":K(t)||(l.push(o.get(Yt)),gn(t)&&l.push(o.get(zs)));break;case"set":gn(t)&&l.push(o.get(Yt));break}if(l.length===1)l[0]&&Ks(l[0]);else{const a=[];for(const c of l)c&&a.push(...c);Ks(kr(a))}}function Ks(t,e){const n=K(t)?t:[...t];for(const i of n)i.computed&&Fo(i);for(const i of n)i.computed||Fo(i)}function Fo(t,e){(t!==Je||t.allowRecurse)&&(t.scheduler?t.scheduler():t.run())}const _h=Tr("__proto__,__v_isRef,__isVue"),ba=new Set(Object.getOwnPropertyNames(Symbol).filter(t=>t!=="arguments"&&t!=="caller").map(t=>Symbol[t]).filter(xr)),gh=Pr(),mh=Pr(!1,!0),yh=Pr(!0),Uo=vh();function vh(){const t={};return["includes","indexOf","lastIndexOf"].forEach(e=>{t[e]=function(...n){const i=se(this);for(let r=0,o=this.length;r<o;r++)je(i,"get",r+"");const s=i[e](...n);return s===-1||s===!1?i[e](...n.map(se)):s}}),["push","pop","shift","unshift","splice"].forEach(e=>{t[e]=function(...n){Dn();const i=se(this)[e].apply(this,n);return Pn(),i}}),t}function Pr(t=!1,e=!1){return function(i,s,r){if(s==="__v_isReactive")return!t;if(s==="__v_isReadonly")return t;if(s==="__v_isShallow")return e;if(s==="__v_raw"&&r===(t?e?Mh:Na:e?Sa:Ta).get(i))return i;const o=K(i);if(!t&&o&&Z(Uo,s))return Reflect.get(Uo,s,r);const l=Reflect.get(i,s,r);return(xr(s)?ba.has(s):_h(s))||(t||je(i,"get",s),e)?l:ke(l)?o&&Or(s)?l:l.value:ve(l)?t?Aa(l):Fr(l):l}}const Ch=Ia(),Eh=Ia(!0);function Ia(t=!1){return function(n,i,s,r){let o=n[i];if(Tn(o)&&ke(o)&&!ke(s))return!1;if(!t&&(!Li(s)&&!Tn(s)&&(o=se(o),s=se(s)),!K(n)&&ke(o)&&!ke(s)))return o.value=s,!0;const l=K(n)&&Or(i)?Number(i)<n.length:Z(n,i),a=Reflect.set(n,i,s,r);return n===se(r)&&(l?Xn(s,o)&&yt(n,"set",i,s):yt(n,"add",i,s)),a}}function bh(t,e){const n=Z(t,e);t[e];const i=Reflect.deleteProperty(t,e);return i&&n&&yt(t,"delete",e,void 0),i}function Ih(t,e){const n=Reflect.has(t,e);return(!xr(e)||!ba.has(e))&&je(t,"has",e),n}function wh(t){return je(t,"iterate",K(t)?"length":Yt),Reflect.ownKeys(t)}const wa={get:gh,set:Ch,deleteProperty:bh,has:Ih,ownKeys:wh},Th={get:yh,set(t,e){return!0},deleteProperty(t,e){return!0}},Sh=De({},wa,{get:mh,set:Eh}),Mr=t=>t,os=t=>Reflect.getPrototypeOf(t);function bi(t,e,n=!1,i=!1){t=t.__v_raw;const s=se(t),r=se(e);n||(e!==r&&je(s,"get",e),je(s,"get",r));const{has:o}=os(s),l=i?Mr:n?$r:Zn;if(o.call(s,e))return l(t.get(e));if(o.call(s,r))return l(t.get(r));t!==s&&t.get(e)}function Ii(t,e=!1){const n=this.__v_raw,i=se(n),s=se(t);return e||(t!==s&&je(i,"has",t),je(i,"has",s)),t===s?n.has(t):n.has(t)||n.has(s)}function wi(t,e=!1){return t=t.__v_raw,!e&&je(se(t),"iterate",Yt),Reflect.get(t,"size",t)}function $o(t){t=se(t);const e=se(this);return os(e).has.call(e,t)||(e.add(t),yt(e,"add",t,t)),this}function Bo(t,e){e=se(e);const n=se(this),{has:i,get:s}=os(n);let r=i.call(n,t);r||(t=se(t),r=i.call(n,t));const o=s.call(n,t);return n.set(t,e),r?Xn(e,o)&&yt(n,"set",t,e):yt(n,"add",t,e),this}function Ho(t){const e=se(this),{has:n,get:i}=os(e);let s=n.call(e,t);s||(t=se(t),s=n.call(e,t)),i&&i.call(e,t);const r=e.delete(t);return s&&yt(e,"delete",t,void 0),r}function Wo(){const t=se(this),e=t.size!==0,n=t.clear();return e&&yt(t,"clear",void 0,void 0),n}function Ti(t,e){return function(i,s){const r=this,o=r.__v_raw,l=se(o),a=e?Mr:t?$r:Zn;return!t&&je(l,"iterate",Yt),o.forEach((c,u)=>i.call(s,a(c),a(u),r))}}function Si(t,e,n){return function(...i){const s=this.__v_raw,r=se(s),o=gn(r),l=t==="entries"||t===Symbol.iterator&&o,a=t==="keys"&&o,c=s[t](...i),u=n?Mr:e?$r:Zn;return!e&&je(r,"iterate",a?zs:Yt),{next(){const{value:h,done:d}=c.next();return d?{value:h,done:d}:{value:l?[u(h[0]),u(h[1])]:u(h),done:d}},[Symbol.iterator](){return this}}}}function It(t){return function(...e){return t==="delete"?!1:this}}function Nh(){const t={get(r){return bi(this,r)},get size(){return wi(this)},has:Ii,add:$o,set:Bo,delete:Ho,clear:Wo,forEach:Ti(!1,!1)},e={get(r){return bi(this,r,!1,!0)},get size(){return wi(this)},has:Ii,add:$o,set:Bo,delete:Ho,clear:Wo,forEach:Ti(!1,!0)},n={get(r){return bi(this,r,!0)},get size(){return wi(this,!0)},has(r){return Ii.call(this,r,!0)},add:It("add"),set:It("set"),delete:It("delete"),clear:It("clear"),forEach:Ti(!0,!1)},i={get(r){return bi(this,r,!0,!0)},get size(){return wi(this,!0)},has(r){return Ii.call(this,r,!0)},add:It("add"),set:It("set"),delete:It("delete"),clear:It("clear"),forEach:Ti(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(r=>{t[r]=Si(r,!1,!1),n[r]=Si(r,!0,!1),e[r]=Si(r,!1,!0),i[r]=Si(r,!0,!0)}),[t,n,e,i]}const[Ah,Rh,xh,Oh]=Nh();function Lr(t,e){const n=e?t?Oh:xh:t?Rh:Ah;return(i,s,r)=>s==="__v_isReactive"?!t:s==="__v_isReadonly"?t:s==="__v_raw"?i:Reflect.get(Z(n,s)&&s in i?n:i,s,r)}const kh={get:Lr(!1,!1)},Dh={get:Lr(!1,!0)},Ph={get:Lr(!0,!1)},Ta=new WeakMap,Sa=new WeakMap,Na=new WeakMap,Mh=new WeakMap;function Lh(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Fh(t){return t.__v_skip||!Object.isExtensible(t)?0:Lh(oh(t))}function Fr(t){return Tn(t)?t:Ur(t,!1,wa,kh,Ta)}function Uh(t){return Ur(t,!1,Sh,Dh,Sa)}function Aa(t){return Ur(t,!0,Th,Ph,Na)}function Ur(t,e,n,i,s){if(!ve(t)||t.__v_raw&&!(e&&t.__v_isReactive))return t;const r=s.get(t);if(r)return r;const o=Fh(t);if(o===0)return t;const l=new Proxy(t,o===2?i:n);return s.set(t,l),l}function mn(t){return Tn(t)?mn(t.__v_raw):!!(t&&t.__v_isReactive)}function Tn(t){return!!(t&&t.__v_isReadonly)}function Li(t){return!!(t&&t.__v_isShallow)}function Ra(t){return mn(t)||Tn(t)}function se(t){const e=t&&t.__v_raw;return e?se(e):t}function xa(t){return Mi(t,"__v_skip",!0),t}const Zn=t=>ve(t)?Fr(t):t,$r=t=>ve(t)?Aa(t):t;function Oa(t){Nt&&Je&&(t=se(t),Ea(t.dep||(t.dep=kr())))}function ka(t,e){t=se(t),t.dep&&Ks(t.dep)}function ke(t){return!!(t&&t.__v_isRef===!0)}function Vo(t){return $h(t,!1)}function $h(t,e){return ke(t)?t:new Bh(t,e)}class Bh{constructor(e,n){this.__v_isShallow=n,this.dep=void 0,this.__v_isRef=!0,this._rawValue=n?e:se(e),this._value=n?e:Zn(e)}get value(){return Oa(this),this._value}set value(e){const n=this.__v_isShallow||Li(e)||Tn(e);e=n?e:se(e),Xn(e,this._rawValue)&&(this._rawValue=e,this._value=n?e:Zn(e),ka(this))}}function qs(t){return ke(t)?t.value:t}const Hh={get:(t,e,n)=>qs(Reflect.get(t,e,n)),set:(t,e,n,i)=>{const s=t[e];return ke(s)&&!ke(n)?(s.value=n,!0):Reflect.set(t,e,n,i)}};function Da(t){return mn(t)?t:new Proxy(t,Hh)}var Pa;class Wh{constructor(e,n,i,s){this._setter=n,this.dep=void 0,this.__v_isRef=!0,this[Pa]=!1,this._dirty=!0,this.effect=new Dr(e,()=>{this._dirty||(this._dirty=!0,ka(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!s,this.__v_isReadonly=i}get value(){const e=se(this);return Oa(e),(e._dirty||!e._cacheable)&&(e._dirty=!1,e._value=e.effect.run()),e._value}set value(e){this._setter(e)}}Pa="__v_isReadonly";function Vh(t,e,n=!1){let i,s;const r=Y(t);return r?(i=t,s=nt):(i=t.get,s=t.set),new Wh(i,s,r||!s,n)}function At(t,e,n,i){let s;try{s=i?t(...i):t()}catch(r){ls(r,e,n)}return s}function Ke(t,e,n,i){if(Y(t)){const r=At(t,e,n,i);return r&&pa(r)&&r.catch(o=>{ls(o,e,n)}),r}const s=[];for(let r=0;r<t.length;r++)s.push(Ke(t[r],e,n,i));return s}function ls(t,e,n,i=!0){const s=e?e.vnode:null;if(e){let r=e.parent;const o=e.proxy,l=n;for(;r;){const c=r.ec;if(c){for(let u=0;u<c.length;u++)if(c[u](t,o,l)===!1)return}r=r.parent}const a=e.appContext.config.errorHandler;if(a){At(a,null,10,[t,o,l]);return}}jh(t,n,s,i)}function jh(t,e,n,i=!0){console.error(t)}let ei=!1,Ys=!1;const Oe=[];let ct=0;const yn=[];let dt=null,Vt=0;const Ma=Promise.resolve();let Br=null;function zh(t){const e=Br||Ma;return t?e.then(this?t.bind(this):t):e}function Kh(t){let e=ct+1,n=Oe.length;for(;e<n;){const i=e+n>>>1;ti(Oe[i])<t?e=i+1:n=i}return e}function Hr(t){(!Oe.length||!Oe.includes(t,ei&&t.allowRecurse?ct+1:ct))&&(t.id==null?Oe.push(t):Oe.splice(Kh(t.id),0,t),La())}function La(){!ei&&!Ys&&(Ys=!0,Br=Ma.then(Ua))}function qh(t){const e=Oe.indexOf(t);e>ct&&Oe.splice(e,1)}function Yh(t){K(t)?yn.push(...t):(!dt||!dt.includes(t,t.allowRecurse?Vt+1:Vt))&&yn.push(t),La()}function jo(t,e=ei?ct+1:0){for(;e<Oe.length;e++){const n=Oe[e];n&&n.pre&&(Oe.splice(e,1),e--,n())}}function Fa(t){if(yn.length){const e=[...new Set(yn)];if(yn.length=0,dt){dt.push(...e);return}for(dt=e,dt.sort((n,i)=>ti(n)-ti(i)),Vt=0;Vt<dt.length;Vt++)dt[Vt]();dt=null,Vt=0}}const ti=t=>t.id==null?1/0:t.id,Gh=(t,e)=>{const n=ti(t)-ti(e);if(n===0){if(t.pre&&!e.pre)return-1;if(e.pre&&!t.pre)return 1}return n};function Ua(t){Ys=!1,ei=!0,Oe.sort(Gh);const e=nt;try{for(ct=0;ct<Oe.length;ct++){const n=Oe[ct];n&&n.active!==!1&&At(n,null,14)}}finally{ct=0,Oe.length=0,Fa(),ei=!1,Br=null,(Oe.length||yn.length)&&Ua()}}function Qh(t,e,...n){if(t.isUnmounted)return;const i=t.vnode.props||de;let s=n;const r=e.startsWith("update:"),o=r&&e.slice(7);if(o&&o in i){const u=`${o==="modelValue"?"model":o}Modifiers`,{number:h,trim:d}=i[u]||de;d&&(s=n.map(_=>_.trim())),h&&(s=n.map(ch))}let l,a=i[l=Es(e)]||i[l=Es(wn(e))];!a&&r&&(a=i[l=Es(kn(e))]),a&&Ke(a,t,6,s);const c=i[l+"Once"];if(c){if(!t.emitted)t.emitted={};else if(t.emitted[l])return;t.emitted[l]=!0,Ke(c,t,6,s)}}function $a(t,e,n=!1){const i=e.emitsCache,s=i.get(t);if(s!==void 0)return s;const r=t.emits;let o={},l=!1;if(!Y(t)){const a=c=>{const u=$a(c,e,!0);u&&(l=!0,De(o,u))};!n&&e.mixins.length&&e.mixins.forEach(a),t.extends&&a(t.extends),t.mixins&&t.mixins.forEach(a)}return!r&&!l?(ve(t)&&i.set(t,null),null):(K(r)?r.forEach(a=>o[a]=null):De(o,r),ve(t)&&i.set(t,o),o)}function as(t,e){return!t||!is(e)?!1:(e=e.slice(2).replace(/Once$/,""),Z(t,e[0].toLowerCase()+e.slice(1))||Z(t,kn(e))||Z(t,e))}let ut=null,cs=null;function Fi(t){const e=ut;return ut=t,cs=t&&t.type.__scopeId||null,e}function Jh(t){cs=t}function Xh(){cs=null}function Zh(t,e=ut,n){if(!e||t._n)return t;const i=(...s)=>{i._d&&tl(-1);const r=Fi(e),o=t(...s);return Fi(r),i._d&&tl(1),o};return i._n=!0,i._c=!0,i._d=!0,i}function Is(t){const{type:e,vnode:n,proxy:i,withProxy:s,props:r,propsOptions:[o],slots:l,attrs:a,emit:c,render:u,renderCache:h,data:d,setupState:_,ctx:v,inheritAttrs:R}=t;let x,W;const ye=Fi(t);try{if(n.shapeFlag&4){const oe=s||i;x=at(u.call(oe,oe,h,r,_,d,v)),W=a}else{const oe=e;x=at(oe.length>1?oe(r,{attrs:a,slots:l,emit:c}):oe(r,null)),W=e.props?a:ef(a)}}catch(oe){zn.length=0,ls(oe,t,1),x=ht(it)}let q=x;if(W&&R!==!1){const oe=Object.keys(W),{shapeFlag:Q}=q;oe.length&&Q&7&&(o&&oe.some(Ar)&&(W=tf(W,o)),q=Dt(q,W))}return n.dirs&&(q=Dt(q),q.dirs=q.dirs?q.dirs.concat(n.dirs):n.dirs),n.transition&&(q.transition=n.transition),x=q,Fi(ye),x}const ef=t=>{let e;for(const n in t)(n==="class"||n==="style"||is(n))&&((e||(e={}))[n]=t[n]);return e},tf=(t,e)=>{const n={};for(const i in t)(!Ar(i)||!(i.slice(9)in e))&&(n[i]=t[i]);return n};function nf(t,e,n){const{props:i,children:s,component:r}=t,{props:o,children:l,patchFlag:a}=e,c=r.emitsOptions;if(e.dirs||e.transition)return!0;if(n&&a>=0){if(a&1024)return!0;if(a&16)return i?zo(i,o,c):!!o;if(a&8){const u=e.dynamicProps;for(let h=0;h<u.length;h++){const d=u[h];if(o[d]!==i[d]&&!as(c,d))return!0}}}else return(s||l)&&(!l||!l.$stable)?!0:i===o?!1:i?o?zo(i,o,c):!0:!!o;return!1}function zo(t,e,n){const i=Object.keys(e);if(i.length!==Object.keys(t).length)return!0;for(let s=0;s<i.length;s++){const r=i[s];if(e[r]!==t[r]&&!as(n,r))return!0}return!1}function sf({vnode:t,parent:e},n){for(;e&&e.subTree===t;)(t=e.vnode).el=n,e=e.parent}const rf=t=>t.__isSuspense;function of(t,e){e&&e.pendingBranch?K(t)?e.effects.push(...t):e.effects.push(t):Yh(t)}function lf(t,e){if(Ae){let n=Ae.provides;const i=Ae.parent&&Ae.parent.provides;i===n&&(n=Ae.provides=Object.create(i)),n[t]=e}}function ws(t,e,n=!1){const i=Ae||ut;if(i){const s=i.parent==null?i.vnode.appContext&&i.vnode.appContext.provides:i.parent.provides;if(s&&t in s)return s[t];if(arguments.length>1)return n&&Y(e)?e.call(i.proxy):e}}const Ko={};function Ts(t,e,n){return Ba(t,e,n)}function Ba(t,e,{immediate:n,deep:i,flush:s,onTrack:r,onTrigger:o}=de){const l=Ae;let a,c=!1,u=!1;if(ke(t)?(a=()=>t.value,c=Li(t)):mn(t)?(a=()=>t,i=!0):K(t)?(u=!0,c=t.some(W=>mn(W)||Li(W)),a=()=>t.map(W=>{if(ke(W))return W.value;if(mn(W))return fn(W);if(Y(W))return At(W,l,2)})):Y(t)?e?a=()=>At(t,l,2):a=()=>{if(!(l&&l.isUnmounted))return h&&h(),Ke(t,l,3,[d])}:a=nt,e&&i){const W=a;a=()=>fn(W())}let h,d=W=>{h=x.onStop=()=>{At(W,l,4)}};if(ii)return d=nt,e?n&&Ke(e,l,3,[a(),u?[]:void 0,d]):a(),nt;let _=u?[]:Ko;const v=()=>{if(!!x.active)if(e){const W=x.run();(i||c||(u?W.some((ye,q)=>Xn(ye,_[q])):Xn(W,_)))&&(h&&h(),Ke(e,l,3,[W,_===Ko?void 0:_,d]),_=W)}else x.run()};v.allowRecurse=!!e;let R;s==="sync"?R=v:s==="post"?R=()=>Fe(v,l&&l.suspense):(v.pre=!0,l&&(v.id=l.uid),R=()=>Hr(v));const x=new Dr(a,R);return e?n?v():_=x.run():s==="post"?Fe(x.run.bind(x),l&&l.suspense):x.run(),()=>{x.stop(),l&&l.scope&&Rr(l.scope.effects,x)}}function af(t,e,n){const i=this.proxy,s=Se(t)?t.includes(".")?Ha(i,t):()=>i[t]:t.bind(i,i);let r;Y(e)?r=e:(r=e.handler,n=e);const o=Ae;Sn(this);const l=Ba(s,r.bind(i),n);return o?Sn(o):Gt(),l}function Ha(t,e){const n=e.split(".");return()=>{let i=t;for(let s=0;s<n.length&&i;s++)i=i[n[s]];return i}}function fn(t,e){if(!ve(t)||t.__v_skip||(e=e||new Set,e.has(t)))return t;if(e.add(t),ke(t))fn(t.value,e);else if(K(t))for(let n=0;n<t.length;n++)fn(t[n],e);else if(da(t)||gn(t))t.forEach(n=>{fn(n,e)});else if(ga(t))for(const n in t)fn(t[n],e);return t}function cf(){const t={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return Ka(()=>{t.isMounted=!0}),qa(()=>{t.isUnmounting=!0}),t}const ze=[Function,Array],uf={name:"BaseTransition",props:{mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:ze,onEnter:ze,onAfterEnter:ze,onEnterCancelled:ze,onBeforeLeave:ze,onLeave:ze,onAfterLeave:ze,onLeaveCancelled:ze,onBeforeAppear:ze,onAppear:ze,onAfterAppear:ze,onAppearCancelled:ze},setup(t,{slots:e}){const n=Qf(),i=cf();let s;return()=>{const r=e.default&&Va(e.default(),!0);if(!r||!r.length)return;let o=r[0];if(r.length>1){for(const R of r)if(R.type!==it){o=R;break}}const l=se(t),{mode:a}=l;if(i.isLeaving)return Ss(o);const c=qo(o);if(!c)return Ss(o);const u=Gs(c,l,i,n);Qs(c,u);const h=n.subTree,d=h&&qo(h);let _=!1;const{getTransitionKey:v}=c.type;if(v){const R=v();s===void 0?s=R:R!==s&&(s=R,_=!0)}if(d&&d.type!==it&&(!jt(c,d)||_)){const R=Gs(d,l,i,n);if(Qs(d,R),a==="out-in")return i.isLeaving=!0,R.afterLeave=()=>{i.isLeaving=!1,n.update()},Ss(o);a==="in-out"&&c.type!==it&&(R.delayLeave=(x,W,ye)=>{const q=Wa(i,d);q[String(d.key)]=d,x._leaveCb=()=>{W(),x._leaveCb=void 0,delete u.delayedLeave},u.delayedLeave=ye})}return o}}},hf=uf;function Wa(t,e){const{leavingVNodes:n}=t;let i=n.get(e.type);return i||(i=Object.create(null),n.set(e.type,i)),i}function Gs(t,e,n,i){const{appear:s,mode:r,persisted:o=!1,onBeforeEnter:l,onEnter:a,onAfterEnter:c,onEnterCancelled:u,onBeforeLeave:h,onLeave:d,onAfterLeave:_,onLeaveCancelled:v,onBeforeAppear:R,onAppear:x,onAfterAppear:W,onAppearCancelled:ye}=e,q=String(t.key),oe=Wa(n,t),Q=(P,F)=>{P&&Ke(P,i,9,F)},D=(P,F)=>{const w=F[1];Q(P,F),K(P)?P.every(ee=>ee.length<=1)&&w():P.length<=1&&w()},z={mode:r,persisted:o,beforeEnter(P){let F=l;if(!n.isMounted)if(s)F=R||l;else return;P._leaveCb&&P._leaveCb(!0);const w=oe[q];w&&jt(t,w)&&w.el._leaveCb&&w.el._leaveCb(),Q(F,[P])},enter(P){let F=a,w=c,ee=u;if(!n.isMounted)if(s)F=x||a,w=W||c,ee=ye||u;else return;let Ee=!1;const B=P._enterCb=k=>{Ee||(Ee=!0,k?Q(ee,[P]):Q(w,[P]),z.delayedLeave&&z.delayedLeave(),P._enterCb=void 0)};F?D(F,[P,B]):B()},leave(P,F){const w=String(t.key);if(P._enterCb&&P._enterCb(!0),n.isUnmounting)return F();Q(h,[P]);let ee=!1;const Ee=P._leaveCb=B=>{ee||(ee=!0,F(),B?Q(v,[P]):Q(_,[P]),P._leaveCb=void 0,oe[w]===t&&delete oe[w])};oe[w]=t,d?D(d,[P,Ee]):Ee()},clone(P){return Gs(P,e,n,i)}};return z}function Ss(t){if(us(t))return t=Dt(t),t.children=null,t}function qo(t){return us(t)?t.children?t.children[0]:void 0:t}function Qs(t,e){t.shapeFlag&6&&t.component?Qs(t.component.subTree,e):t.shapeFlag&128?(t.ssContent.transition=e.clone(t.ssContent),t.ssFallback.transition=e.clone(t.ssFallback)):t.transition=e}function Va(t,e=!1,n){let i=[],s=0;for(let r=0;r<t.length;r++){let o=t[r];const l=n==null?o.key:String(n)+String(o.key!=null?o.key:r);o.type===We?(o.patchFlag&128&&s++,i=i.concat(Va(o.children,e,l))):(e||o.type!==it)&&i.push(l!=null?Dt(o,{key:l}):o)}if(s>1)for(let r=0;r<i.length;r++)i[r].patchFlag=-2;return i}function ja(t){return Y(t)?{setup:t,name:t.name}:t}const ki=t=>!!t.type.__asyncLoader,us=t=>t.type.__isKeepAlive;function ff(t,e){za(t,"a",e)}function df(t,e){za(t,"da",e)}function za(t,e,n=Ae){const i=t.__wdc||(t.__wdc=()=>{let s=n;for(;s;){if(s.isDeactivated)return;s=s.parent}return t()});if(hs(e,i,n),n){let s=n.parent;for(;s&&s.parent;)us(s.parent.vnode)&&pf(i,e,n,s),s=s.parent}}function pf(t,e,n,i){const s=hs(e,t,i,!0);Ya(()=>{Rr(i[e],s)},n)}function hs(t,e,n=Ae,i=!1){if(n){const s=n[t]||(n[t]=[]),r=e.__weh||(e.__weh=(...o)=>{if(n.isUnmounted)return;Dn(),Sn(n);const l=Ke(e,n,t,o);return Gt(),Pn(),l});return i?s.unshift(r):s.push(r),r}}const vt=t=>(e,n=Ae)=>(!ii||t==="sp")&&hs(t,e,n),_f=vt("bm"),Ka=vt("m"),gf=vt("bu"),mf=vt("u"),qa=vt("bum"),Ya=vt("um"),yf=vt("sp"),vf=vt("rtg"),Cf=vt("rtc");function Ef(t,e=Ae){hs("ec",t,e)}function Ut(t,e,n,i){const s=t.dirs,r=e&&e.dirs;for(let o=0;o<s.length;o++){const l=s[o];r&&(l.oldValue=r[o].value);let a=l.dir[i];a&&(Dn(),Ke(a,n,8,[t.el,l,t,e]),Pn())}}const bf=Symbol();function Yo(t,e,n,i){let s;const r=n&&n[i];if(K(t)||Se(t)){s=new Array(t.length);for(let o=0,l=t.length;o<l;o++)s[o]=e(t[o],o,void 0,r&&r[o])}else if(typeof t=="number"){s=new Array(t);for(let o=0;o<t;o++)s[o]=e(o+1,o,void 0,r&&r[o])}else if(ve(t))if(t[Symbol.iterator])s=Array.from(t,(o,l)=>e(o,l,void 0,r&&r[l]));else{const o=Object.keys(t);s=new Array(o.length);for(let l=0,a=o.length;l<a;l++){const c=o[l];s[l]=e(t[c],c,l,r&&r[l])}}else s=[];return n&&(n[i]=s),s}const Js=t=>t?rc(t)?Kr(t)||t.proxy:Js(t.parent):null,Ui=De(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>Js(t.parent),$root:t=>Js(t.root),$emit:t=>t.emit,$options:t=>Wr(t),$forceUpdate:t=>t.f||(t.f=()=>Hr(t.update)),$nextTick:t=>t.n||(t.n=zh.bind(t.proxy)),$watch:t=>af.bind(t)}),If={get({_:t},e){const{ctx:n,setupState:i,data:s,props:r,accessCache:o,type:l,appContext:a}=t;let c;if(e[0]!=="$"){const _=o[e];if(_!==void 0)switch(_){case 1:return i[e];case 2:return s[e];case 4:return n[e];case 3:return r[e]}else{if(i!==de&&Z(i,e))return o[e]=1,i[e];if(s!==de&&Z(s,e))return o[e]=2,s[e];if((c=t.propsOptions[0])&&Z(c,e))return o[e]=3,r[e];if(n!==de&&Z(n,e))return o[e]=4,n[e];Xs&&(o[e]=0)}}const u=Ui[e];let h,d;if(u)return e==="$attrs"&&je(t,"get",e),u(t);if((h=l.__cssModules)&&(h=h[e]))return h;if(n!==de&&Z(n,e))return o[e]=4,n[e];if(d=a.config.globalProperties,Z(d,e))return d[e]},set({_:t},e,n){const{data:i,setupState:s,ctx:r}=t;return s!==de&&Z(s,e)?(s[e]=n,!0):i!==de&&Z(i,e)?(i[e]=n,!0):Z(t.props,e)||e[0]==="$"&&e.slice(1)in t?!1:(r[e]=n,!0)},has({_:{data:t,setupState:e,accessCache:n,ctx:i,appContext:s,propsOptions:r}},o){let l;return!!n[o]||t!==de&&Z(t,o)||e!==de&&Z(e,o)||(l=r[0])&&Z(l,o)||Z(i,o)||Z(Ui,o)||Z(s.config.globalProperties,o)},defineProperty(t,e,n){return n.get!=null?t._.accessCache[e]=0:Z(n,"value")&&this.set(t,e,n.value,null),Reflect.defineProperty(t,e,n)}};let Xs=!0;function wf(t){const e=Wr(t),n=t.proxy,i=t.ctx;Xs=!1,e.beforeCreate&&Go(e.beforeCreate,t,"bc");const{data:s,computed:r,methods:o,watch:l,provide:a,inject:c,created:u,beforeMount:h,mounted:d,beforeUpdate:_,updated:v,activated:R,deactivated:x,beforeDestroy:W,beforeUnmount:ye,destroyed:q,unmounted:oe,render:Q,renderTracked:D,renderTriggered:z,errorCaptured:P,serverPrefetch:F,expose:w,inheritAttrs:ee,components:Ee,directives:B,filters:k}=e;if(c&&Tf(c,i,null,t.appContext.config.unwrapInjectedRef),o)for(const E in o){const O=o[E];Y(O)&&(i[E]=O.bind(n))}if(s){const E=s.call(n,n);ve(E)&&(t.data=Fr(E))}if(Xs=!0,r)for(const E in r){const O=r[E],H=Y(O)?O.bind(n,n):Y(O.get)?O.get.bind(n,n):nt,ne=!Y(O)&&Y(O.set)?O.set.bind(n):nt,fe=nd({get:H,set:ne});Object.defineProperty(i,E,{enumerable:!0,configurable:!0,get:()=>fe.value,set:le=>fe.value=le})}if(l)for(const E in l)Ga(l[E],i,n,E);if(a){const E=Y(a)?a.call(n):a;Reflect.ownKeys(E).forEach(O=>{lf(O,E[O])})}u&&Go(u,t,"c");function L(E,O){K(O)?O.forEach(H=>E(H.bind(n))):O&&E(O.bind(n))}if(L(_f,h),L(Ka,d),L(gf,_),L(mf,v),L(ff,R),L(df,x),L(Ef,P),L(Cf,D),L(vf,z),L(qa,ye),L(Ya,oe),L(yf,F),K(w))if(w.length){const E=t.exposed||(t.exposed={});w.forEach(O=>{Object.defineProperty(E,O,{get:()=>n[O],set:H=>n[O]=H})})}else t.exposed||(t.exposed={});Q&&t.render===nt&&(t.render=Q),ee!=null&&(t.inheritAttrs=ee),Ee&&(t.components=Ee),B&&(t.directives=B)}function Tf(t,e,n=nt,i=!1){K(t)&&(t=Zs(t));for(const s in t){const r=t[s];let o;ve(r)?"default"in r?o=ws(r.from||s,r.default,!0):o=ws(r.from||s):o=ws(r),ke(o)&&i?Object.defineProperty(e,s,{enumerable:!0,configurable:!0,get:()=>o.value,set:l=>o.value=l}):e[s]=o}}function Go(t,e,n){Ke(K(t)?t.map(i=>i.bind(e.proxy)):t.bind(e.proxy),e,n)}function Ga(t,e,n,i){const s=i.includes(".")?Ha(n,i):()=>n[i];if(Se(t)){const r=e[t];Y(r)&&Ts(s,r)}else if(Y(t))Ts(s,t.bind(n));else if(ve(t))if(K(t))t.forEach(r=>Ga(r,e,n,i));else{const r=Y(t.handler)?t.handler.bind(n):e[t.handler];Y(r)&&Ts(s,r,t)}}function Wr(t){const e=t.type,{mixins:n,extends:i}=e,{mixins:s,optionsCache:r,config:{optionMergeStrategies:o}}=t.appContext,l=r.get(e);let a;return l?a=l:!s.length&&!n&&!i?a=e:(a={},s.length&&s.forEach(c=>$i(a,c,o,!0)),$i(a,e,o)),ve(e)&&r.set(e,a),a}function $i(t,e,n,i=!1){const{mixins:s,extends:r}=e;r&&$i(t,r,n,!0),s&&s.forEach(o=>$i(t,o,n,!0));for(const o in e)if(!(i&&o==="expose")){const l=Sf[o]||n&&n[o];t[o]=l?l(t[o],e[o]):e[o]}return t}const Sf={data:Qo,props:Bt,emits:Bt,methods:Bt,computed:Bt,beforeCreate:Le,created:Le,beforeMount:Le,mounted:Le,beforeUpdate:Le,updated:Le,beforeDestroy:Le,beforeUnmount:Le,destroyed:Le,unmounted:Le,activated:Le,deactivated:Le,errorCaptured:Le,serverPrefetch:Le,components:Bt,directives:Bt,watch:Af,provide:Qo,inject:Nf};function Qo(t,e){return e?t?function(){return De(Y(t)?t.call(this,this):t,Y(e)?e.call(this,this):e)}:e:t}function Nf(t,e){return Bt(Zs(t),Zs(e))}function Zs(t){if(K(t)){const e={};for(let n=0;n<t.length;n++)e[t[n]]=t[n];return e}return t}function Le(t,e){return t?[...new Set([].concat(t,e))]:e}function Bt(t,e){return t?De(De(Object.create(null),t),e):e}function Af(t,e){if(!t)return e;if(!e)return t;const n=De(Object.create(null),t);for(const i in e)n[i]=Le(t[i],e[i]);return n}function Rf(t,e,n,i=!1){const s={},r={};Mi(r,fs,1),t.propsDefaults=Object.create(null),Qa(t,e,s,r);for(const o in t.propsOptions[0])o in s||(s[o]=void 0);n?t.props=i?s:Uh(s):t.type.props?t.props=s:t.props=r,t.attrs=r}function xf(t,e,n,i){const{props:s,attrs:r,vnode:{patchFlag:o}}=t,l=se(s),[a]=t.propsOptions;let c=!1;if((i||o>0)&&!(o&16)){if(o&8){const u=t.vnode.dynamicProps;for(let h=0;h<u.length;h++){let d=u[h];if(as(t.emitsOptions,d))continue;const _=e[d];if(a)if(Z(r,d))_!==r[d]&&(r[d]=_,c=!0);else{const v=wn(d);s[v]=er(a,l,v,_,t,!1)}else _!==r[d]&&(r[d]=_,c=!0)}}}else{Qa(t,e,s,r)&&(c=!0);let u;for(const h in l)(!e||!Z(e,h)&&((u=kn(h))===h||!Z(e,u)))&&(a?n&&(n[h]!==void 0||n[u]!==void 0)&&(s[h]=er(a,l,h,void 0,t,!0)):delete s[h]);if(r!==l)for(const h in r)(!e||!Z(e,h)&&!0)&&(delete r[h],c=!0)}c&&yt(t,"set","$attrs")}function Qa(t,e,n,i){const[s,r]=t.propsOptions;let o=!1,l;if(e)for(let a in e){if(Oi(a))continue;const c=e[a];let u;s&&Z(s,u=wn(a))?!r||!r.includes(u)?n[u]=c:(l||(l={}))[u]=c:as(t.emitsOptions,a)||(!(a in i)||c!==i[a])&&(i[a]=c,o=!0)}if(r){const a=se(n),c=l||de;for(let u=0;u<r.length;u++){const h=r[u];n[h]=er(s,a,h,c[h],t,!Z(c,h))}}return o}function er(t,e,n,i,s,r){const o=t[n];if(o!=null){const l=Z(o,"default");if(l&&i===void 0){const a=o.default;if(o.type!==Function&&Y(a)){const{propsDefaults:c}=s;n in c?i=c[n]:(Sn(s),i=c[n]=a.call(null,e),Gt())}else i=a}o[0]&&(r&&!l?i=!1:o[1]&&(i===""||i===kn(n))&&(i=!0))}return i}function Ja(t,e,n=!1){const i=e.propsCache,s=i.get(t);if(s)return s;const r=t.props,o={},l=[];let a=!1;if(!Y(t)){const u=h=>{a=!0;const[d,_]=Ja(h,e,!0);De(o,d),_&&l.push(..._)};!n&&e.mixins.length&&e.mixins.forEach(u),t.extends&&u(t.extends),t.mixins&&t.mixins.forEach(u)}if(!r&&!a)return ve(t)&&i.set(t,_n),_n;if(K(r))for(let u=0;u<r.length;u++){const h=wn(r[u]);Jo(h)&&(o[h]=de)}else if(r)for(const u in r){const h=wn(u);if(Jo(h)){const d=r[u],_=o[h]=K(d)||Y(d)?{type:d}:d;if(_){const v=el(Boolean,_.type),R=el(String,_.type);_[0]=v>-1,_[1]=R<0||v<R,(v>-1||Z(_,"default"))&&l.push(h)}}}const c=[o,l];return ve(t)&&i.set(t,c),c}function Jo(t){return t[0]!=="$"}function Xo(t){const e=t&&t.toString().match(/^\s*function (\w+)/);return e?e[1]:t===null?"null":""}function Zo(t,e){return Xo(t)===Xo(e)}function el(t,e){return K(e)?e.findIndex(n=>Zo(n,t)):Y(e)&&Zo(e,t)?0:-1}const Xa=t=>t[0]==="_"||t==="$stable",Vr=t=>K(t)?t.map(at):[at(t)],Of=(t,e,n)=>{if(e._n)return e;const i=Zh((...s)=>Vr(e(...s)),n);return i._c=!1,i},Za=(t,e,n)=>{const i=t._ctx;for(const s in t){if(Xa(s))continue;const r=t[s];if(Y(r))e[s]=Of(s,r,i);else if(r!=null){const o=Vr(r);e[s]=()=>o}}},ec=(t,e)=>{const n=Vr(e);t.slots.default=()=>n},kf=(t,e)=>{if(t.vnode.shapeFlag&32){const n=e._;n?(t.slots=se(e),Mi(e,"_",n)):Za(e,t.slots={})}else t.slots={},e&&ec(t,e);Mi(t.slots,fs,1)},Df=(t,e,n)=>{const{vnode:i,slots:s}=t;let r=!0,o=de;if(i.shapeFlag&32){const l=e._;l?n&&l===1?r=!1:(De(s,e),!n&&l===1&&delete s._):(r=!e.$stable,Za(e,s)),o=e}else e&&(ec(t,e),o={default:1});if(r)for(const l in s)!Xa(l)&&!(l in o)&&delete s[l]};function tc(){return{app:null,config:{isNativeTag:ih,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Pf=0;function Mf(t,e){return function(i,s=null){Y(i)||(i=Object.assign({},i)),s!=null&&!ve(s)&&(s=null);const r=tc(),o=new Set;let l=!1;const a=r.app={_uid:Pf++,_component:i,_props:s,_container:null,_context:r,_instance:null,version:id,get config(){return r.config},set config(c){},use(c,...u){return o.has(c)||(c&&Y(c.install)?(o.add(c),c.install(a,...u)):Y(c)&&(o.add(c),c(a,...u))),a},mixin(c){return r.mixins.includes(c)||r.mixins.push(c),a},component(c,u){return u?(r.components[c]=u,a):r.components[c]},directive(c,u){return u?(r.directives[c]=u,a):r.directives[c]},mount(c,u,h){if(!l){const d=ht(i,s);return d.appContext=r,u&&e?e(d,c):t(d,c,h),l=!0,a._container=c,c.__vue_app__=a,Kr(d.component)||d.component.proxy}},unmount(){l&&(t(null,a._container),delete a._container.__vue_app__)},provide(c,u){return r.provides[c]=u,a}};return a}}function tr(t,e,n,i,s=!1){if(K(t)){t.forEach((d,_)=>tr(d,e&&(K(e)?e[_]:e),n,i,s));return}if(ki(i)&&!s)return;const r=i.shapeFlag&4?Kr(i.component)||i.component.proxy:i.el,o=s?null:r,{i:l,r:a}=t,c=e&&e.r,u=l.refs===de?l.refs={}:l.refs,h=l.setupState;if(c!=null&&c!==a&&(Se(c)?(u[c]=null,Z(h,c)&&(h[c]=null)):ke(c)&&(c.value=null)),Y(a))At(a,l,12,[o,u]);else{const d=Se(a),_=ke(a);if(d||_){const v=()=>{if(t.f){const R=d?u[a]:a.value;s?K(R)&&Rr(R,r):K(R)?R.includes(r)||R.push(r):d?(u[a]=[r],Z(h,a)&&(h[a]=u[a])):(a.value=[r],t.k&&(u[t.k]=a.value))}else d?(u[a]=o,Z(h,a)&&(h[a]=o)):_&&(a.value=o,t.k&&(u[t.k]=o))};o?(v.id=-1,Fe(v,n)):v()}}}const Fe=of;function Lf(t){return Ff(t)}function Ff(t,e){const n=uh();n.__VUE__=!0;const{insert:i,remove:s,patchProp:r,createElement:o,createText:l,createComment:a,setText:c,setElementText:u,parentNode:h,nextSibling:d,setScopeId:_=nt,cloneNode:v,insertStaticContent:R}=t,x=(f,p,g,y=null,m=null,T=null,A=!1,I=null,S=!!p.dynamicChildren)=>{if(f===p)return;f&&!jt(f,p)&&(y=Ge(f),_e(f,m,T,!0),f=null),p.patchFlag===-2&&(S=!1,p.dynamicChildren=null);const{type:C,ref:U,shapeFlag:M}=p;switch(C){case jr:W(f,p,g,y);break;case it:ye(f,p,g,y);break;case Ns:f==null&&q(p,g,y,A);break;case We:B(f,p,g,y,m,T,A,I,S);break;default:M&1?D(f,p,g,y,m,T,A,I,S):M&6?k(f,p,g,y,m,T,A,I,S):(M&64||M&128)&&C.process(f,p,g,y,m,T,A,I,S,Me)}U!=null&&m&&tr(U,f&&f.ref,T,p||f,!p)},W=(f,p,g,y)=>{if(f==null)i(p.el=l(p.children),g,y);else{const m=p.el=f.el;p.children!==f.children&&c(m,p.children)}},ye=(f,p,g,y)=>{f==null?i(p.el=a(p.children||""),g,y):p.el=f.el},q=(f,p,g,y)=>{[f.el,f.anchor]=R(f.children,p,g,y,f.el,f.anchor)},oe=({el:f,anchor:p},g,y)=>{let m;for(;f&&f!==p;)m=d(f),i(f,g,y),f=m;i(p,g,y)},Q=({el:f,anchor:p})=>{let g;for(;f&&f!==p;)g=d(f),s(f),f=g;s(p)},D=(f,p,g,y,m,T,A,I,S)=>{A=A||p.type==="svg",f==null?z(p,g,y,m,T,A,I,S):w(f,p,m,T,A,I,S)},z=(f,p,g,y,m,T,A,I)=>{let S,C;const{type:U,props:M,shapeFlag:$,transition:j,patchFlag:te,dirs:ae}=f;if(f.el&&v!==void 0&&te===-1)S=f.el=v(f.el);else{if(S=f.el=o(f.type,T,M&&M.is,M),$&8?u(S,f.children):$&16&&F(f.children,S,null,y,m,T&&U!=="foreignObject",A,I),ae&&Ut(f,null,y,"created"),M){for(const ge in M)ge!=="value"&&!Oi(ge)&&r(S,ge,null,M[ge],T,f.children,y,m,Pe);"value"in M&&r(S,"value",null,M.value),(C=M.onVnodeBeforeMount)&&ot(C,y,f)}P(S,f,f.scopeId,A,y)}ae&&Ut(f,null,y,"beforeMount");const ce=(!m||m&&!m.pendingBranch)&&j&&!j.persisted;ce&&j.beforeEnter(S),i(S,p,g),((C=M&&M.onVnodeMounted)||ce||ae)&&Fe(()=>{C&&ot(C,y,f),ce&&j.enter(S),ae&&Ut(f,null,y,"mounted")},m)},P=(f,p,g,y,m)=>{if(g&&_(f,g),y)for(let T=0;T<y.length;T++)_(f,y[T]);if(m){let T=m.subTree;if(p===T){const A=m.vnode;P(f,A,A.scopeId,A.slotScopeIds,m.parent)}}},F=(f,p,g,y,m,T,A,I,S=0)=>{for(let C=S;C<f.length;C++){const U=f[C]=I?St(f[C]):at(f[C]);x(null,U,p,g,y,m,T,A,I)}},w=(f,p,g,y,m,T,A)=>{const I=p.el=f.el;let{patchFlag:S,dynamicChildren:C,dirs:U}=p;S|=f.patchFlag&16;const M=f.props||de,$=p.props||de;let j;g&&$t(g,!1),(j=$.onVnodeBeforeUpdate)&&ot(j,g,p,f),U&&Ut(p,f,g,"beforeUpdate"),g&&$t(g,!0);const te=m&&p.type!=="foreignObject";if(C?ee(f.dynamicChildren,C,I,g,y,te,T):A||H(f,p,I,null,g,y,te,T,!1),S>0){if(S&16)Ee(I,p,M,$,g,y,m);else if(S&2&&M.class!==$.class&&r(I,"class",null,$.class,m),S&4&&r(I,"style",M.style,$.style,m),S&8){const ae=p.dynamicProps;for(let ce=0;ce<ae.length;ce++){const ge=ae[ce],Qe=M[ge],un=$[ge];(un!==Qe||ge==="value")&&r(I,ge,Qe,un,m,f.children,g,y,Pe)}}S&1&&f.children!==p.children&&u(I,p.children)}else!A&&C==null&&Ee(I,p,M,$,g,y,m);((j=$.onVnodeUpdated)||U)&&Fe(()=>{j&&ot(j,g,p,f),U&&Ut(p,f,g,"updated")},y)},ee=(f,p,g,y,m,T,A)=>{for(let I=0;I<p.length;I++){const S=f[I],C=p[I],U=S.el&&(S.type===We||!jt(S,C)||S.shapeFlag&70)?h(S.el):g;x(S,C,U,null,y,m,T,A,!0)}},Ee=(f,p,g,y,m,T,A)=>{if(g!==y){for(const I in y){if(Oi(I))continue;const S=y[I],C=g[I];S!==C&&I!=="value"&&r(f,I,C,S,A,p.children,m,T,Pe)}if(g!==de)for(const I in g)!Oi(I)&&!(I in y)&&r(f,I,g[I],null,A,p.children,m,T,Pe);"value"in y&&r(f,"value",g.value,y.value)}},B=(f,p,g,y,m,T,A,I,S)=>{const C=p.el=f?f.el:l(""),U=p.anchor=f?f.anchor:l("");let{patchFlag:M,dynamicChildren:$,slotScopeIds:j}=p;j&&(I=I?I.concat(j):j),f==null?(i(C,g,y),i(U,g,y),F(p.children,g,U,m,T,A,I,S)):M>0&&M&64&&$&&f.dynamicChildren?(ee(f.dynamicChildren,$,g,m,T,A,I),(p.key!=null||m&&p===m.subTree)&&nc(f,p,!0)):H(f,p,g,U,m,T,A,I,S)},k=(f,p,g,y,m,T,A,I,S)=>{p.slotScopeIds=I,f==null?p.shapeFlag&512?m.ctx.activate(p,g,y,A,S):N(p,g,y,m,T,A,S):L(f,p,S)},N=(f,p,g,y,m,T,A)=>{const I=f.component=Gf(f,y,m);if(us(f)&&(I.ctx.renderer=Me),Jf(I),I.asyncDep){if(m&&m.registerDep(I,E),!f.el){const S=I.subTree=ht(it);ye(null,S,p,g)}return}E(I,f,p,g,m,T,A)},L=(f,p,g)=>{const y=p.component=f.component;if(nf(f,p,g))if(y.asyncDep&&!y.asyncResolved){O(y,p,g);return}else y.next=p,qh(y.update),y.update();else p.el=f.el,y.vnode=p},E=(f,p,g,y,m,T,A)=>{const I=()=>{if(f.isMounted){let{next:U,bu:M,u:$,parent:j,vnode:te}=f,ae=U,ce;$t(f,!1),U?(U.el=te.el,O(f,U,A)):U=te,M&&bs(M),(ce=U.props&&U.props.onVnodeBeforeUpdate)&&ot(ce,j,U,te),$t(f,!0);const ge=Is(f),Qe=f.subTree;f.subTree=ge,x(Qe,ge,h(Qe.el),Ge(Qe),f,m,T),U.el=ge.el,ae===null&&sf(f,ge.el),$&&Fe($,m),(ce=U.props&&U.props.onVnodeUpdated)&&Fe(()=>ot(ce,j,U,te),m)}else{let U;const{el:M,props:$}=p,{bm:j,m:te,parent:ae}=f,ce=ki(p);if($t(f,!1),j&&bs(j),!ce&&(U=$&&$.onVnodeBeforeMount)&&ot(U,ae,p),$t(f,!0),M&&bt){const ge=()=>{f.subTree=Is(f),bt(M,f.subTree,f,m,null)};ce?p.type.__asyncLoader().then(()=>!f.isUnmounted&&ge()):ge()}else{const ge=f.subTree=Is(f);x(null,ge,g,y,f,m,T),p.el=ge.el}if(te&&Fe(te,m),!ce&&(U=$&&$.onVnodeMounted)){const ge=p;Fe(()=>ot(U,ae,ge),m)}(p.shapeFlag&256||ae&&ki(ae.vnode)&&ae.vnode.shapeFlag&256)&&f.a&&Fe(f.a,m),f.isMounted=!0,p=g=y=null}},S=f.effect=new Dr(I,()=>Hr(C),f.scope),C=f.update=()=>S.run();C.id=f.uid,$t(f,!0),C()},O=(f,p,g)=>{p.component=f;const y=f.vnode.props;f.vnode=p,f.next=null,xf(f,p.props,y,g),Df(f,p.children,g),Dn(),jo(),Pn()},H=(f,p,g,y,m,T,A,I,S=!1)=>{const C=f&&f.children,U=f?f.shapeFlag:0,M=p.children,{patchFlag:$,shapeFlag:j}=p;if($>0){if($&128){fe(C,M,g,y,m,T,A,I,S);return}else if($&256){ne(C,M,g,y,m,T,A,I,S);return}}j&8?(U&16&&Pe(C,m,T),M!==C&&u(g,M)):U&16?j&16?fe(C,M,g,y,m,T,A,I,S):Pe(C,m,T,!0):(U&8&&u(g,""),j&16&&F(M,g,y,m,T,A,I,S))},ne=(f,p,g,y,m,T,A,I,S)=>{f=f||_n,p=p||_n;const C=f.length,U=p.length,M=Math.min(C,U);let $;for($=0;$<M;$++){const j=p[$]=S?St(p[$]):at(p[$]);x(f[$],j,g,null,m,T,A,I,S)}C>U?Pe(f,m,T,!0,!1,M):F(p,g,y,m,T,A,I,S,M)},fe=(f,p,g,y,m,T,A,I,S)=>{let C=0;const U=p.length;let M=f.length-1,$=U-1;for(;C<=M&&C<=$;){const j=f[C],te=p[C]=S?St(p[C]):at(p[C]);if(jt(j,te))x(j,te,g,null,m,T,A,I,S);else break;C++}for(;C<=M&&C<=$;){const j=f[M],te=p[$]=S?St(p[$]):at(p[$]);if(jt(j,te))x(j,te,g,null,m,T,A,I,S);else break;M--,$--}if(C>M){if(C<=$){const j=$+1,te=j<U?p[j].el:y;for(;C<=$;)x(null,p[C]=S?St(p[C]):at(p[C]),g,te,m,T,A,I,S),C++}}else if(C>$)for(;C<=M;)_e(f[C],m,T,!0),C++;else{const j=C,te=C,ae=new Map;for(C=te;C<=$;C++){const He=p[C]=S?St(p[C]):at(p[C]);He.key!=null&&ae.set(He.key,C)}let ce,ge=0;const Qe=$-te+1;let un=!1,ko=0;const Un=new Array(Qe);for(C=0;C<Qe;C++)Un[C]=0;for(C=j;C<=M;C++){const He=f[C];if(ge>=Qe){_e(He,m,T,!0);continue}let rt;if(He.key!=null)rt=ae.get(He.key);else for(ce=te;ce<=$;ce++)if(Un[ce-te]===0&&jt(He,p[ce])){rt=ce;break}rt===void 0?_e(He,m,T,!0):(Un[rt-te]=C+1,rt>=ko?ko=rt:un=!0,x(He,p[rt],g,null,m,T,A,I,S),ge++)}const Do=un?Uf(Un):_n;for(ce=Do.length-1,C=Qe-1;C>=0;C--){const He=te+C,rt=p[He],Po=He+1<U?p[He+1].el:y;Un[C]===0?x(null,rt,g,Po,m,T,A,I,S):un&&(ce<0||C!==Do[ce]?le(rt,g,Po,2):ce--)}}},le=(f,p,g,y,m=null)=>{const{el:T,type:A,transition:I,children:S,shapeFlag:C}=f;if(C&6){le(f.component.subTree,p,g,y);return}if(C&128){f.suspense.move(p,g,y);return}if(C&64){A.move(f,p,g,Me);return}if(A===We){i(T,p,g);for(let M=0;M<S.length;M++)le(S[M],p,g,y);i(f.anchor,p,g);return}if(A===Ns){oe(f,p,g);return}if(y!==2&&C&1&&I)if(y===0)I.beforeEnter(T),i(T,p,g),Fe(()=>I.enter(T),m);else{const{leave:M,delayLeave:$,afterLeave:j}=I,te=()=>i(T,p,g),ae=()=>{M(T,()=>{te(),j&&j()})};$?$(T,te,ae):ae()}else i(T,p,g)},_e=(f,p,g,y=!1,m=!1)=>{const{type:T,props:A,ref:I,children:S,dynamicChildren:C,shapeFlag:U,patchFlag:M,dirs:$}=f;if(I!=null&&tr(I,null,g,f,!0),U&256){p.ctx.deactivate(f);return}const j=U&1&&$,te=!ki(f);let ae;if(te&&(ae=A&&A.onVnodeBeforeUnmount)&&ot(ae,p,f),U&6)Lt(f.component,g,y);else{if(U&128){f.suspense.unmount(g,y);return}j&&Ut(f,null,p,"beforeUnmount"),U&64?f.type.remove(f,p,g,m,Me,y):C&&(T!==We||M>0&&M&64)?Pe(C,p,g,!1,!0):(T===We&&M&384||!m&&U&16)&&Pe(S,p,g),y&&qe(f)}(te&&(ae=A&&A.onVnodeUnmounted)||j)&&Fe(()=>{ae&&ot(ae,p,f),j&&Ut(f,null,p,"unmounted")},g)},qe=f=>{const{type:p,el:g,anchor:y,transition:m}=f;if(p===We){Ye(g,y);return}if(p===Ns){Q(f);return}const T=()=>{s(g),m&&!m.persisted&&m.afterLeave&&m.afterLeave()};if(f.shapeFlag&1&&m&&!m.persisted){const{leave:A,delayLeave:I}=m,S=()=>A(g,T);I?I(f.el,T,S):S()}else T()},Ye=(f,p)=>{let g;for(;f!==p;)g=d(f),s(f),f=g;s(p)},Lt=(f,p,g)=>{const{bum:y,scope:m,update:T,subTree:A,um:I}=f;y&&bs(y),m.stop(),T&&(T.active=!1,_e(A,f,p,g)),I&&Fe(I,p),Fe(()=>{f.isUnmounted=!0},p),p&&p.pendingBranch&&!p.isUnmounted&&f.asyncDep&&!f.asyncResolved&&f.suspenseId===p.pendingId&&(p.deps--,p.deps===0&&p.resolve())},Pe=(f,p,g,y=!1,m=!1,T=0)=>{for(let A=T;A<f.length;A++)_e(f[A],p,g,y,m)},Ge=f=>f.shapeFlag&6?Ge(f.component.subTree):f.shapeFlag&128?f.suspense.next():d(f.anchor||f.el),Ne=(f,p,g)=>{f==null?p._vnode&&_e(p._vnode,null,null,!0):x(p._vnode||null,f,p,null,null,null,g),jo(),Fa(),p._vnode=f},Me={p:x,um:_e,m:le,r:qe,mt:N,mc:F,pc:H,pbc:ee,n:Ge,o:t};let Ft,bt;return e&&([Ft,bt]=e(Me)),{render:Ne,hydrate:Ft,createApp:Mf(Ne,Ft)}}function $t({effect:t,update:e},n){t.allowRecurse=e.allowRecurse=n}function nc(t,e,n=!1){const i=t.children,s=e.children;if(K(i)&&K(s))for(let r=0;r<i.length;r++){const o=i[r];let l=s[r];l.shapeFlag&1&&!l.dynamicChildren&&((l.patchFlag<=0||l.patchFlag===32)&&(l=s[r]=St(s[r]),l.el=o.el),n||nc(o,l))}}function Uf(t){const e=t.slice(),n=[0];let i,s,r,o,l;const a=t.length;for(i=0;i<a;i++){const c=t[i];if(c!==0){if(s=n[n.length-1],t[s]<c){e[i]=s,n.push(i);continue}for(r=0,o=n.length-1;r<o;)l=r+o>>1,t[n[l]]<c?r=l+1:o=l;c<t[n[r]]&&(r>0&&(e[i]=n[r-1]),n[r]=i)}}for(r=n.length,o=n[r-1];r-- >0;)n[r]=o,o=e[o];return n}const $f=t=>t.__isTeleport,We=Symbol(void 0),jr=Symbol(void 0),it=Symbol(void 0),Ns=Symbol(void 0),zn=[];let Ze=null;function pt(t=!1){zn.push(Ze=t?null:[])}function Bf(){zn.pop(),Ze=zn[zn.length-1]||null}let ni=1;function tl(t){ni+=t}function ic(t){return t.dynamicChildren=ni>0?Ze||_n:null,Bf(),ni>0&&Ze&&Ze.push(t),t}function Tt(t,e,n,i,s,r){return ic(_t(t,e,n,i,s,r,!0))}function Hf(t,e,n,i,s){return ic(ht(t,e,n,i,s,!0))}function Wf(t){return t?t.__v_isVNode===!0:!1}function jt(t,e){return t.type===e.type&&t.key===e.key}const fs="__vInternal",sc=({key:t})=>t!=null?t:null,Di=({ref:t,ref_key:e,ref_for:n})=>t!=null?Se(t)||ke(t)||Y(t)?{i:ut,r:t,k:e,f:!!n}:t:null;function _t(t,e=null,n=null,i=0,s=null,r=t===We?0:1,o=!1,l=!1){const a={__v_isVNode:!0,__v_skip:!0,type:t,props:e,key:e&&sc(e),ref:e&&Di(e),scopeId:cs,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:r,patchFlag:i,dynamicProps:s,dynamicChildren:null,appContext:null};return l?(zr(a,n),r&128&&t.normalize(a)):n&&(a.shapeFlag|=Se(n)?8:16),ni>0&&!o&&Ze&&(a.patchFlag>0||r&6)&&a.patchFlag!==32&&Ze.push(a),a}const ht=Vf;function Vf(t,e=null,n=null,i=0,s=null,r=!1){if((!t||t===bf)&&(t=it),Wf(t)){const l=Dt(t,e,!0);return n&&zr(l,n),ni>0&&!r&&Ze&&(l.shapeFlag&6?Ze[Ze.indexOf(t)]=l:Ze.push(l)),l.patchFlag|=-2,l}if(td(t)&&(t=t.__vccOpts),e){e=jf(e);let{class:l,style:a}=e;l&&!Se(l)&&(e.class=Nr(l)),ve(a)&&(Ra(a)&&!K(a)&&(a=De({},a)),e.style=Sr(a))}const o=Se(t)?1:rf(t)?128:$f(t)?64:ve(t)?4:Y(t)?2:0;return _t(t,e,n,i,s,o,r,!0)}function jf(t){return t?Ra(t)||fs in t?De({},t):t:null}function Dt(t,e,n=!1){const{props:i,ref:s,patchFlag:r,children:o}=t,l=e?Kf(i||{},e):i;return{__v_isVNode:!0,__v_skip:!0,type:t.type,props:l,key:l&&sc(l),ref:e&&e.ref?n&&s?K(s)?s.concat(Di(e)):[s,Di(e)]:Di(e):s,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:o,target:t.target,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:e&&t.type!==We?r===-1?16:r|16:r,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:t.transition,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&Dt(t.ssContent),ssFallback:t.ssFallback&&Dt(t.ssFallback),el:t.el,anchor:t.anchor}}function zf(t=" ",e=0){return ht(jr,null,t,e)}function nl(t="",e=!1){return e?(pt(),Hf(it,null,t)):ht(it,null,t)}function at(t){return t==null||typeof t=="boolean"?ht(it):K(t)?ht(We,null,t.slice()):typeof t=="object"?St(t):ht(jr,null,String(t))}function St(t){return t.el===null||t.memo?t:Dt(t)}function zr(t,e){let n=0;const{shapeFlag:i}=t;if(e==null)e=null;else if(K(e))n=16;else if(typeof e=="object")if(i&65){const s=e.default;s&&(s._c&&(s._d=!1),zr(t,s()),s._c&&(s._d=!0));return}else{n=32;const s=e._;!s&&!(fs in e)?e._ctx=ut:s===3&&ut&&(ut.slots._===1?e._=1:(e._=2,t.patchFlag|=1024))}else Y(e)?(e={default:e,_ctx:ut},n=32):(e=String(e),i&64?(n=16,e=[zf(e)]):n=8);t.children=e,t.shapeFlag|=n}function Kf(...t){const e={};for(let n=0;n<t.length;n++){const i=t[n];for(const s in i)if(s==="class")e.class!==i.class&&(e.class=Nr([e.class,i.class]));else if(s==="style")e.style=Sr([e.style,i.style]);else if(is(s)){const r=e[s],o=i[s];o&&r!==o&&!(K(r)&&r.includes(o))&&(e[s]=r?[].concat(r,o):o)}else s!==""&&(e[s]=i[s])}return e}function ot(t,e,n,i=null){Ke(t,e,7,[n,i])}const qf=tc();let Yf=0;function Gf(t,e,n){const i=t.type,s=(e?e.appContext:t.appContext)||qf,r={uid:Yf++,vnode:t,type:i,parent:e,appContext:s,root:null,next:null,subTree:null,effect:null,update:null,scope:new hh(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(s.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:Ja(i,s),emitsOptions:$a(i,s),emit:null,emitted:null,propsDefaults:de,inheritAttrs:i.inheritAttrs,ctx:de,data:de,props:de,attrs:de,slots:de,refs:de,setupState:de,setupContext:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return r.ctx={_:r},r.root=e?e.root:r,r.emit=Qh.bind(null,r),t.ce&&t.ce(r),r}let Ae=null;const Qf=()=>Ae||ut,Sn=t=>{Ae=t,t.scope.on()},Gt=()=>{Ae&&Ae.scope.off(),Ae=null};function rc(t){return t.vnode.shapeFlag&4}let ii=!1;function Jf(t,e=!1){ii=e;const{props:n,children:i}=t.vnode,s=rc(t);Rf(t,n,s,e),kf(t,i);const r=s?Xf(t,e):void 0;return ii=!1,r}function Xf(t,e){const n=t.type;t.accessCache=Object.create(null),t.proxy=xa(new Proxy(t.ctx,If));const{setup:i}=n;if(i){const s=t.setupContext=i.length>1?ed(t):null;Sn(t),Dn();const r=At(i,t,0,[t.props,s]);if(Pn(),Gt(),pa(r)){if(r.then(Gt,Gt),e)return r.then(o=>{il(t,o,e)}).catch(o=>{ls(o,t,0)});t.asyncDep=r}else il(t,r,e)}else oc(t,e)}function il(t,e,n){Y(e)?t.type.__ssrInlineRender?t.ssrRender=e:t.render=e:ve(e)&&(t.setupState=Da(e)),oc(t,n)}let sl;function oc(t,e,n){const i=t.type;if(!t.render){if(!e&&sl&&!i.render){const s=i.template||Wr(t).template;if(s){const{isCustomElement:r,compilerOptions:o}=t.appContext.config,{delimiters:l,compilerOptions:a}=i,c=De(De({isCustomElement:r,delimiters:l},o),a);i.render=sl(s,c)}}t.render=i.render||nt}Sn(t),Dn(),wf(t),Pn(),Gt()}function Zf(t){return new Proxy(t.attrs,{get(e,n){return je(t,"get","$attrs"),e[n]}})}function ed(t){const e=i=>{t.exposed=i||{}};let n;return{get attrs(){return n||(n=Zf(t))},slots:t.slots,emit:t.emit,expose:e}}function Kr(t){if(t.exposed)return t.exposeProxy||(t.exposeProxy=new Proxy(Da(xa(t.exposed)),{get(e,n){if(n in e)return e[n];if(n in Ui)return Ui[n](t)}}))}function td(t){return Y(t)&&"__vccOpts"in t}const nd=(t,e)=>Vh(t,e,ii),id="3.2.39",sd="http://www.w3.org/2000/svg",zt=typeof document!="undefined"?document:null,rl=zt&&zt.createElement("template"),rd={insert:(t,e,n)=>{e.insertBefore(t,n||null)},remove:t=>{const e=t.parentNode;e&&e.removeChild(t)},createElement:(t,e,n,i)=>{const s=e?zt.createElementNS(sd,t):zt.createElement(t,n?{is:n}:void 0);return t==="select"&&i&&i.multiple!=null&&s.setAttribute("multiple",i.multiple),s},createText:t=>zt.createTextNode(t),createComment:t=>zt.createComment(t),setText:(t,e)=>{t.nodeValue=e},setElementText:(t,e)=>{t.textContent=e},parentNode:t=>t.parentNode,nextSibling:t=>t.nextSibling,querySelector:t=>zt.querySelector(t),setScopeId(t,e){t.setAttribute(e,"")},cloneNode(t){const e=t.cloneNode(!0);return"_value"in t&&(e._value=t._value),e},insertStaticContent(t,e,n,i,s,r){const o=n?n.previousSibling:e.lastChild;if(s&&(s===r||s.nextSibling))for(;e.insertBefore(s.cloneNode(!0),n),!(s===r||!(s=s.nextSibling)););else{rl.innerHTML=i?`<svg>${t}</svg>`:t;const l=rl.content;if(i){const a=l.firstChild;for(;a.firstChild;)l.appendChild(a.firstChild);l.removeChild(a)}e.insertBefore(l,n)}return[o?o.nextSibling:e.firstChild,n?n.previousSibling:e.lastChild]}};function od(t,e,n){const i=t._vtc;i&&(e=(e?[e,...i]:[...i]).join(" ")),e==null?t.removeAttribute("class"):n?t.setAttribute("class",e):t.className=e}function ld(t,e,n){const i=t.style,s=Se(n);if(n&&!s){for(const r in n)nr(i,r,n[r]);if(e&&!Se(e))for(const r in e)n[r]==null&&nr(i,r,"")}else{const r=i.display;s?e!==n&&(i.cssText=n):e&&t.removeAttribute("style"),"_vod"in t&&(i.display=r)}}const ol=/\s*!important$/;function nr(t,e,n){if(K(n))n.forEach(i=>nr(t,e,i));else if(n==null&&(n=""),e.startsWith("--"))t.setProperty(e,n);else{const i=ad(t,e);ol.test(n)?t.setProperty(kn(i),n.replace(ol,""),"important"):t[i]=n}}const ll=["Webkit","Moz","ms"],As={};function ad(t,e){const n=As[e];if(n)return n;let i=wn(e);if(i!=="filter"&&i in t)return As[e]=i;i=ma(i);for(let s=0;s<ll.length;s++){const r=ll[s]+i;if(r in t)return As[e]=r}return e}const al="http://www.w3.org/1999/xlink";function cd(t,e,n,i,s){if(i&&e.startsWith("xlink:"))n==null?t.removeAttributeNS(al,e.slice(6,e.length)):t.setAttributeNS(al,e,n);else{const r=Zu(e);n==null||r&&!ha(n)?t.removeAttribute(e):t.setAttribute(e,r?"":n)}}function ud(t,e,n,i,s,r,o){if(e==="innerHTML"||e==="textContent"){i&&o(i,s,r),t[e]=n==null?"":n;return}if(e==="value"&&t.tagName!=="PROGRESS"&&!t.tagName.includes("-")){t._value=n;const a=n==null?"":n;(t.value!==a||t.tagName==="OPTION")&&(t.value=a),n==null&&t.removeAttribute(e);return}let l=!1;if(n===""||n==null){const a=typeof t[e];a==="boolean"?n=ha(n):n==null&&a==="string"?(n="",l=!0):a==="number"&&(n=0,l=!0)}try{t[e]=n}catch{}l&&t.removeAttribute(e)}const[lc,hd]=(()=>{let t=Date.now,e=!1;if(typeof window!="undefined"){Date.now()>document.createEvent("Event").timeStamp&&(t=performance.now.bind(performance));const n=navigator.userAgent.match(/firefox\/(\d+)/i);e=!!(n&&Number(n[1])<=53)}return[t,e]})();let ir=0;const fd=Promise.resolve(),dd=()=>{ir=0},pd=()=>ir||(fd.then(dd),ir=lc());function _d(t,e,n,i){t.addEventListener(e,n,i)}function gd(t,e,n,i){t.removeEventListener(e,n,i)}function md(t,e,n,i,s=null){const r=t._vei||(t._vei={}),o=r[e];if(i&&o)o.value=i;else{const[l,a]=yd(e);if(i){const c=r[e]=vd(i,s);_d(t,l,c,a)}else o&&(gd(t,l,o,a),r[e]=void 0)}}const cl=/(?:Once|Passive|Capture)$/;function yd(t){let e;if(cl.test(t)){e={};let i;for(;i=t.match(cl);)t=t.slice(0,t.length-i[0].length),e[i[0].toLowerCase()]=!0}return[t[2]===":"?t.slice(3):kn(t.slice(2)),e]}function vd(t,e){const n=i=>{const s=i.timeStamp||lc();(hd||s>=n.attached-1)&&Ke(Cd(i,n.value),e,5,[i])};return n.value=t,n.attached=pd(),n}function Cd(t,e){if(K(e)){const n=t.stopImmediatePropagation;return t.stopImmediatePropagation=()=>{n.call(t),t._stopped=!0},e.map(i=>s=>!s._stopped&&i&&i(s))}else return e}const ul=/^on[a-z]/,Ed=(t,e,n,i,s=!1,r,o,l,a)=>{e==="class"?od(t,i,s):e==="style"?ld(t,n,i):is(e)?Ar(e)||md(t,e,n,i,o):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):bd(t,e,i,s))?ud(t,e,i,r,o,l,a):(e==="true-value"?t._trueValue=i:e==="false-value"&&(t._falseValue=i),cd(t,e,i,s))};function bd(t,e,n,i){return i?!!(e==="innerHTML"||e==="textContent"||e in t&&ul.test(e)&&Y(n)):e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&t.tagName==="INPUT"||e==="type"&&t.tagName==="TEXTAREA"||ul.test(e)&&Se(n)?!1:e in t}const Id={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String};hf.props;const wd=De({patchProp:Ed},rd);let hl;function Td(){return hl||(hl=Lf(wd))}const Sd=(...t)=>{const e=Td().createApp(...t),{mount:n}=e;return e.mount=i=>{const s=Nd(i);if(!s)return;const r=e._component;!Y(r)&&!r.render&&!r.template&&(r.template=s.innerHTML),s.innerHTML="";const o=n(s,!1,s instanceof SVGElement);return s instanceof Element&&(s.removeAttribute("v-cloak"),s.setAttribute("data-v-app","")),o},e};function Nd(t){return Se(t)?document.querySelector(t):t}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const b=function(t,e){if(!t)throw Mn(e)},Mn=function(t){return new Error("Firebase Database ("+ac.SDK_VERSION+") INTERNAL ASSERT FAILED: "+t)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Jp(t){An(new Jt("platform-logger",e=>new cp(e),"PRIVATE")),An(new Jt("heartbeat",e=>new Yp(e),"PRIVATE")),xt(ar,ml,t),xt(ar,ml,"esm2017"),xt("fire-js","")}Jp("");const El="@firebase/database",bl="0.13.6";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vn=new Jr("@firebase/database"),t_=function(){let t=1;return function(){return t++}}(),wc=function(t){const e=Vd(t),n=new $d;n.update(e);const i=n.digest();return qr.encodeByteArray(i)},_i=function(...t){let e="";for(let n=0;n<t.length;n++){const i=t[n];Array.isArray(i)||i&&typeof i=="object"&&typeof i.length=="number"?e+=_i.apply(null,i):typeof i=="object"?e+=Te(i):e+=i,e+=" "}return e};let Qt=null,Il=!0;const n_=function(t,e){b(!e||t===!0||t===!1,"Can't turn on custom loggers persistently."),t===!0?(vn.logLevel=ue.VERBOSE,Qt=vn.log.bind(vn),e&&ur.set("logging_enabled",!0)):typeof t=="function"?Qt=t:(Qt=null,ur.remove("logging_enabled"))},Re=function(...t){if(Il===!0&&(Il=!1,Qt===null&&ur.get("logging_enabled")===!0&&n_(!0)),Qt){const e=_i.apply(null,t);Qt(e)}},gi=function(t){return function(...e){Re(t,...e)}},hr=function(...t){const e="FIREBASE INTERNAL ERROR: "+_i(...t);vn.error(e)},en=function(...t){const e=`FIREBASE FATAL ERROR: ${_i(...t)}`;throw vn.error(e),new Error(e)},Ve=function(...t){const e="FIREBASE WARNING: "+_i(...t);vn.warn(e)},i_=function(){typeof window!="undefined"&&window.location&&window.location.protocol&&window.location.protocol.indexOf("https:")!==-1&&Ve("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().")},Tc=function(t){return typeof t=="number"&&(t!==t||t===Number.POSITIVE_INFINITY||t===Number.NEGATIVE_INFINITY)},s_=function(t){if(document.readyState==="complete")t();else{let e=!1;const n=function(){if(!document.body){setTimeout(n,Math.floor(10));return}e||(e=!0,t())};document.addEventListener?(document.addEventListener("DOMContentLoaded",n,!1),window.addEventListener("load",n,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",()=>{document.readyState==="complete"&&n()}),window.attachEvent("onload",n))}},Rn="[MIN_NAME]",tn="[MAX_NAME]",Ln=function(t,e){if(t===e)return 0;if(t===Rn||e===tn)return-1;if(e===Rn||t===tn)return 1;{const n=wl(t),i=wl(e);return n!==null?i!==null?n-i===0?t.length-e.length:n-i:-1:i!==null?1:t<e?-1:1}},r_=function(t,e){return t===e?0:t<e?-1:1},Bn=function(t,e){if(e&&t in e)return e[t];throw new Error("Missing required key ("+t+") in object: "+Te(e))},eo=function(t){if(typeof t!="object"||t===null)return Te(t);const e=[];for(const i in t)e.push(i);e.sort();let n="{";for(let i=0;i<e.length;i++)i!==0&&(n+=","),n+=Te(e[i]),n+=":",n+=eo(t[e[i]]);return n+="}",n},Sc=function(t,e){const n=t.length;if(n<=e)return[t];const i=[];for(let s=0;s<n;s+=e)s+e>n?i.push(t.substring(s,n)):i.push(t.substring(s,s+e));return i};function Be(t,e){for(const n in t)t.hasOwnProperty(n)&&e(n,t[n])}const Nc=function(t){b(!Tc(t),"Invalid JSON number");const e=11,n=52,i=(1<<e-1)-1;let s,r,o,l,a;t===0?(r=0,o=0,s=1/t===-1/0?1:0):(s=t<0,t=Math.abs(t),t>=Math.pow(2,1-i)?(l=Math.min(Math.floor(Math.log(t)/Math.LN2),i),r=l+i,o=Math.round(t*Math.pow(2,n-l)-Math.pow(2,n))):(r=0,o=Math.round(t/Math.pow(2,1-i-n))));const c=[];for(a=n;a;a-=1)c.push(o%2?1:0),o=Math.floor(o/2);for(a=e;a;a-=1)c.push(r%2?1:0),r=Math.floor(r/2);c.push(s?1:0),c.reverse();const u=c.join("");let h="";for(a=0;a<64;a+=8){let d=parseInt(u.substr(a,8),2).toString(16);d.length===1&&(d="0"+d),h=h+d}return h.toLowerCase()},o_=function(){return!!(typeof window=="object"&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href))},l_=function(){return typeof Windows=="object"&&typeof Windows.UI=="object"};function a_(t,e){let n="Unknown Error";t==="too_big"?n="The data requested exceeds the maximum size that can be accessed with a single request.":t==="permission_denied"?n="Client doesn't have permission to access the desired data.":t==="unavailable"&&(n="The service is unavailable");const i=new Error(t+" at "+e._path.toString()+": "+n);return i.code=t.toUpperCase(),i}const c_=new RegExp("^-?(0*)\\d{1,10}$"),u_=-2147483648,h_=2147483647,wl=function(t){if(c_.test(t)){const e=Number(t);if(e>=u_&&e<=h_)return e}return null},mi=function(t){try{t()}catch(e){setTimeout(()=>{const n=e.stack||"";throw Ve("Exception was thrown by user callback.",n),e},Math.floor(0))}},f_=function(){return(typeof window=="object"&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0},Kn=function(t,e){const n=setTimeout(t,e);return typeof n=="number"&&typeof Deno!="undefined"&&Deno.unrefTimer?Deno.unrefTimer(n):typeof n=="object"&&n.unref&&n.unref(),n};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jc{constructor(e){this.allowedEvents_=e,this.listeners_={},b(Array.isArray(e)&&e.length>0,"Requires a non-empty array")}trigger(e,...n){if(Array.isArray(this.listeners_[e])){const i=[...this.listeners_[e]];for(let s=0;s<i.length;s++)i[s].callback.apply(i[s].context,n)}}on(e,n,i){this.validateEventType_(e),this.listeners_[e]=this.listeners_[e]||[],this.listeners_[e].push({callback:n,context:i});const s=this.getInitialEvent(e);s&&n.apply(i,s)}off(e,n,i){this.validateEventType_(e);const s=this.listeners_[e]||[];for(let r=0;r<s.length;r++)if(s[r].callback===n&&(!i||i===s[r].context)){s.splice(r,1);return}}validateEventType_(e){b(this.allowedEvents_.find(n=>n===e),"Unknown event: "+e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vi extends jc{constructor(){super(["online"]),this.online_=!0,typeof window!="undefined"&&typeof window.addEventListener!="undefined"&&!Gr()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}static getInstance(){return new Vi}getInitialEvent(e){return b(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ps{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,n){const i=new G(Rn,e),s=new G(Rn,n);return this.compare(i,s)!==0}minPost(){return G.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let pr;function J_(t){pr=t}const Qc=function(t){return typeof t=="number"?"number:"+Nc(t):"string:"+t},Jc=function(t){if(t.isLeafNode()){const e=t.val();b(typeof e=="string"||typeof e=="number"||typeof e=="object"&&Ct(e,".sv"),"Priority must be a string or number.")}else b(t===pr||t.isEmpty(),"priority of unexpected type.");b(t===pr||t.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ll;class Ie{constructor(e,n=Ie.__childrenNodeConstructor.EMPTY_NODE){this.value_=e,this.priorityNode_=n,this.lazyHash_=null,b(this.value_!==void 0&&this.value_!==null,"LeafNode shouldn't be created with null/undefined value."),Jc(this.priorityNode_)}static set __childrenNodeConstructor(e){Ll=e}static get __childrenNodeConstructor(){return Ll}isLeafNode(){return!0}getPriority(){return this.priorityNode_}updatePriority(e){return new Ie(this.value_,e)}getImmediateChild(e){return e===".priority"?this.priorityNode_:Ie.__childrenNodeConstructor.EMPTY_NODE}getChild(e){return X(e)?this:J(e)===".priority"?this.priorityNode_:Ie.__childrenNodeConstructor.EMPTY_NODE}hasChild(){return!1}getPredecessorChildName(e,n){return null}updateImmediateChild(e,n){return e===".priority"?this.updatePriority(n):n.isEmpty()&&e!==".priority"?this:Ie.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(e,n).updatePriority(this.priorityNode_)}updateChild(e,n){const i=J(e);return i===null?n:n.isEmpty()&&i!==".priority"?this:(b(i!==".priority"||Pt(e)===1,".priority must be the last token in a path"),this.updateImmediateChild(i,Ie.__childrenNodeConstructor.EMPTY_NODE.updateChild(pe(e),n)))}isEmpty(){return!1}numChildren(){return 0}forEachChild(e,n){return!1}val(e){return e&&!this.getPriority().isEmpty()?{".value":this.getValue(),".priority":this.getPriority().val()}:this.getValue()}hash(){if(this.lazyHash_===null){let e="";this.priorityNode_.isEmpty()||(e+="priority:"+Qc(this.priorityNode_.val())+":");const n=typeof this.value_;e+=n+":",n==="number"?e+=Nc(this.value_):e+=this.value_,this.lazyHash_=wc(e)}return this.lazyHash_}getValue(){return this.value_}compareTo(e){return e===Ie.__childrenNodeConstructor.EMPTY_NODE?1:e instanceof Ie.__childrenNodeConstructor?-1:(b(e.isLeafNode(),"Unknown node type"),this.compareToLeafNode_(e))}compareToLeafNode_(e){const n=typeof e.value_,i=typeof this.value_,s=Ie.VALUE_TYPE_ORDER.indexOf(n),r=Ie.VALUE_TYPE_ORDER.indexOf(i);return b(s>=0,"Unknown leaf type: "+n),b(r>=0,"Unknown leaf type: "+i),s===r?i==="object"?0:this.value_<e.value_?-1:this.value_===e.value_?0:1:r-s}withIndex(){return this}isIndexed(){return!0}equals(e){if(e===this)return!0;if(e.isLeafNode()){const n=e;return this.value_===n.value_&&this.priorityNode_.equals(n.priorityNode_)}else return!1}}Ie.VALUE_TYPE_ORDER=["object","boolean","number","string"];/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Xc,Zc;function X_(t){Xc=t}function Z_(t){Zc=t}class eg extends ps{compare(e,n){const i=e.node.getPriority(),s=n.node.getPriority(),r=i.compareTo(s);return r===0?Ln(e.name,n.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,n){return!e.getPriority().equals(n.getPriority())}minPost(){return G.MIN}maxPost(){return new G(tn,new Ie("[PRIORITY-POST]",Zc))}makePost(e,n){const i=Xc(e);return new G(n,new Ie("[PRIORITY-POST]",i))}toString(){return".priority"}}const Ce=new eg;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Fs;const hn={};class gt{constructor(e,n){this.indexes_=e,this.indexSet_=n}static get Default(){return b(hn&&Ce,"ChildrenNode.ts has not been loaded"),Fs=Fs||new gt({".priority":hn},{".priority":Ce}),Fs}get(e){const n=Nn(this.indexes_,e);if(!n)throw new Error("No index defined for "+e);return n instanceof $e?n:null}hasIndex(e){return Ct(this.indexSet_,e.toString())}addIndex(e,n){b(e!==Cn,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const i=[];let s=!1;const r=n.getIterator(G.Wrap);let o=r.getNext();for(;o;)s=s||e.isDefinedOn(o.node),i.push(o),o=r.getNext();let l;s?l=ji(i,e.getCompare()):l=hn;const a=e.toString(),c=Object.assign({},this.indexSet_);c[a]=e;const u=Object.assign({},this.indexes_);return u[a]=l,new gt(u,c)}addToIndexes(e,n){const i=Bi(this.indexes_,(s,r)=>{const o=Nn(this.indexSet_,r);if(b(o,"Missing index implementation for "+r),s===hn)if(o.isDefinedOn(e.node)){const l=[],a=n.getIterator(G.Wrap);let c=a.getNext();for(;c;)c.name!==e.name&&l.push(c),c=a.getNext();return l.push(e),ji(l,o.getCompare())}else return hn;else{const l=n.get(e.name);let a=s;return l&&(a=a.remove(new G(e.name,l))),a.insert(e,e.node)}});return new gt(i,this.indexSet_)}removeFromIndexes(e,n){const i=Bi(this.indexes_,s=>{if(s===hn)return s;{const r=n.get(e.name);return r?s.remove(new G(e.name,r)):s}});return new gt(i,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Wn;class V{constructor(e,n,i){this.children_=e,this.priorityNode_=n,this.indexMap_=i,this.lazyHash_=null,this.priorityNode_&&Jc(this.priorityNode_),this.children_.isEmpty()&&b(!this.priorityNode_||this.priorityNode_.isEmpty(),"An empty node cannot have a priority")}static get EMPTY_NODE(){return Wn||(Wn=new V(new $e(oo),null,gt.Default))}isLeafNode(){return!1}getPriority(){return this.priorityNode_||Wn}updatePriority(e){return this.children_.isEmpty()?this:new V(this.children_,e,this.indexMap_)}getImmediateChild(e){if(e===".priority")return this.getPriority();{const n=this.children_.get(e);return n===null?Wn:n}}getChild(e){const n=J(e);return n===null?this:this.getImmediateChild(n).getChild(pe(e))}hasChild(e){return this.children_.get(e)!==null}updateImmediateChild(e,n){if(b(n,"We should always be passing snapshot nodes"),e===".priority")return this.updatePriority(n);{const i=new G(e,n);let s,r;n.isEmpty()?(s=this.children_.remove(e),r=this.indexMap_.removeFromIndexes(i,this.children_)):(s=this.children_.insert(e,n),r=this.indexMap_.addToIndexes(i,this.children_));const o=s.isEmpty()?Wn:this.priorityNode_;return new V(s,o,r)}}updateChild(e,n){const i=J(e);if(i===null)return n;{b(J(e)!==".priority"||Pt(e)===1,".priority must be the last token in a path");const s=this.getImmediateChild(i).updateChild(pe(e),n);return this.updateImmediateChild(i,s)}}isEmpty(){return this.children_.isEmpty()}numChildren(){return this.children_.count()}val(e){if(this.isEmpty())return null;const n={};let i=0,s=0,r=!0;if(this.forEachChild(Ce,(o,l)=>{n[o]=l.val(e),i++,r&&V.INTEGER_REGEXP_.test(o)?s=Math.max(s,Number(o)):r=!1}),!e&&r&&s<2*i){const o=[];for(const l in n)o[l]=n[l];return o}else return e&&!this.getPriority().isEmpty()&&(n[".priority"]=this.getPriority().val()),n}hash(){if(this.lazyHash_===null){let e="";this.getPriority().isEmpty()||(e+="priority:"+Qc(this.getPriority().val())+":"),this.forEachChild(Ce,(n,i)=>{const s=i.hash();s!==""&&(e+=":"+n+":"+s)}),this.lazyHash_=e===""?"":wc(e)}return this.lazyHash_}getPredecessorChildName(e,n,i){const s=this.resolveIndex_(i);if(s){const r=s.getPredecessorKey(new G(e,n));return r?r.name:null}else return this.children_.getPredecessorKey(e)}getFirstChildName(e){const n=this.resolveIndex_(e);if(n){const i=n.minKey();return i&&i.name}else return this.children_.minKey()}getFirstChild(e){const n=this.getFirstChildName(e);return n?new G(n,this.children_.get(n)):null}getLastChildName(e){const n=this.resolveIndex_(e);if(n){const i=n.maxKey();return i&&i.name}else return this.children_.maxKey()}getLastChild(e){const n=this.getLastChildName(e);return n?new G(n,this.children_.get(n)):null}forEachChild(e,n){const i=this.resolveIndex_(e);return i?i.inorderTraversal(s=>n(s.name,s.node)):this.children_.inorderTraversal(n)}getIterator(e){return this.getIteratorFrom(e.minPost(),e)}getIteratorFrom(e,n){const i=this.resolveIndex_(n);if(i)return i.getIteratorFrom(e,s=>s);{const s=this.children_.getIteratorFrom(e.name,G.Wrap);let r=s.peek();for(;r!=null&&n.compare(r,e)<0;)s.getNext(),r=s.peek();return s}}getReverseIterator(e){return this.getReverseIteratorFrom(e.maxPost(),e)}getReverseIteratorFrom(e,n){const i=this.resolveIndex_(n);if(i)return i.getReverseIteratorFrom(e,s=>s);{const s=this.children_.getReverseIteratorFrom(e.name,G.Wrap);let r=s.peek();for(;r!=null&&n.compare(r,e)>0;)s.getNext(),r=s.peek();return s}}compareTo(e){return this.isEmpty()?e.isEmpty()?0:-1:e.isLeafNode()||e.isEmpty()?1:e===yi?-1:0}withIndex(e){if(e===Cn||this.indexMap_.hasIndex(e))return this;{const n=this.indexMap_.addIndex(e,this.children_);return new V(this.children_,this.priorityNode_,n)}}isIndexed(e){return e===Cn||this.indexMap_.hasIndex(e)}equals(e){if(e===this)return!0;if(e.isLeafNode())return!1;{const n=e;if(this.getPriority().equals(n.getPriority()))if(this.children_.count()===n.children_.count()){const i=this.getIterator(Ce),s=n.getIterator(Ce);let r=i.getNext(),o=s.getNext();for(;r&&o;){if(r.name!==o.name||!r.node.equals(o.node))return!1;r=i.getNext(),o=s.getNext()}return r===null&&o===null}else return!1;else return!1}}resolveIndex_(e){return e===Cn?null:this.indexMap_.get(e.toString())}}V.INTEGER_REGEXP_=/^(0|[1-9]\d*)$/;class ig extends V{constructor(){super(new $e(oo),V.EMPTY_NODE,gt.Default)}compareTo(e){return e===this?0:1}equals(e){return e===this}getPriority(){return this}getImmediateChild(e){return V.EMPTY_NODE}isEmpty(){return!1}}const yi=new ig;Object.defineProperties(G,{MIN:{value:new G(Rn,V.EMPTY_NODE)},MAX:{value:new G(tn,yi)}});Gc.__EMPTY_NODE=V.EMPTY_NODE;Ie.__childrenNodeConstructor=V;J_(yi);Z_(yi);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sg=!0;function xe(t,e=null){if(t===null)return V.EMPTY_NODE;if(typeof t=="object"&&".priority"in t&&(e=t[".priority"]),b(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof t=="object"&&".value"in t&&t[".value"]!==null&&(t=t[".value"]),typeof t!="object"||".sv"in t){const n=t;return new Ie(n,xe(e))}if(!(t instanceof Array)&&sg){const n=[];let i=!1;if(Be(t,(o,l)=>{if(o.substring(0,1)!=="."){const a=xe(l);a.isEmpty()||(i=i||!a.getPriority().isEmpty(),n.push(new G(o,a)))}}),n.length===0)return V.EMPTY_NODE;const r=ji(n,Q_,o=>o.name,oo);if(i){const o=ji(n,Ce.getCompare());return new V(r,xe(e),new gt({".priority":o},{".priority":Ce}))}else return new V(r,xe(e),gt.Default)}else{let n=V.EMPTY_NODE;return Be(t,(i,s)=>{if(Ct(t,i)&&i.substring(0,1)!=="."){const r=xe(s);(r.isLeafNode()||!r.isEmpty())&&(n=n.updateImmediateChild(i,r))}}),n.updatePriority(xe(e))}}X_(xe);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function eu(t){return{type:"value",snapshotNode:t}}function xn(t,e){return{type:"child_added",snapshotNode:e,childName:t}}function li(t,e){return{type:"child_removed",snapshotNode:e,childName:t}}function ai(t,e,n){return{type:"child_changed",snapshotNode:e,childName:t,oldSnap:n}}function ag(t,e){return{type:"child_moved",snapshotNode:e,childName:t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lo{constructor(e){this.index_=e}updateChild(e,n,i,s,r,o){b(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const l=e.getImmediateChild(n);return l.getChild(s).equals(i.getChild(s))&&l.isEmpty()===i.isEmpty()||(o!=null&&(i.isEmpty()?e.hasChild(n)?o.trackChildChange(li(n,l)):b(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):l.isEmpty()?o.trackChildChange(xn(n,i)):o.trackChildChange(ai(n,i,l))),e.isLeafNode()&&i.isEmpty())?e:e.updateImmediateChild(n,i).withIndex(this.index_)}updateFullNode(e,n,i){return i!=null&&(e.isLeafNode()||e.forEachChild(Ce,(s,r)=>{n.hasChild(s)||i.trackChildChange(li(s,r))}),n.isLeafNode()||n.forEachChild(Ce,(s,r)=>{if(e.hasChild(s)){const o=e.getImmediateChild(s);o.equals(r)||i.trackChildChange(ai(s,r,o))}else i.trackChildChange(xn(s,r))})),n.withIndex(this.index_)}updatePriority(e,n){return e.isEmpty()?V.EMPTY_NODE:e.updatePriority(n)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ki(){return{value:null,children:new Map}}function tu(t,e,n){if(X(e))t.value=n,t.children.clear();else if(t.value!==null)t.value=t.value.updateChild(e,n);else{const i=J(e);t.children.has(i)||t.children.set(i,Ki());const s=t.children.get(i);e=pe(e),tu(s,e,n)}}function _r(t,e,n){t.value!==null?n(e,t.value):fg(t,(i,s)=>{const r=new he(e.toString()+"/"+i);_r(s,r,n)})}function fg(t,e){t.children.forEach((n,i)=>{e(i,n)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ui{constructor(e,n){this.source=e,this.path=n,this.type=tt.LISTEN_COMPLETE}operationForChild(e){return X(this.path)?new ui(this.source,ie()):new ui(this.source,pe(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nn{constructor(e,n,i){this.source=e,this.path=n,this.snap=i,this.type=tt.OVERWRITE}operationForChild(e){return X(this.path)?new nn(this.source,ie(),this.snap.getImmediateChild(e)):new nn(this.source,pe(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hi{constructor(e,n,i){this.source=e,this.path=n,this.children=i,this.type=tt.MERGE}operationForChild(e){if(X(this.path)){const n=this.children.subtree(new he(e));return n.isEmpty()?null:n.value?new nn(this.source,ie(),n.value):new hi(this.source,ie(),n)}else return b(J(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new hi(this.source,pe(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class st{constructor(e){this.writeTree_=e}static empty(){return new st(new me(null))}}function Yn(t,e,n){if(X(e))return new st(new me(n));{const i=t.writeTree_.findRootMostValueAndPath(e);if(i!=null){const s=i.path;let r=i.value;const o=Ue(s,e);return r=r.updateChild(o,n),new st(t.writeTree_.set(s,r))}else{const s=new me(n),r=t.writeTree_.setTree(e,s);return new st(r)}}}function Bl(t,e,n){let i=t;return Be(n,(s,r)=>{i=Yn(i,be(e,s),r)}),i}function Hl(t,e){if(X(e))return st.empty();{const n=t.writeTree_.setTree(e,new me(null));return new st(n)}}function mr(t,e){return an(t,e)!=null}function an(t,e){const n=t.writeTree_.findRootMostValueAndPath(e);return n!=null?t.writeTree_.get(n.path).getChild(Ue(n.path,e)):null}function Wl(t){const e=[],n=t.writeTree_.value;return n!=null?n.isLeafNode()||n.forEachChild(Ce,(i,s)=>{e.push(new G(i,s))}):t.writeTree_.children.inorderTraversal((i,s)=>{s.value!=null&&e.push(new G(i,s.value))}),e}function Ot(t,e){if(X(e))return t;{const n=an(t,e);return n!=null?new st(new me(n)):new st(t.writeTree_.subtree(e))}}function yr(t){return t.writeTree_.isEmpty()}function On(t,e){return su(ie(),t.writeTree_,e)}function su(t,e,n){if(e.value!=null)return n.updateChild(t,e.value);{let i=null;return e.children.inorderTraversal((s,r)=>{s===".priority"?(b(r.value!==null,"Priority writes must always be leaf nodes"),i=r.value):n=su(be(t,s),r,n)}),!n.getChild(t).isEmpty()&&i!==null&&(n=n.updateChild(be(t,".priority"),i)),n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ho(t,e){return au(e,t)}function bg(t,e,n,i,s){b(i>t.lastWriteId,"Stacking an older write on top of newer ones"),s===void 0&&(s=!0),t.allWrites.push({path:e,snap:n,writeId:i,visible:s}),s&&(t.visibleWrites=Yn(t.visibleWrites,e,n)),t.lastWriteId=i}function Ig(t,e){for(let n=0;n<t.allWrites.length;n++){const i=t.allWrites[n];if(i.writeId===e)return i}return null}function wg(t,e){const n=t.allWrites.findIndex(l=>l.writeId===e);b(n>=0,"removeWrite called with nonexistent writeId.");const i=t.allWrites[n];t.allWrites.splice(n,1);let s=i.visible,r=!1,o=t.allWrites.length-1;for(;s&&o>=0;){const l=t.allWrites[o];l.visible&&(o>=n&&Tg(l,i.path)?s=!1:et(i.path,l.path)&&(r=!0)),o--}if(s){if(r)return Sg(t),!0;if(i.snap)t.visibleWrites=Hl(t.visibleWrites,i.path);else{const l=i.children;Be(l,a=>{t.visibleWrites=Hl(t.visibleWrites,be(i.path,a))})}return!0}else return!1}function Tg(t,e){if(t.snap)return et(t.path,e);for(const n in t.children)if(t.children.hasOwnProperty(n)&&et(be(t.path,n),e))return!0;return!1}function Sg(t){t.visibleWrites=ru(t.allWrites,Ng,ie()),t.allWrites.length>0?t.lastWriteId=t.allWrites[t.allWrites.length-1].writeId:t.lastWriteId=-1}function Ng(t){return t.visible}function ru(t,e,n){let i=st.empty();for(let s=0;s<t.length;++s){const r=t[s];if(e(r)){const o=r.path;let l;if(r.snap)et(n,o)?(l=Ue(n,o),i=Yn(i,l,r.snap)):et(o,n)&&(l=Ue(o,n),i=Yn(i,ie(),r.snap.getChild(l)));else if(r.children){if(et(n,o))l=Ue(n,o),i=Bl(i,l,r.children);else if(et(o,n))if(l=Ue(o,n),X(l))i=Bl(i,ie(),r.children);else{const a=Nn(r.children,J(l));if(a){const c=a.getChild(pe(l));i=Yn(i,ie(),c)}}}else throw Mn("WriteRecord should have .snap or .children")}}return i}function ou(t,e,n,i,s){if(!i&&!s){const r=an(t.visibleWrites,e);if(r!=null)return r;{const o=Ot(t.visibleWrites,e);if(yr(o))return n;if(n==null&&!mr(o,ie()))return null;{const l=n||V.EMPTY_NODE;return On(o,l)}}}else{const r=Ot(t.visibleWrites,e);if(!s&&yr(r))return n;if(!s&&n==null&&!mr(r,ie()))return null;{const o=function(c){return(c.visible||s)&&(!i||!~i.indexOf(c.writeId))&&(et(c.path,e)||et(e,c.path))},l=ru(t.allWrites,o,e),a=n||V.EMPTY_NODE;return On(l,a)}}}function Ag(t,e,n){let i=V.EMPTY_NODE;const s=an(t.visibleWrites,e);if(s)return s.isLeafNode()||s.forEachChild(Ce,(r,o)=>{i=i.updateImmediateChild(r,o)}),i;if(n){const r=Ot(t.visibleWrites,e);return n.forEachChild(Ce,(o,l)=>{const a=On(Ot(r,new he(o)),l);i=i.updateImmediateChild(o,a)}),Wl(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}else{const r=Ot(t.visibleWrites,e);return Wl(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}}function Rg(t,e,n,i,s){b(i||s,"Either existingEventSnap or existingServerSnap must exist");const r=be(e,n);if(mr(t.visibleWrites,r))return null;{const o=Ot(t.visibleWrites,r);return yr(o)?s.getChild(n):On(o,s.getChild(n))}}function xg(t,e,n,i){const s=be(e,n),r=an(t.visibleWrites,s);if(r!=null)return r;if(i.isCompleteForChild(n)){const o=Ot(t.visibleWrites,s);return On(o,i.getNode().getImmediateChild(n))}else return null}function Og(t,e){return an(t.visibleWrites,e)}function kg(t,e,n,i,s,r,o){let l;const a=Ot(t.visibleWrites,e),c=an(a,ie());if(c!=null)l=c;else if(n!=null)l=On(a,n);else return[];if(l=l.withIndex(o),!l.isEmpty()&&!l.isLeafNode()){const u=[],h=o.getCompare(),d=r?l.getReverseIteratorFrom(i,o):l.getIteratorFrom(i,o);let _=d.getNext();for(;_&&u.length<s;)h(_,i)!==0&&u.push(_),_=d.getNext();return u}else return[]}function Dg(){return{visibleWrites:st.empty(),allWrites:[],lastWriteId:-1}}function Yi(t,e,n,i){return ou(t.writeTree,t.treePath,e,n,i)}function fo(t,e){return Ag(t.writeTree,t.treePath,e)}function Vl(t,e,n,i){return Rg(t.writeTree,t.treePath,e,n,i)}function Gi(t,e){return Og(t.writeTree,be(t.treePath,e))}function Pg(t,e,n,i,s,r){return kg(t.writeTree,t.treePath,e,n,i,s,r)}function po(t,e,n){return xg(t.writeTree,t.treePath,e,n)}function lu(t,e){return au(be(t.treePath,e),t.writeTree)}function au(t,e){return{treePath:t,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fg(t){return{filter:t}}function Ug(t,e){b(e.eventCache.getNode().isIndexed(t.filter.getIndex()),"Event snap not indexed"),b(e.serverCache.getNode().isIndexed(t.filter.getIndex()),"Server snap not indexed")}function $g(t,e,n,i,s){const r=new Mg;let o,l;if(n.type===tt.OVERWRITE){const c=n;c.source.fromUser?o=vr(t,e,c.path,c.snap,i,s,r):(b(c.source.fromServer,"Unknown source."),l=c.source.tagged||e.serverCache.isFiltered()&&!X(c.path),o=Qi(t,e,c.path,c.snap,i,s,l,r))}else if(n.type===tt.MERGE){const c=n;c.source.fromUser?o=Hg(t,e,c.path,c.children,i,s,r):(b(c.source.fromServer,"Unknown source."),l=c.source.tagged||e.serverCache.isFiltered(),o=Cr(t,e,c.path,c.children,i,s,l,r))}else if(n.type===tt.ACK_USER_WRITE){const c=n;c.revert?o=jg(t,e,c.path,i,s,r):o=Wg(t,e,c.path,c.affectedTree,i,s,r)}else if(n.type===tt.LISTEN_COMPLETE)o=Vg(t,e,n.path,i,r);else throw Mn("Unknown operation type: "+n.type);const a=r.getChanges();return Bg(e,o,a),{viewCache:o,changes:a}}function Bg(t,e,n){const i=e.eventCache;if(i.isFullyInitialized()){const s=i.getNode().isLeafNode()||i.getNode().isEmpty(),r=gr(t);(n.length>0||!t.eventCache.isFullyInitialized()||s&&!i.getNode().equals(r)||!i.getNode().getPriority().equals(r.getPriority()))&&n.push(eu(gr(e)))}}function uu(t,e,n,i,s,r){const o=e.eventCache;if(Gi(i,n)!=null)return e;{let l,a;if(X(n))if(b(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const c=rn(e),u=c instanceof V?c:V.EMPTY_NODE,h=fo(i,u);l=t.filter.updateFullNode(e.eventCache.getNode(),h,r)}else{const c=Yi(i,rn(e));l=t.filter.updateFullNode(e.eventCache.getNode(),c,r)}else{const c=J(n);if(c===".priority"){b(Pt(n)===1,"Can't have a priority with additional path components");const u=o.getNode();a=e.serverCache.getNode();const h=Vl(i,n,u,a);h!=null?l=t.filter.updatePriority(u,h):l=o.getNode()}else{const u=pe(n);let h;if(o.isCompleteForChild(c)){a=e.serverCache.getNode();const d=Vl(i,n,o.getNode(),a);d!=null?h=o.getNode().getImmediateChild(c).updateChild(u,d):h=o.getNode().getImmediateChild(c)}else h=po(i,c,e.serverCache);h!=null?l=t.filter.updateChild(o.getNode(),c,h,u,s,r):l=o.getNode()}}return qn(e,l,o.isFullyInitialized()||X(n),t.filter.filtersNodes())}}function Qi(t,e,n,i,s,r,o,l){const a=e.serverCache;let c;const u=o?t.filter:t.filter.getIndexedFilter();if(X(n))c=u.updateFullNode(a.getNode(),i,null);else if(u.filtersNodes()&&!a.isFiltered()){const _=a.getNode().updateChild(n,i);c=u.updateFullNode(a.getNode(),_,null)}else{const _=J(n);if(!a.isCompleteForPath(n)&&Pt(n)>1)return e;const v=pe(n),x=a.getNode().getImmediateChild(_).updateChild(v,i);_===".priority"?c=u.updatePriority(a.getNode(),x):c=u.updateChild(a.getNode(),_,x,v,cu,null)}const h=iu(e,c,a.isFullyInitialized()||X(n),u.filtersNodes()),d=new _o(s,h,r);return uu(t,h,n,s,d,l)}function vr(t,e,n,i,s,r,o){const l=e.eventCache;let a,c;const u=new _o(s,e,r);if(X(n))c=t.filter.updateFullNode(e.eventCache.getNode(),i,o),a=qn(e,c,!0,t.filter.filtersNodes());else{const h=J(n);if(h===".priority")c=t.filter.updatePriority(e.eventCache.getNode(),i),a=qn(e,c,l.isFullyInitialized(),l.isFiltered());else{const d=pe(n),_=l.getNode().getImmediateChild(h);let v;if(X(d))v=i;else{const R=u.getCompleteChild(h);R!=null?zc(d)===".priority"&&R.getChild(qc(d)).isEmpty()?v=R:v=R.updateChild(d,i):v=V.EMPTY_NODE}if(_.equals(v))a=e;else{const R=t.filter.updateChild(l.getNode(),h,v,d,u,o);a=qn(e,R,l.isFullyInitialized(),t.filter.filtersNodes())}}}return a}function jl(t,e){return t.eventCache.isCompleteForChild(e)}function Hg(t,e,n,i,s,r,o){let l=e;return i.foreach((a,c)=>{const u=be(n,a);jl(e,J(u))&&(l=vr(t,l,u,c,s,r,o))}),i.foreach((a,c)=>{const u=be(n,a);jl(e,J(u))||(l=vr(t,l,u,c,s,r,o))}),l}function zl(t,e,n){return n.foreach((i,s)=>{e=e.updateChild(i,s)}),e}function Cr(t,e,n,i,s,r,o,l){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let a=e,c;X(n)?c=i:c=new me(null).setTree(n,i);const u=e.serverCache.getNode();return c.children.inorderTraversal((h,d)=>{if(u.hasChild(h)){const _=e.serverCache.getNode().getImmediateChild(h),v=zl(t,_,d);a=Qi(t,a,new he(h),v,s,r,o,l)}}),c.children.inorderTraversal((h,d)=>{const _=!e.serverCache.isCompleteForChild(h)&&d.value===null;if(!u.hasChild(h)&&!_){const v=e.serverCache.getNode().getImmediateChild(h),R=zl(t,v,d);a=Qi(t,a,new he(h),R,s,r,o,l)}}),a}function Wg(t,e,n,i,s,r,o){if(Gi(s,n)!=null)return e;const l=e.serverCache.isFiltered(),a=e.serverCache;if(i.value!=null){if(X(n)&&a.isFullyInitialized()||a.isCompleteForPath(n))return Qi(t,e,n,a.getNode().getChild(n),s,r,l,o);if(X(n)){let c=new me(null);return a.getNode().forEachChild(Cn,(u,h)=>{c=c.set(new he(u),h)}),Cr(t,e,n,c,s,r,l,o)}else return e}else{let c=new me(null);return i.foreach((u,h)=>{const d=be(n,u);a.isCompleteForPath(d)&&(c=c.set(u,a.getNode().getChild(d)))}),Cr(t,e,n,c,s,r,l,o)}}function Vg(t,e,n,i,s){const r=e.serverCache,o=iu(e,r.getNode(),r.isFullyInitialized()||X(n),r.isFiltered());return uu(t,o,n,i,cu,s)}function jg(t,e,n,i,s,r){let o;if(Gi(i,n)!=null)return e;{const l=new _o(i,e,s),a=e.eventCache.getNode();let c;if(X(n)||J(n)===".priority"){let u;if(e.serverCache.isFullyInitialized())u=Yi(i,rn(e));else{const h=e.serverCache.getNode();b(h instanceof V,"serverChildren would be complete if leaf node"),u=fo(i,h)}u=u,c=t.filter.updateFullNode(a,u,r)}else{const u=J(n);let h=po(i,u,e.serverCache);h==null&&e.serverCache.isCompleteForChild(u)&&(h=a.getImmediateChild(u)),h!=null?c=t.filter.updateChild(a,u,h,pe(n),l,r):e.eventCache.getNode().hasChild(u)?c=t.filter.updateChild(a,u,V.EMPTY_NODE,pe(n),l,r):c=a,c.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=Yi(i,rn(e)),o.isLeafNode()&&(c=t.filter.updateFullNode(c,o,r)))}return o=e.serverCache.isFullyInitialized()||Gi(i,ie())!=null,qn(e,c,o,t.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Xi;function im(t){b(!Xi,"__referenceConstructor has already been defined"),Xi=t}function sm(){return b(Xi,"Reference.ts has not been loaded"),Xi}let rm=1;class Gl{constructor(e){this.listenProvider_=e,this.syncPointTree_=new me(null),this.pendingWriteTree_=Dg(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function om(t,e,n,i,s){return bg(t.pendingWriteTree_,e,n,i,s),s?vi(t,new nn(nu(),e,n)):[]}function pn(t,e,n=!1){const i=Ig(t.pendingWriteTree_,e);if(wg(t.pendingWriteTree_,e)){let r=new me(null);return i.snap!=null?r=r.set(ie(),!0):Be(i.children,o=>{r=r.set(new he(o),!0)}),vi(t,new qi(i.path,r,n))}else return[]}function ms(t,e,n){return vi(t,new nn(co(),e,n))}function lm(t,e,n){const i=me.fromObject(n);return vi(t,new hi(co(),e,i))}function am(t,e){return vi(t,new ui(co(),e))}function cm(t,e,n){const i=mo(t,n);if(i){const s=yo(i),r=s.path,o=s.queryId,l=Ue(r,e),a=new ui(uo(o),l);return vo(t,r,a)}else return[]}function Er(t,e,n,i,s=!1){const r=e._path,o=t.syncPointTree_.get(r);let l=[];if(o&&(e._queryIdentifier==="default"||pu(o,e))){const a=nm(o,e,n,i);Zg(o)&&(t.syncPointTree_=t.syncPointTree_.remove(r));const c=a.removed;if(l=a.events,!s){const u=c.findIndex(d=>d._queryParams.loadsAllData())!==-1,h=t.syncPointTree_.findOnPath(r,(d,_)=>Mt(_));if(u&&!h){const d=t.syncPointTree_.subtree(r);if(!d.isEmpty()){const _=fm(d);for(let v=0;v<_.length;++v){const R=_[v],x=R.query,W=yu(t,R);t.listenProvider_.startListening(Gn(x),Zi(t,x),W.hashFn,W.onComplete)}}}!h&&c.length>0&&!i&&(u?t.listenProvider_.stopListening(Gn(e),null):c.forEach(d=>{const _=t.queryToTagMap.get(ys(d));t.listenProvider_.stopListening(Gn(d),_)}))}dm(t,c)}return l}function um(t,e,n,i){const s=mo(t,i);if(s!=null){const r=yo(s),o=r.path,l=r.queryId,a=Ue(o,e),c=new nn(uo(l),a,n);return vo(t,o,c)}else return[]}function hm(t,e,n,i){const s=mo(t,i);if(s){const r=yo(s),o=r.path,l=r.queryId,a=Ue(o,e),c=me.fromObject(n),u=new hi(uo(l),a,c);return vo(t,o,u)}else return[]}function Ql(t,e,n,i=!1){const s=e._path;let r=null,o=!1;t.syncPointTree_.foreachOnPath(s,(d,_)=>{const v=Ue(d,s);r=r||En(_,v),o=o||Mt(_)});let l=t.syncPointTree_.get(s);l?(o=o||Mt(l),r=r||En(l,ie())):(l=new Qg,t.syncPointTree_=t.syncPointTree_.set(s,l));let a;r!=null?a=!0:(a=!1,r=V.EMPTY_NODE,t.syncPointTree_.subtree(s).foreachChild((_,v)=>{const R=En(v,ie());R&&(r=r.updateImmediateChild(_,R))}));const c=pu(l,e);if(!c&&!e._queryParams.loadsAllData()){const d=ys(e);b(!t.queryToTagMap.has(d),"View does not exist, but we have a tag");const _=pm();t.queryToTagMap.set(d,_),t.tagToQueryMap.set(_,d)}const u=ho(t.pendingWriteTree_,s);let h=tm(l,e,n,u,r,a);if(!c&&!o&&!i){const d=du(l,e);h=h.concat(_m(t,e,d))}return h}function _u(t,e,n){const s=t.pendingWriteTree_,r=t.syncPointTree_.findOnPath(e,(o,l)=>{const a=Ue(o,e),c=En(l,a);if(c)return c});return ou(s,e,r,n,!0)}function vi(t,e){return gu(e,t.syncPointTree_,null,ho(t.pendingWriteTree_,ie()))}function gu(t,e,n,i){if(X(t.path))return mu(t,e,n,i);{const s=e.get(ie());n==null&&s!=null&&(n=En(s,ie()));let r=[];const o=J(t.path),l=t.operationForChild(o),a=e.children.get(o);if(a&&l){const c=n?n.getImmediateChild(o):null,u=lu(i,o);r=r.concat(gu(l,a,c,u))}return s&&(r=r.concat(go(s,t,i,n))),r}}function mu(t,e,n,i){const s=e.get(ie());n==null&&s!=null&&(n=En(s,ie()));let r=[];return e.children.inorderTraversal((o,l)=>{const a=n?n.getImmediateChild(o):null,c=lu(i,o),u=t.operationForChild(o);u&&(r=r.concat(mu(u,l,a,c)))}),s&&(r=r.concat(go(s,t,i,n))),r}function yu(t,e){const n=e.query,i=Zi(t,n);return{hashFn:()=>(Kg(e)||V.EMPTY_NODE).hash(),onComplete:s=>{if(s==="ok")return i?cm(t,n._path,i):am(t,n._path);{const r=a_(s,n);return Er(t,n,null,r)}}}}function Zi(t,e){const n=ys(e);return t.queryToTagMap.get(n)}function ys(t){return t._path.toString()+"$"+t._queryIdentifier}function mo(t,e){return t.tagToQueryMap.get(e)}function yo(t){const e=t.indexOf("$");return b(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new he(t.substr(0,e))}}function vo(t,e,n){const i=t.syncPointTree_.get(e);b(i,"Missing sync point for query tag that we're tracking");const s=ho(t.pendingWriteTree_,e);return go(i,n,s,null)}function fm(t){return t.fold((e,n,i)=>{if(n&&Mt(n))return[gs(n)];{let s=[];return n&&(s=fu(n)),Be(i,(r,o)=>{s=s.concat(o)}),s}})}function Gn(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(sm())(t._repo,t._path):t}function dm(t,e){for(let n=0;n<e.length;++n){const i=e[n];if(!i._queryParams.loadsAllData()){const s=ys(i),r=t.queryToTagMap.get(s);t.queryToTagMap.delete(s),t.tagToQueryMap.delete(r)}}}function pm(){return rm++}function _m(t,e,n){const i=e._path,s=Zi(t,e),r=yu(t,n),o=t.listenProvider_.startListening(Gn(e),s,r.hashFn,r.onComplete),l=t.syncPointTree_.subtree(i);if(s)b(!Mt(l.value),"If we're adding a query, it shouldn't be shadowed");else{const a=l.fold((c,u,h)=>{if(!X(c)&&u&&Mt(u))return[gs(u).query];{let d=[];return u&&(d=d.concat(fu(u).map(_=>_.query))),Be(h,(_,v)=>{d=d.concat(v)}),d}});for(let c=0;c<a.length;++c){const u=a[c];t.listenProvider_.stopListening(Gn(u),Zi(t,u))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Io{constructor(e="",n=null,i={children:{},childCount:0}){this.name=e,this.parent=n,this.node=i}}function wo(t,e){let n=e instanceof he?e:new he(e),i=t,s=J(n);for(;s!==null;){const r=Nn(i.node.children,s)||{children:{},childCount:0};i=new Io(s,i,r),n=pe(n),s=J(n)}return i}function Fn(t){return t.node.value}function vu(t,e){t.node.value=e,br(t)}function Cu(t){return t.node.childCount>0}function Em(t){return Fn(t)===void 0&&!Cu(t)}function vs(t,e){Be(t.node.children,(n,i)=>{e(new Io(n,t,i))})}function Eu(t,e,n,i){n&&!i&&e(t),vs(t,s=>{Eu(s,e,!0,i)}),n&&i&&e(t)}function bm(t,e,n){let i=n?t:t.parent;for(;i!==null;){if(e(i))return!0;i=i.parent}return!1}function Ci(t){return new he(t.parent===null?t.name:Ci(t.parent)+"/"+t.name)}function br(t){t.parent!==null&&Im(t.parent,t.name,t)}function Im(t,e,n){const i=Em(n),s=Ct(t.node.children,e);i&&s?(delete t.node.children[e],t.node.childCount--,br(t)):!i&&!s&&(t.node.children[e]=n.node,t.node.childCount++,br(t))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Om="repo_interrupt",km=25;class Dm{constructor(e,n,i,s){this.repoInfo_=e,this.forceRestClient_=n,this.authTokenProvider_=i,this.appCheckProvider_=s,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Rm,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Ki(),this.transactionQueueTree_=new Io,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function Pm(t,e,n){if(t.stats_=no(t.repoInfo_),t.forceRestClient_||f_())t.server_=new zi(t.repoInfo_,(i,s,r,o)=>{Xl(t,i,s,r,o)},t.authTokenProvider_,t.appCheckProvider_),setTimeout(()=>Zl(t,!0),0);else{if(typeof n!="undefined"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{Te(n)}catch(i){throw new Error("Invalid authOverride provided: "+i)}}t.persistentConnection_=new mt(t.repoInfo_,e,(i,s,r,o)=>{Xl(t,i,s,r,o)},i=>{Zl(t,i)},i=>{Lm(t,i)},t.authTokenProvider_,t.appCheckProvider_,n),t.server_=t.persistentConnection_}t.authTokenProvider_.addTokenChangeListener(i=>{t.server_.refreshAuthToken(i)}),t.appCheckProvider_.addTokenChangeListener(i=>{t.server_.refreshAppCheckToken(i.token)}),t.statsReporter_=y_(t.repoInfo_,()=>new gg(t.stats_,t.server_)),t.infoData_=new hg,t.infoSyncTree_=new Gl({startListening:(i,s,r,o)=>{let l=[];const a=t.infoData_.getNode(i._path);return a.isEmpty()||(l=ms(t.infoSyncTree_,i._path,a),setTimeout(()=>{o("ok")},0)),l},stopListening:()=>{}}),To(t,"connected",!1),t.serverSyncTree_=new Gl({startListening:(i,s,r,o)=>(t.server_.listen(i,r,s,(l,a)=>{const c=o(l,a);cn(t.eventQueue_,i._path,c)}),[]),stopListening:(i,s)=>{t.server_.unlisten(i,s)}})}function Mm(t){const n=t.infoData_.getNode(new he(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function Ru(t){return gm({timestamp:Mm(t)})}function Xl(t,e,n,i,s){t.dataUpdateCount++;const r=new he(e);n=t.interceptServerDataCallback_?t.interceptServerDataCallback_(e,n):n;let o=[];if(s)if(i){const a=Bi(n,c=>xe(c));o=hm(t.serverSyncTree_,r,a,s)}else{const a=xe(n);o=um(t.serverSyncTree_,r,a,s)}else if(i){const a=Bi(n,c=>xe(c));o=lm(t.serverSyncTree_,r,a)}else{const a=xe(n);o=ms(t.serverSyncTree_,r,a)}let l=r;o.length>0&&(l=No(t,r)),cn(t.eventQueue_,l,o)}function Zl(t,e){To(t,"connected",e),e===!1&&Um(t)}function Lm(t,e){Be(e,(n,i)=>{To(t,n,i)})}function To(t,e,n){const i=new he("/.info/"+e),s=xe(n);t.infoData_.updateSnapshot(i,s);const r=ms(t.infoSyncTree_,i,s);cn(t.eventQueue_,i,r)}function Fm(t){return t.nextWriteId_++}function Um(t){xu(t,"onDisconnectEvents");const e=Ru(t),n=Ki();_r(t.onDisconnect_,ie(),(s,r)=>{const o=vm(s,r,t.serverSyncTree_,e);tu(n,s,o)});let i=[];_r(n,ie(),(s,r)=>{i=i.concat(ms(t.serverSyncTree_,s,r));const o=Vm(t,s);No(t,o)}),t.onDisconnect_=Ki(),cn(t.eventQueue_,ie(),i)}function $m(t,e,n){let i;J(e._path)===".info"?i=Ql(t.infoSyncTree_,e,n):i=Ql(t.serverSyncTree_,e,n),Nu(t.eventQueue_,e._path,i)}function ea(t,e,n){let i;J(e._path)===".info"?i=Er(t.infoSyncTree_,e,n):i=Er(t.serverSyncTree_,e,n),Nu(t.eventQueue_,e._path,i)}function Bm(t){t.persistentConnection_&&t.persistentConnection_.interrupt(Om)}function xu(t,...e){let n="";t.persistentConnection_&&(n=t.persistentConnection_.id+":"),Re(n,...e)}function Ou(t,e,n){return _u(t.serverSyncTree_,e,n)||V.EMPTY_NODE}function So(t,e=t.transactionQueueTree_){if(e||Cs(t,e),Fn(e)){const n=Du(t,e);b(n.length>0,"Sending zero length transaction queue"),n.every(s=>s.status===0)&&Hm(t,Ci(e),n)}else Cu(e)&&vs(e,n=>{So(t,n)})}function Hm(t,e,n){const i=n.map(c=>c.currentWriteId),s=Ou(t,e,i);let r=s;const o=s.hash();for(let c=0;c<n.length;c++){const u=n[c];b(u.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;const h=Ue(e,u.path);r=r.updateChild(h,u.currentOutputSnapshotRaw)}const l=r.val(!0),a=e;t.server_.put(a.toString(),l,c=>{xu(t,"transaction put response",{path:a.toString(),status:c});let u=[];if(c==="ok"){const h=[];for(let d=0;d<n.length;d++)n[d].status=2,u=u.concat(pn(t.serverSyncTree_,n[d].currentWriteId)),n[d].onComplete&&h.push(()=>n[d].onComplete(null,!0,n[d].currentOutputSnapshotResolved)),n[d].unwatcher();Cs(t,wo(t.transactionQueueTree_,e)),So(t,t.transactionQueueTree_),cn(t.eventQueue_,e,u);for(let d=0;d<h.length;d++)mi(h[d])}else{if(c==="datastale")for(let h=0;h<n.length;h++)n[h].status===3?n[h].status=4:n[h].status=0;else{Ve("transaction at "+a.toString()+" failed: "+c);for(let h=0;h<n.length;h++)n[h].status=4,n[h].abortReason=c}No(t,e)}},o)}function No(t,e){const n=ku(t,e),i=Ci(n),s=Du(t,n);return Wm(t,s,i),i}function Wm(t,e,n){if(e.length===0)return;const i=[];let s=[];const o=e.filter(l=>l.status===0).map(l=>l.currentWriteId);for(let l=0;l<e.length;l++){const a=e[l],c=Ue(n,a.path);let u=!1,h;if(b(c!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),a.status===4)u=!0,h=a.abortReason,s=s.concat(pn(t.serverSyncTree_,a.currentWriteId,!0));else if(a.status===0)if(a.retryCount>=km)u=!0,h="maxretry",s=s.concat(pn(t.serverSyncTree_,a.currentWriteId,!0));else{const d=Ou(t,a.path,o);a.currentInputSnapshot=d;const _=e[l].update(d.val());if(_!==void 0){wu("transaction failed: Data returned ",_,a.path);let v=xe(_);typeof _=="object"&&_!=null&&Ct(_,".priority")||(v=v.updatePriority(d.getPriority()));const x=a.currentWriteId,W=Ru(t),ye=Cm(v,d,W);a.currentOutputSnapshotRaw=v,a.currentOutputSnapshotResolved=ye,a.currentWriteId=Fm(t),o.splice(o.indexOf(x),1),s=s.concat(om(t.serverSyncTree_,a.path,ye,a.currentWriteId,a.applyLocally)),s=s.concat(pn(t.serverSyncTree_,x,!0))}else u=!0,h="nodata",s=s.concat(pn(t.serverSyncTree_,a.currentWriteId,!0))}cn(t.eventQueue_,n,s),s=[],u&&(e[l].status=2,function(d){setTimeout(d,Math.floor(0))}(e[l].unwatcher),e[l].onComplete&&(h==="nodata"?i.push(()=>e[l].onComplete(null,!1,e[l].currentInputSnapshot)):i.push(()=>e[l].onComplete(new Error(h),!1,null))))}Cs(t,t.transactionQueueTree_);for(let l=0;l<i.length;l++)mi(i[l]);So(t,t.transactionQueueTree_)}function ku(t,e){let n,i=t.transactionQueueTree_;for(n=J(e);n!==null&&Fn(i)===void 0;)i=wo(i,n),e=pe(e),n=J(e);return i}function Du(t,e){const n=[];return Pu(t,e,n),n.sort((i,s)=>i.order-s.order),n}function Pu(t,e,n){const i=Fn(e);if(i)for(let s=0;s<i.length;s++)n.push(i[s]);vs(e,s=>{Pu(t,s,n)})}function Cs(t,e){const n=Fn(e);if(n){let i=0;for(let s=0;s<n.length;s++)n[s].status!==2&&(n[i]=n[s],i++);n.length=i,vu(e,n.length>0?n:void 0)}vs(e,i=>{Cs(t,i)})}function Vm(t,e){const n=Ci(ku(t,e)),i=wo(t.transactionQueueTree_,e);return bm(i,s=>{Bs(t,s)}),Bs(t,i),Eu(i,s=>{Bs(t,s)}),n}function Bs(t,e){const n=Fn(e);if(n){const i=[];let s=[],r=-1;for(let o=0;o<n.length;o++)n[o].status===3||(n[o].status===1?(b(r===o-1,"All SENT items should be at beginning of queue."),r=o,n[o].status=3,n[o].abortReason="set"):(b(n[o].status===0,"Unexpected transaction status in abort"),n[o].unwatcher(),s=s.concat(pn(t.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&i.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?vu(e,void 0):n.length=r+1,cn(t.eventQueue_,Ci(e),s);for(let o=0;o<i.length;o++)mi(i[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mu{constructor(e,n,i,s){this.eventType=e,this.eventRegistration=n,this.snapshot=i,this.prevName=s}getPath(){const e=this.snapshot.ref;return this.eventType==="value"?e._path:e.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+Te(this.snapshot.exportVal())}}class Lu{constructor(e,n,i){this.eventRegistration=e,this.error=n,this.path=i}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sy(t){Xp(Zr),An(new Jt("database",(e,{instanceIdentifier:n})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return Zm(i,s,r,n)},"PUBLIC").setMultipleInstances(!0)),xt(El,bl,t),xt(El,bl,"esm2017")}mt.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};mt.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};sy();var Fu=(t,e)=>{const n=t.__vccOpts||t;for(const[i,s]of e)n[i]=s;return n},ry=typeof globalThis!="undefined"?globalThis:typeof window!="undefined"?window:typeof global!="undefined"?global:typeof self!="undefined"?self:{},Uu={exports:{}};(function(t,e){(function(n,i){t.exports=i()})(ry,function(){var n=1e3,i=6e4,s=36e5,r="millisecond",o="second",l="minute",a="hour",c="day",u="week",h="month",d="quarter",_="year",v="date",R="Invalid Date",x=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,W=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,ye={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_")},q=function(B,k,N){var L=String(B);return!L||L.length>=k?B:""+Array(k+1-L.length).join(N)+B},oe={s:q,z:function(B){var k=-B.utcOffset(),N=Math.abs(k),L=Math.floor(N/60),E=N%60;return(k<=0?"+":"-")+q(L,2,"0")+":"+q(E,2,"0")},m:function B(k,N){if(k.date()<N.date())return-B(N,k);var L=12*(N.year()-k.year())+(N.month()-k.month()),E=k.clone().add(L,h),O=N-E<0,H=k.clone().add(L+(O?-1:1),h);return+(-(L+(N-E)/(O?E-H:H-E))||0)},a:function(B){return B<0?Math.ceil(B)||0:Math.floor(B)},p:function(B){return{M:h,y:_,w:u,d:c,D:v,h:a,m:l,s:o,ms:r,Q:d}[B]||String(B||"").toLowerCase().replace(/s$/,"")},u:function(B){return B===void 0}},Q="en",D={};D[Q]=ye;var z=function(B){return B instanceof ee},P=function B(k,N,L){var E;if(!k)return Q;if(typeof k=="string"){var O=k.toLowerCase();D[O]&&(E=O),N&&(D[O]=N,E=O);var H=k.split("-");if(!E&&H.length>1)return B(H[0])}else{var ne=k.name;D[ne]=k,E=ne}return!L&&E&&(Q=E),E||!L&&Q},F=function(B,k){if(z(B))return B.clone();var N=typeof k=="object"?k:{};return N.date=B,N.args=arguments,new ee(N)},w=oe;w.l=P,w.i=z,w.w=function(B,k){return F(B,{locale:k.$L,utc:k.$u,x:k.$x,$offset:k.$offset})};var ee=function(){function B(N){this.$L=P(N.locale,null,!0),this.parse(N)}var k=B.prototype;return k.parse=function(N){this.$d=function(L){var E=L.date,O=L.utc;if(E===null)return new Date(NaN);if(w.u(E))return new Date;if(E instanceof Date)return new Date(E);if(typeof E=="string"&&!/Z$/i.test(E)){var H=E.match(x);if(H){var ne=H[2]-1||0,fe=(H[7]||"0").substring(0,3);return O?new Date(Date.UTC(H[1],ne,H[3]||1,H[4]||0,H[5]||0,H[6]||0,fe)):new Date(H[1],ne,H[3]||1,H[4]||0,H[5]||0,H[6]||0,fe)}}return new Date(E)}(N),this.$x=N.x||{},this.init()},k.init=function(){var N=this.$d;this.$y=N.getFullYear(),this.$M=N.getMonth(),this.$D=N.getDate(),this.$W=N.getDay(),this.$H=N.getHours(),this.$m=N.getMinutes(),this.$s=N.getSeconds(),this.$ms=N.getMilliseconds()},k.$utils=function(){return w},k.isValid=function(){return this.$d.toString()!==R},k.isSame=function(N,L){var E=F(N);return this.startOf(L)<=E&&E<=this.endOf(L)},k.isAfter=function(N,L){return F(N)<this.startOf(L)},k.isBefore=function(N,L){return this.endOf(L)<F(N)},k.$g=function(N,L,E){return w.u(N)?this[L]:this.set(E,N)},k.unix=function(){return Math.floor(this.valueOf()/1e3)},k.valueOf=function(){return this.$d.getTime()},k.startOf=function(N,L){var E=this,O=!!w.u(L)||L,H=w.p(N),ne=function(Ge,Ne){var Me=w.w(E.$u?Date.UTC(E.$y,Ne,Ge):new Date(E.$y,Ne,Ge),E);return O?Me:Me.endOf(c)},fe=function(Ge,Ne){return w.w(E.toDate()[Ge].apply(E.toDate("s"),(O?[0,0,0,0]:[23,59,59,999]).slice(Ne)),E)},le=this.$W,_e=this.$M,qe=this.$D,Ye="set"+(this.$u?"UTC":"");switch(H){case _:return O?ne(1,0):ne(31,11);case h:return O?ne(1,_e):ne(0,_e+1);case u:var Lt=this.$locale().weekStart||0,Pe=(le<Lt?le+7:le)-Lt;return ne(O?qe-Pe:qe+(6-Pe),_e);case c:case v:return fe(Ye+"Hours",0);case a:return fe(Ye+"Minutes",1);case l:return fe(Ye+"Seconds",2);case o:return fe(Ye+"Milliseconds",3);default:return this.clone()}},k.endOf=function(N){return this.startOf(N,!1)},k.$set=function(N,L){var E,O=w.p(N),H="set"+(this.$u?"UTC":""),ne=(E={},E[c]=H+"Date",E[v]=H+"Date",E[h]=H+"Month",E[_]=H+"FullYear",E[a]=H+"Hours",E[l]=H+"Minutes",E[o]=H+"Seconds",E[r]=H+"Milliseconds",E)[O],fe=O===c?this.$D+(L-this.$W):L;if(O===h||O===_){var le=this.clone().set(v,1);le.$d[ne](fe),le.init(),this.$d=le.set(v,Math.min(this.$D,le.daysInMonth())).$d}else ne&&this.$d[ne](fe);return this.init(),this},k.set=function(N,L){return this.clone().$set(N,L)},k.get=function(N){return this[w.p(N)]()},k.add=function(N,L){var E,O=this;N=Number(N);var H=w.p(L),ne=function(_e){var qe=F(O);return w.w(qe.date(qe.date()+Math.round(_e*N)),O)};if(H===h)return this.set(h,this.$M+N);if(H===_)return this.set(_,this.$y+N);if(H===c)return ne(1);if(H===u)return ne(7);var fe=(E={},E[l]=i,E[a]=s,E[o]=n,E)[H]||1,le=this.$d.getTime()+N*fe;return w.w(le,this)},k.subtract=function(N,L){return this.add(-1*N,L)},k.format=function(N){var L=this,E=this.$locale();if(!this.isValid())return E.invalidDate||R;var O=N||"YYYY-MM-DDTHH:mm:ssZ",H=w.z(this),ne=this.$H,fe=this.$m,le=this.$M,_e=E.weekdays,qe=E.months,Ye=function(Ne,Me,Ft,bt){return Ne&&(Ne[Me]||Ne(L,O))||Ft[Me].slice(0,bt)},Lt=function(Ne){return w.s(ne%12||12,Ne,"0")},Pe=E.meridiem||function(Ne,Me,Ft){var bt=Ne<12?"AM":"PM";return Ft?bt.toLowerCase():bt},Ge={YY:String(this.$y).slice(-2),YYYY:this.$y,M:le+1,MM:w.s(le+1,2,"0"),MMM:Ye(E.monthsShort,le,qe,3),MMMM:Ye(qe,le),D:this.$D,DD:w.s(this.$D,2,"0"),d:String(this.$W),dd:Ye(E.weekdaysMin,this.$W,_e,2),ddd:Ye(E.weekdaysShort,this.$W,_e,3),dddd:_e[this.$W],H:String(ne),HH:w.s(ne,2,"0"),h:Lt(1),hh:Lt(2),a:Pe(ne,fe,!0),A:Pe(ne,fe,!1),m:String(fe),mm:w.s(fe,2,"0"),s:String(this.$s),ss:w.s(this.$s,2,"0"),SSS:w.s(this.$ms,3,"0"),Z:H};return O.replace(W,function(Ne,Me){return Me||Ge[Ne]||H.replace(":","")})},k.utcOffset=function(){return 15*-Math.round(this.$d.getTimezoneOffset()/15)},k.diff=function(N,L,E){var O,H=w.p(L),ne=F(N),fe=(ne.utcOffset()-this.utcOffset())*i,le=this-ne,_e=w.m(this,ne);return _e=(O={},O[_]=_e/12,O[h]=_e,O[d]=_e/3,O[u]=(le-fe)/6048e5,O[c]=(le-fe)/864e5,O[a]=le/s,O[l]=le/i,O[o]=le/n,O)[H]||le,E?_e:w.a(_e)},k.daysInMonth=function(){return this.endOf(h).$D},k.$locale=function(){return D[this.$L]},k.locale=function(N,L){if(!N)return this.$L;var E=this.clone(),O=P(N,L,!0);return O&&(E.$L=O),E},k.clone=function(){return w.w(this.$d,this)},k.toDate=function(){return new Date(this.valueOf())},k.toJSON=function(){return this.isValid()?this.toISOString():null},k.toISOString=function(){return this.$d.toISOString()},k.toString=function(){return this.$d.toUTCString()},B}(),Ee=ee.prototype;return F.prototype=Ee,[["$ms",r],["$s",o],["$m",l],["$H",a],["$W",c],["$M",h],["$y",_],["$D",v]].forEach(function(B){Ee[B[1]]=function(k){return this.$g(k,B[0],B[1])}}),F.extend=function(B,k){return B.$i||(B(k,ee,F),B.$i=!0),F},F.locale=P,F.isDayjs=z,F.unix=function(B){return F(1e3*B)},F.en=D[Q],F.Ls=D,F.p={},F})})(Uu);var Ri=Uu.exports;const oy={class:"row"},ly={class:"row place justify-content-md-center",style:{padding:"5px"}},ay={class:"col-3",style:{margin:"5px"}},cy={key:0,class:"box"},uy={key:1,class:"box"},hy=ja({__name:"MainPage",setup(t){const e={\u5831\u5230:["\u5065\u6AA2\u6AC3\u53F0"],\u9AD4\u6AA2\u5927\u6A13:["\u8EAB\u9AD8\u9AD4\u91CD","\u5FC3\u96FB\u5716","\u8840\u58D3\u91CF\u6E2C","\u5BB6\u91AB\u8A3A\u65B7","\u62BD\u8840\u7AD9","\u7CBE\u795E\u79D1\u6AA2\u67E5","\u51FA\u53E3"]},n="NFC",i=iy(),s=Ym(i,n),r=Vo({});Object.keys(e).forEach(Q=>{e[Q].forEach(D=>{r.value[D]={num:0,avgWorkTime:0,avgWaitTime:0}})});let o={},l={},a={},c={},u={},h=[],d=Vo(0);Object.keys(e).forEach(Q=>{e[Q].forEach(D=>{c[D]=[]})});let _=new URLSearchParams(window.location.search);console.log("If you want to set the time range, you can set params like '?start=2022-09-22T13:15:00'");let v=Ri(_.get("start")||"NaN"),R=v.valueOf(),x=Ri(_.get("end")||"NaN"),W=x.valueOf();const ye=Ri();isNaN(R)&&(v=ye.set("hour",0).set("minute",0).set("second",0),R=v.valueOf()),isNaN(W)&&(x=v.add(1,"day"),W=x.valueOf()),console.log(v.toJSON()),console.log(v.format("\u958B\u59CB\u6642\u9593:\u672C\u5730\u6642\u9593 YYYY-MM-DD HH:mm:ss")),console.log(x.toJSON()),console.log(x.format("\u7D50\u675F\u6642\u9593:\u672C\u5730\u6642\u9593 YYYY-MM-DD HH:mm:ss")),Qm(s,Q=>{const D=Q.val();D.timestamp<R||D.timestamp>W||oe(D)});function q(Q){return Ri(Q).format("HH:mm:ss")}function oe(Q){const D=Q.serialNumber,z=Q.placeName,P=Q.timestamp;if(console.log(Q),D in o||(o[D]={}),z in o[D]||(o[D][z]={intime:-1,outtime:-1}),!(z in r.value))return;const F="\u7B49\u5019\u5340";if(l[D]||(l[D]=F),!a[D])a[D]=P;else if(P-a[D]<1e3){console.log(`${q(P)} ${D}  ${(P-a[D])/1e3}  \u592A\u5FEB\uFF0Cskip`);return}if(a[D]=P,z=="\u5065\u6AA2\u6AC3\u53F0")if(!u[D])console.log(`${q(P)}\uFF1A${D} \u5F9E\u5916\u9762\u9032\u5165\u4E86 ${z}`),u[D]=P;else{const ee=Math.floor((P-u[D])/1e3);console.log(`${q(P)}\uFF1A${D} \u56DE\u5230\u4E86 ${z}\uFF0C\u6574\u8D9F\u82B1\u4E86 ${ee} \u79D2`),h.push(ee),u[D]=0,d.value=Math.floor(h.reduce((Ee,B)=>Ee+B)/h.length)}const w=l[D];if(w!=F&&w!=z){o[D][z].intime=P;const ee=P-o[D][w].intime;c[w].push(ee),console.log(`${q(P)}\uFF1A${D} \u82B1 ${Math.floor(ee/1e3)} \u79D2\uFF0C \u5F9E ${w} \u77AC\u9593\u79FB\u52D5\u5230 ${z}`),o[D][w].intime=-1,l[D]=z}else if(w!=F&&w==z){const ee=P-o[D][w].intime;c[z].push(ee),console.log(`${q(P)}\uFF1A${D} \u82B1 ${Math.floor(ee/1e3)} \u79D2\uFF0C\u5728 ${w}\uFF0C\u5237\u7B2C2\u6B21\uFF0C\u5230\u7B49\u5019\u5340`),o[D][w].intime=-1,l[D]=F}else w==F?(console.log(`${q(P)}\uFF1A${D} \u5F9E ${w} \u9032\u5165 ${z}`),o[D][z].intime=P,l[D]=z):console.log(`${q(P)}\uFF1A\u9019\u4E8B\u4E0D\u8A72\u767C\u751F ${D} , ${w} , ${z}`);w!=F&&c[w].length>0&&(r.value[w].num=c[w].length,r.value[w].avgWorkTime=c[w].reduce((ee,Ee)=>ee+Ee)/c[w].length,r.value[w].avgWorkTime=Math.floor(r.value[w].avgWorkTime/1e3)),z!=F&&c[z].length>0&&(r.value[z].num=c[z].length,r.value[z].avgWorkTime=c[z].reduce((ee,Ee)=>ee+Ee)/c[z].length,r.value[z].avgWorkTime=Math.floor(r.value[z].avgWorkTime/1e3))}return(Q,D)=>(pt(),Tt("div",oy,[(pt(!0),Tt(We,null,Yo(qs(e),(z,P,F)=>(pt(),Tt("div",ly,[_t("h1",null,$n(P),1),(pt(!0),Tt(We,null,Yo(z.filter(w=>w!="\u51FA\u53E3"),(w,ee,Ee)=>(pt(),Tt("div",ay,[w.includes("\u5065\u6AA2\u6AC3\u53F0")?nl("",!0):(pt(),Tt("div",cy,[_t("h2",null,$n(w),1),_t("h3",null,"\u5E73\u5747\u8655\u7406\u6642\u9593\uFF1A"+$n(r.value[w].avgWorkTime)+" \u79D2",1)])),w=="\u5065\u6AA2\u6AC3\u53F0"?(pt(),Tt("div",uy,[_t("h2",null,$n(w),1),_t("h3",null,"\u5E73\u5747\u5B8C\u6210\u9AD4\u6AA2\u6642\u9593\uFF1A"+$n(qs(d))+" \u79D2",1)])):nl("",!0)]))),256))]))),256))]))}});var fy=Fu(hy,[["__scopeId","data-v-e949b3a2"]]),dy="firebase",py="9.9.4";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const na=new Jr("@firebase/auth");function Pi(t,...e){na.logLevel<=ue.ERROR&&na.error(`Auth (${Zr}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class di{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){re(e.idToken,"internal-error"),re(typeof e.idToken!="undefined","internal-error"),re(typeof e.refreshToken!="undefined","internal-error");const n="expiresIn"in e&&typeof e.expiresIn!="undefined"?Number(e.expiresIn):Ay(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,n)}async getToken(e,n=!1){return re(!this.accessToken||this.refreshToken,e,"user-token-expired"),!n&&this.accessToken&&!this.isExpired?this.accessToken:this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null}clearRefreshToken(){this.refreshToken=null}async refresh(e,n){const{accessToken:i,refreshToken:s,expiresIn:r}=await Py(e,n);this.updateTokensAndExpiration(i,s,Number(r))}updateTokensAndExpiration(e,n,i){this.refreshToken=n||null,this.accessToken=e||null,this.expirationTime=Date.now()+i*1e3}static fromJSON(e,n){const{refreshToken:i,accessToken:s,expirationTime:r}=n,o=new di;return i&&(re(typeof i=="string","internal-error",{appName:e}),o.refreshToken=i),s&&(re(typeof s=="string","internal-error",{appName:e}),o.accessToken=s),r&&(re(typeof r=="number","internal-error",{appName:e}),o.expirationTime=r),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new di,this.toJSON())}_performRefresh(){return Qn("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ws(t,e,n){return`firebase:${t}:${e}:${n}`}class In{constructor(e,n,i){this.persistence=e,this.auth=n,this.userKey=i;const{config:s,name:r}=this.auth;this.fullUserKey=Ws(this.userKey,s.apiKey,r),this.fullPersistenceKey=Ws("persistence",s.apiKey,r),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?bn._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,n,i="authUser"){if(!n.length)return new In(qt(oa),e,i);const s=(await Promise.all(n.map(async c=>{if(await c._isAvailable())return c}))).filter(c=>c);let r=s[0]||qt(oa);const o=Ws(i,e.config.apiKey,e.name);let l=null;for(const c of n)try{const u=await c._get(o);if(u){const h=bn._fromJSON(e,u);c!==r&&(l=h),r=c;break}}catch{}const a=s.filter(c=>c._shouldAllowMigration);return!r._shouldAllowMigration||!a.length?new In(r,e,i):(r=a[0],l&&await r._set(o,l.toJSON()),await Promise.all(n.map(async c=>{if(c!==r)try{await c._remove(o)}catch{}})),new In(r,e,i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qu(t,e=[]){let n;switch(t){case"Browser":n=la(ft());break;case"Worker":n=`${la(ft())}-${t}`;break;default:n=t}const i=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${Zr}/${i}`}/**
 * @license
