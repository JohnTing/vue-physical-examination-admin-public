 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pf="FirebaseError";class ln extends Error{constructor(e,n,i){super(n),this.code=e,this.customData=i,this.name=Pf,Object.setPrototypeOf(this,ln.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,pi.prototype.create)}}class pi{constructor(e,n,i){this.service=e,this.serviceName=n,this.errors=i}create(e,...n){const i=n[0]||{},s=`${this.service}/${e}`,r=this.errors[e],o=r?Mf(r,i):"Error",l=`${this.serviceName}: ${o} (${s}).`;return new ln(s,l,i)}}function Mf(t,e){return t.replace(Ff,(n,i)=>{const s=e[i];return s!=null?String(s):`<${i}?>`})}const Ff=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const eo=Mp;function Hp(t,e={}){typeof e!="object"&&(e={name:e});const n=Object.assign({name:Ec,automaticDataCollectionEnabled:!1},e),i=n.name;if(typeof i!="string"||!i)throw en.create("bad-app-name",{appName:String(i)});const s=Hi.get(i);if(s){if(or(t,s.options)&&or(n,s.config))return s;throw en.create("duplicate-app",{appName:i})}const r=new qf(i);for(const l of ur.values())r.addComponent(l);const o=new Bp(t,n,r);return Hi.set(i,o),o}function Wp(t=Ec){const e=Hi.get(t);if(!e)throw en.create("no-app",{appName:t});return e}function xt(t,e,n){var i;let s=(i=Fp[t])!==null&&i!==void 0?i:t;n&&(s+=`-${n}`);const r=s.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const l=[`Unable to register library "${s}" with version "${e}":`];r&&l.push(`library name "${s}" contains illegal characters (whitespace or "/")`),r&&o&&l.push("and"),o&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Zt.warn(l.join(" "));return}Rn(new Xt(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const no="5",xc="v",kc="s",Oc="r",Dc="f",Pc=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,Mc="ls",Fc="p",pr="ac",Lc="websocket",Uc="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fg{getCompleteChild(e){return null}getChildAfterChild(e,n,i){return null}}const hu=new Fg;class go{constructor(e,n,i=null){this.writes_=e,this.viewCache_=n,this.optCompleteServerCache_=i}getCompleteChild(e){const n=this.viewCache_.eventCache;if(n.isCompleteForChild(e))return n.getNode().getImmediateChild(e);{const i=this.optCompleteServerCache_!=null?new rn(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return _o(this.writes_,e,i)}}getChildAfterChild(e,n,i){const s=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:on(this.viewCache_),r=Pg(this.writes_,s,n,1,i,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sy(t){Xp(eo),Rn(new Xt("database",(e,{instanceIdentifier:n})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return Zm(i,s,r,n)},"PUBLIC").setMultipleInstances(!0)),xt(El,bl,t),xt(El,bl,"esm2017")}yt.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};yt.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};sy();var $u=(t,e)=>{const n=t.__vccOpts||t;for(const[i,s]of e)n[i]=s;return n},ry=typeof globalThis!="undefined"?globalThis:typeof window!="undefined"?window:typeof global!="undefined"?global:typeof self!="undefined"?self:{},Bu={exports:{}};(function(t,e){(function(n,i){t.exports=i()})(ry,function(){var n=1e3,i=6e4,s=36e5,r="millisecond",o="second",l="minute",a="hour",c="day",u="week",h="month",f="quarter",_="year",v="date",R="Invalid Date",x=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,W=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,ye={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_")},q=function(B,O,N){var F=String(B);return!F||F.length>=O?B:""+Array(O+1-F.length).join(N)+B},oe={s:q,z:function(B){var O=-B.utcOffset(),N=Math.abs(O),F=Math.floor(N/60),E=N%60;return(O<=0?"+":"-")+q(F,2,"0")+":"+q(E,2,"0")},m:function B(O,N){if(O.date()<N.date())return-B(N,O);var F=12*(N.year()-O.year())+(N.month()-O.month()),E=O.clone().add(F,h),k=N-E<0,H=O.clone().add(F+(k?-1:1),h);return+(-(F+(N-E)/(k?E-H:H-E))||0)},a:function(B){return B<0?Math.ceil(B)||0:Math.floor(B)},p:function(B){return{M:h,y:_,w:u,d:c,D:v,h:a,m:l,s:o,ms:r,Q:f}[B]||String(B||"").toLowerCase().replace(/s$/,"")},u:function(B){return B===void 0}},Q="en",D={};D[Q]=ye;var z=function(B){return B instanceof ee},P=function B(O,N,F){var E;if(!O)return Q;if(typeof O=="string"){var k=O.toLowerCase();D[k]&&(E=k),N&&(D[k]=N,E=k);var H=O.split("-");if(!E&&H.length>1)return B(H[0])}else{var ne=O.name;D[ne]=O,E=ne}return!F&&E&&(Q=E),E||!F&&Q},L=function(B,O){if(z(B))return B.clone();var N=typeof O=="object"?O:{};return N.date=B,N.args=arguments,new ee(N)},b=oe;b.l=P,b.i=z,b.w=function(B,O){return L(B,{locale:O.$L,utc:O.$u,x:O.$x,$offset:O.$offset})};var ee=function(){function B(N){this.$L=P(N.locale,null,!0),this.parse(N)}var O=B.prototype;return O.parse=function(N){this.$d=function(F){var E=F.date,k=F.utc;if(E===null)return new Date(NaN);if(b.u(E))return new Date;if(E instanceof Date)return new Date(E);if(typeof E=="string"&&!/Z$/i.test(E)){var H=E.match(x);if(H){var ne=H[2]-1||0,de=(H[7]||"0").substring(0,3);return k?new Date(Date.UTC(H[1],ne,H[3]||1,H[4]||0,H[5]||0,H[6]||0,de)):new Date(H[1],ne,H[3]||1,H[4]||0,H[5]||0,H[6]||0,de)}}return new Date(E)}(N),this.$x=N.x||{},this.init()},O.init=function(){var N=this.$d;this.$y=N.getFullYear(),this.$M=N.getMonth(),this.$D=N.getDate(),this.$W=N.getDay(),this.$H=N.getHours(),this.$m=N.getMinutes(),this.$s=N.getSeconds(),this.$ms=N.getMilliseconds()},O.$utils=function(){return b},O.isValid=function(){return this.$d.toString()!==R},O.isSame=function(N,F){var E=L(N);return this.startOf(F)<=E&&E<=this.endOf(F)},O.isAfter=function(N,F){return L(N)<this.startOf(F)},O.isBefore=function(N,F){return this.endOf(F)<L(N)},O.$g=function(N,F,E){return b.u(N)?this[F]:this.set(E,N)},O.unix=function(){return Math.floor(this.valueOf()/1e3)},O.valueOf=function(){return this.$d.getTime()},O.startOf=function(N,F){var E=this,k=!!b.u(F)||F,H=b.p(N),ne=function(Qe,Ne){var Me=b.w(E.$u?Date.UTC(E.$y,Ne,Qe):new Date(E.$y,Ne,Qe),E);return k?Me:Me.endOf(c)},de=function(Qe,Ne){return b.w(E.toDate()[Qe].apply(E.toDate("s"),(k?[0,0,0,0]:[23,59,59,999]).slice(Ne)),E)},le=this.$W,_e=this.$M,Ye=this.$D,Ge="set"+(this.$u?"UTC":"");switch(H){case _:return k?ne(1,0):ne(31,11);case h:return k?ne(1,_e):ne(0,_e+1);case u:var Ft=this.$locale().weekStart||0,Pe=(le<Ft?le+7:le)-Ft;return ne(k?Ye-Pe:Ye+(6-Pe),_e);case c:case v:return de(Ge+"Hours",0);case a:return de(Ge+"Minutes",1);case l:return de(Ge+"Seconds",2);case o:return de(Ge+"Milliseconds",3);default:return this.clone()}},O.endOf=function(N){return this.startOf(N,!1)},O.$set=function(N,F){var E,k=b.p(N),H="set"+(this.$u?"UTC":""),ne=(E={},E[c]=H+"Date",E[v]=H+"Date",E[h]=H+"Month",E[_]=H+"FullYear",E[a]=H+"Hours",E[l]=H+"Minutes",E[o]=H+"Seconds",E[r]=H+"Milliseconds",E)[k],de=k===c?this.$D+(F-this.$W):F;if(k===h||k===_){var le=this.clone().set(v,1);le.$d[ne](de),le.init(),this.$d=le.set(v,Math.min(this.$D,le.daysInMonth())).$d}else ne&&this.$d[ne](de);return this.init(),this},O.set=function(N,F){return this.clone().$set(N,F)},O.get=function(N){return this[b.p(N)]()},O.add=function(N,F){var E,k=this;N=Number(N);var H=b.p(F),ne=function(_e){var Ye=L(k);return b.w(Ye.date(Ye.date()+Math.round(_e*N)),k)};if(H===h)return this.set(h,this.$M+N);if(H===_)return this.set(_,this.$y+N);if(H===c)return ne(1);if(H===u)return ne(7);var de=(E={},E[l]=i,E[a]=s,E[o]=n,E)[H]||1,le=this.$d.getTime()+N*de;return b.w(le,this)},O.subtract=function(N,F){return this.add(-1*N,F)},O.format=function(N){var F=this,E=this.$locale();if(!this.isValid())return E.invalidDate||R;var k=N||"YYYY-MM-DDTHH:mm:ssZ",H=b.z(this),ne=this.$H,de=this.$m,le=this.$M,_e=E.weekdays,Ye=E.months,Ge=function(Ne,Me,Lt,It){return Ne&&(Ne[Me]||Ne(F,k))||Lt[Me].slice(0,It)},Ft=function(Ne){return b.s(ne%12||12,Ne,"0")},Pe=E.meridiem||function(Ne,Me,Lt){var It=Ne<12?"AM":"PM";return Lt?It.toLowerCase():It},Qe={YY:String(this.$y).slice(-2),YYYY:this.$y,M:le+1,MM:b.s(le+1,2,"0"),MMM:Ge(E.monthsShort,le,Ye,3),MMMM:Ge(Ye,le),D:this.$D,DD:b.s(this.$D,2,"0"),d:String(this.$W),dd:Ge(E.weekdaysMin,this.$W,_e,2),ddd:Ge(E.weekdaysShort,this.$W,_e,3),dddd:_e[this.$W],H:String(ne),HH:b.s(ne,2,"0"),h:Ft(1),hh:Ft(2),a:Pe(ne,de,!0),A:Pe(ne,de,!1),m:String(de),mm:b.s(de,2,"0"),s:String(this.$s),ss:b.s(this.$s,2,"0"),SSS:b.s(this.$ms,3,"0"),Z:H};return k.replace(W,function(Ne,Me){return Me||Qe[Ne]||H.replace(":","")})},O.utcOffset=function(){return 15*-Math.round(this.$d.getTimezoneOffset()/15)},O.diff=function(N,F,E){var k,H=b.p(F),ne=L(N),de=(ne.utcOffset()-this.utcOffset())*i,le=this-ne,_e=b.m(this,ne);return _e=(k={},k[_]=_e/12,k[h]=_e,k[f]=_e/3,k[u]=(le-de)/6048e5,k[c]=(le-de)/864e5,k[a]=le/s,k[l]=le/i,k[o]=le/n,k)[H]||le,E?_e:b.a(_e)},O.daysInMonth=function(){return this.endOf(h).$D},O.$locale=function(){return D[this.$L]},O.locale=function(N,F){if(!N)return this.$L;var E=this.clone(),k=P(N,F,!0);return k&&(E.$L=k),E},O.clone=function(){return b.w(this.$d,this)},O.toDate=function(){return new Date(this.valueOf())},O.toJSON=function(){return this.isValid()?this.toISOString():null},O.toISOString=function(){return this.$d.toISOString()},O.toString=function(){return this.$d.toUTCString()},B}(),Ee=ee.prototype;return L.prototype=Ee,[["$ms",r],["$s",o],["$m",l],["$H",a],["$W",c],["$M",h],["$y",_],["$D",v]].forEach(function(B){Ee[B[1]]=function(O){return this.$g(O,B[0],B[1])}}),L.extend=function(B,O){return B.$i||(B(O,ee,L),B.$i=!0),L},L.locale=P,L.isDayjs=z,L.unix=function(B){return L(1e3*B)},L.en=D[Q],L.Ls=D,L.p={},L})})(Bu);var Ri=Bu.exports;const oy=t=>(Ba("data-v-6ebd4082"),t=t(),Ha(),t),ly={class:"row"},ay={class:"col-sm-3 place",style:{padding:"5px"}},cy={class:"row",style:{margin:"5px"}},uy={key:0,class:"box"},hy={key:1,class:"box"},dy={key:2,class:"box"},fy=oy(()=>dt("h2",null,Bt("\u5FC3\u96FB\u6AA2\u67E5"),-1)),py={key:0},_y={key:1},gy=Ka({__name:"MainPage",setup(t){const e={\u5831\u5230:["\u5065\u6AA2\u6AC3\u53F0"],\u9AD4\u6AA2\u5927\u6A13:["\u57FA\u790E\u6AA2\u67E5","\u5FC3\u96FB\u6AA2\u67E5_\u7537","\u5FC3\u96FB\u6AA2\u67E5_\u5973","\u5BB6\u91AB\u8A3A\u65B7","\u62BD\u8840\u6AA2\u67E5","\u7CBE\u795E\u79D1\u6AA2\u67E5"],\u91AB\u7642\u5927\u6A13:["X\u5149\u6AA2\u67E5","\u773C\u79D1\u6AA2\u67E5"],\u7259\u79D1:["\u7259\u91AB\u6AA2\u67E5"]},n="NFC",i=iy(),s=Ym(i,n),r=jo({});Object.keys(e).forEach(Q=>{e[Q].forEach(D=>{r.value[D]={num:0,avgWorkTime:0}})});let o={},l={},a={},c={},u={},h=[],f=jo(0);Object.keys(e).forEach(Q=>{e[Q].forEach(D=>{c[D]=[]})});let _=new URLSearchParams(window.location.search);console.log("If you want to set the time range, you can set params like '?start=2022-09-22T13:15:00'");let v=Ri(_.get("start")||"NaN"),R=v.valueOf(),x=Ri(_.get("end")||"NaN"),W=x.valueOf();const ye=Ri();isNaN(R)&&(console.log("use today as startDate"),v=ye.set("hour",0).set("minute",0).set("second",0),R=v.valueOf()),isNaN(W)&&(console.log("use tomorrow as endDate"),x=v.add(1,"day"),W=x.valueOf()),console.log(v.toJSON()),console.log(v.format("\u958B\u59CB\u6642\u9593:\u672C\u5730\u6642\u9593 YYYY-MM-DD HH:mm:ss")),console.log(x.toJSON()),console.log(x.format("\u7D50\u675F\u6642\u9593:\u672C\u5730\u6642\u9593 YYYY-MM-DD HH:mm:ss")),Qm(s,Q=>{const D=Q.val();D.timestamp<R||D.timestamp>W||oe(D)});function q(Q){return Ri(Q).format("HH:mm:ss")}function oe(Q){const D=Q.serialNumber,z=Q.placeName,P=Q.timestamp;if(console.log(Q),D in o||(o[D]={}),z in o[D]||(o[D][z]={intime:-1,outtime:-1}),!(z in r.value))return;const L="\u7B49\u5019\u5340";if(l[D]||(l[D]=L),!a[D])a[D]=P;else if(P-a[D]<1e3){console.log(`${q(P)} ${D}  ${(P-a[D])/1e3}  \u592A\u5FEB\uFF0Cskip`);return}if(a[D]=P,z=="\u5065\u6AA2\u6AC3\u53F0")if(!u[D])console.log(`${q(P)}\uFF1A${D} \u5F9E\u5916\u9762\u9032\u5165\u4E86 ${z}`),u[D]=P;else{const ee=Math.floor((P-u[D])/1e3);console.log(`${q(P)}\uFF1A${D} \u56DE\u5230\u4E86 ${z}\uFF0C\u6574\u8D9F\u82B1\u4E86 ${ee} \u79D2`),h.push(ee),u[D]=0,f.value=Math.floor(h.reduce((Ee,B)=>Ee+B)/h.length)}const b=l[D];if(b!=L&&b!=z){o[D][z].intime=P;const ee=P-o[D][b].intime;c[b].push(ee),console.log(`${q(P)}\uFF1A${D} \u82B1 ${Math.floor(ee/1e3)} \u79D2\uFF0C \u5F9E ${b} \u77AC\u9593\u79FB\u52D5\u5230 ${z}`),o[D][b].intime=-1,l[D]=z}else if(b!=L&&b==z){const ee=P-o[D][b].intime;c[z].push(ee),console.log(`${q(P)}\uFF1A${D} \u82B1 ${Math.floor(ee/1e3)} \u79D2\uFF0C\u5728 ${b}\uFF0C\u5237\u7B2C2\u6B21\uFF0C\u5230\u7B49\u5019\u5340`),o[D][b].intime=-1,l[D]=L}else b==L?(console.log(`${q(P)}\uFF1A${D} \u5F9E ${b} \u9032\u5165 ${z}`),o[D][z].intime=P,l[D]=z):console.log(`${q(P)}\uFF1A\u9019\u4E8B\u4E0D\u8A72\u767C\u751F ${D} , ${b} , ${z}`);b!=L&&c[b].length>0&&(r.value[b].num=c[b].length,r.value[b].avgWorkTime=c[b].reduce((ee,Ee)=>ee+Ee)/c[b].length,r.value[b].avgWorkTime=Math.floor(r.value[b].avgWorkTime/1e3)),z!=L&&c[z].length>0&&(r.value[z].num=c[z].length,r.value[z].avgWorkTime=c[z].reduce((ee,Ee)=>ee+Ee)/c[z].length,r.value[z].avgWorkTime=Math.floor(r.value[z].avgWorkTime/1e3))}return(Q,D)=>(Ke(),Xe("div",ly,[(Ke(!0),Xe(We,null,Go(Ys(e),(z,P,L)=>(Ke(),Xe("div",ay,[dt("h1",null,Bt(P),1),(Ke(!0),Xe(We,null,Go(z,(b,ee,Ee)=>(Ke(),Xe("div",cy,[!b.includes("\u5FC3\u96FB\u6AA2\u67E5")&&!b.includes("\u5065\u6AA2\u6AC3\u53F0")?(Ke(),Xe("div",uy,[dt("h2",null,Bt(b),1),dt("h3",null,"\u5E73\u5747\u8655\u7406\u6642\u9593\uFF1A"+Bt(r.value[b].avgWorkTime)+" \u79D2",1)])):As("",!0),b=="\u5065\u6AA2\u6AC3\u53F0"?(Ke(),Xe("div",hy,[dt("h2",null,Bt(b),1),dt("h3",null,"\u5E73\u5747\u5B8C\u6210\u9AD4\u6AA2\u6642\u9593\uFF1A"+Bt(Ys(f))+" \u79D2",1)])):As("",!0),b=="\u5FC3\u96FB\u6AA2\u67E5_\u7537"?(Ke(),Xe("div",dy,[fy,r.value[b].num+r.value.\u5FC3\u96FB\u6AA2\u67E5_\u5973.num?(Ke(),Xe("h3",py," \u5E73\u5747\u8655\u7406\u6642\u9593\uFF1A"+Bt(((r.value[b].avgWorkTime*r.value[b].num+r.value.\u5FC3\u96FB\u6AA2\u67E5_\u5973.avgWorkTime*r.value.\u5FC3\u96FB\u6AA2\u67E5_\u5973.num)/(r.value[b].num+r.value.\u5FC3\u96FB\u6AA2\u67E5_\u5973.num)).toFixed(0))+" \u79D2 ",1)):(Ke(),Xe("h3",_y,"\u5E73\u5747\u8655\u7406\u6642\u9593\uFF1A0 \u79D2"))])):As("",!0)]))),256))]))),256))]))}});var my=$u(gy,[["__scopeId","data-v-6ebd4082"]]),yy="firebase",vy="9.9.4";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */xt(yy,vy,"app");function Hu(t,e){var n={};for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&e.indexOf(i)<0&&(n[i]=t[i]);if(t!=null&&typeof Object.getOwnPropertySymbols=="function")for(var s=0,i=Object.getOwnPropertySymbols(t);s<i.length;s++)e.indexOf(i[s])<0&&Object.prototype.propertyIsEnumerable.call(t,i[s])&&(n[i[s]]=t[i[s]]);return n}function Wu(){return{["dependent-sdk-initialized-before-auth"]:"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Cy=Wu,Vu=new pi("auth","Firebase",Wu());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const na=new Xr("@firebase/auth");function Pi(t,...e){na.logLevel<=ue.ERROR&&na.error(`Auth (${eo}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Jn(t){if(!!t)try{const e=new Date(Number(t));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function Oy(t,e=!1){const n=an(t),i=await n.getIdToken(e),s=Gu(i);re(s&&s.exp&&s.auth_time&&s.iat,n.auth,"internal-error");const r=typeof s.firebase=="object"?s.firebase:void 0,o=r==null?void 0:r.sign_in_provider;return{claims:s,token:i,authTime:Jn(Ws(s.auth_time)),issuedAtTime:Jn(Ws(s.iat)),expirationTime:Jn(Ws(s.exp)),signInProvider:o||null,signInSecondFactor:(r==null?void 0:r.sign_in_second_factor)||null}}function Ws(t){return Number(t)*1e3}function Gu(t){var e;const[n,i,s]=t.split(".");if(n===void 0||i===void 0||s===void 0)return Pi("JWT malformed, contained fewer than 3 sections"),null;try{const r=rr(i);return r?JSON.parse(r):(Pi("Failed to decode base64 JWT payload"),null)}catch(r){return Pi("Caught error parsing JWT payload as JSON",(e=r)===null||e===void 0?void 0:e.toString()),null}}function Dy(t){const e=Gu(t);return re(e,"internal-error"),re(typeof e.exp!="undefined","internal-error"),re(typeof e.iat!="undefined","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Tr(t,e,n=!1){if(n)return e;try{return await e}catch(i){throw i instanceof ln&&Py(i)&&t.auth.currentUser===t&&await t.auth.signOut(),i}}function Py({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function la(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Vy(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(By(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(zy(e))return"Blackberry";if(Ky(e))return"Webos";if(Hy(e))return"Safari";if((e.includes("chrome/")||Wy(e))&&!e.includes("edge/"))return"Chrome";if(jy(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=t.match(n);if((i==null?void 0:i.length)===2)return i[1]}return"Other"}function By(t=_t()){return/firefox\//i.test(t)}function Hy(t=_t()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Wy(t=_t()){return/crios\//i.test(t)}function Vy(t=_t()){return/iemobile/i.test(t)}function jy(t=_t()){return/android/i.test(t)}function zy(t=_t()){return/blackberry/i.test(t)}function Ky(t=_t()){return/webos/i.test(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
